% -*-LaTeX-*-
%
% typography-slides.tex - top-level source file for TACS slides 
%
...
%\newcommand{\soundtrack}[1]{\makebox[0.0mm][l]{\warnc{\normalsize{#1}}\textc}}
\newcommand{\soundtrack}[1]{\makebox[0.0mm][l]{}}%\warnc{\normalsize{#1}}\textc}}
...
\geometry{a4paper, landscape, dvips,
  left=30mm, right=30mm,
  foot=10mm, head=5mm, headsep=5mm, top=0mm, bottom=10mm}
...
\definecolor{textc}{rgb}{0.0,0.0,0.0}
\definecolor{titlec}{rgb}{0.0,0.6,0.0}
\definecolor{warnc}{rgb}{0.9,0.0,0.4}
\newcommand{\mc}{\color{mc}}
\newcommand{\emc}{\color{emc}}
\newcommand{\textc}{\color{textc}}
\newcommand{\titlec}{\color{titlec}}
\newcommand{\warnc}{\color{warnc}}



%%\renewcommand{\varsection}[1]{{\Huge #1\hfill}}
\newcommand{\varsection}[1]{{\begin{center}\Huge\titlec #1\end{center}}}
\newcommand{\varsubsection}[1]{{\begin{center}\huge\titlec #1\end{center}}}
...
\newcommand{\myinfes}[4]{\mbox{{#1}}\,{\frac{\displaystyle#3}{\displaystyle#4}}\,{#2}}
\newcommand{\Infer}[4]{\myinfes{#1}{#2}{#3}{#4}}
\newcommand{\simpleinfer}[3]{\myinfes{}{#3}{#1}{#2}}
...
\newcommand{\rsize}{\huge}
\newcommand{\rrulefront}[5]{\paragraph{\rsize{}#1}{\rsize\textbf{\rsize{}#2}}
\[\begin{array}{l@{\ }l}&#3\\#4\
&#5\end{array}\]}

\newcommand{\rrenbox}[1]{%
  \framebox{\begin{minipage}{\textwidth}\rsize{}#1%
            \end{minipage}}}
\newcommand{\rrencmt}[1]{%
  \par\vspace{0.5ex}\noindent\hfill%
