(* ---------------------------------------------------------------------- *)
(* Netsem Tthee Automated Tests Code: getifaddrs()                        *)
(* Matthew Fairbairn - Created 20040113                                   *)
(* $Id: getifaddrs.ml,v 1.7 2006/06/19 11:57:45 amgb2 Exp $ *)
(* ---------------------------------------------------------------------- *)
...
let test1 = (
  (function id -> function ts ->
      let getifaddrs_call = (tid_of_int_private 0, GETIFADDRS()) in
      ignore(libd_call (the ts.th_libd_hnd) getifaddrs_call)),
  "getifaddrs() -- call getifaddrs()",
...
let do_getifaddrs_tests handle hosts_list test_type =
  begin_next_test_group handle "getifaddrs()";
