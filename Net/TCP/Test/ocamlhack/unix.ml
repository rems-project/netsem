...
(* $Id: unix.ml,v 1.1 2002/08/02 14:15:19 smb50 Exp $ *)
...
type ip_socket_bool_option = IP_HDRINCL
...
external ip_getsockopt: file_descr -> ip_socket_bool_option -> bool
					  = "unix_ip_getsockopt_bool"
external ip_setsockopt: file_descr -> ip_socket_bool_option -> bool -> unit
					  = "unix_ip_setsockopt_bool"
