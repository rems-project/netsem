...
\def\rulesrcsid{\$ Id: TCP3\textunderscore{}hostTypesScript.sml,v 1.9 2009/02/20 10:35:33 tjr22 Exp \$}
...
\emph{TCP state} ($\tsunknown{CLOSED}$, $\tsunknown{LISTEN}$, etc.), send and receive
...
\ddefnn{tcpTsocket}{\iA{tcp\_socket}}{\subddefnA[{ details of a TCP socket }]{tcp\_socket}{\tstype{tcp\_socket}{}\\{}
 ...
 \tsvar{cb}   : \tstype{tcpcb};{}\\{}
 \tsvar{lis}  : \tsunknown{socket\_listen} \;\;\tstype{option} \tsholcomm{ invariant: $*$ iff not $\tsunknown{LISTEN}$ }{}\\{}
 \Mmagicbolrrec }
}
{}
...
\ddefnn{socket}{\iA{socket}}{\subddefnA[{ details of a socket }]{socket}{\tstype{socket}{}\\{}
...
\ddefnc{TCPTSockZ}{\iA{TCP\_Sock0}\iB{TCP\_Sock}\iB{UDP\_Sock0}\iB{UDP\_Sock}\iB{Sock}\iB{tcp\_sock\_of}\iB{udp\_sock\_of}\iB{proto\_of}\iB{proto\_eq}}{\subddefnA[{ helper constructor }]{TCP\_Sock0}{\tsaux{TCP\_Sock0}(\tsvar{st}, \tsvar{cb}, \tsvar{lis}){}\\{}
 = \Mmagiclrec  \tsvar{st}\Mass \tsvar{st}; \tsvar{cb}\Mass \tsvar{cb}; \tsvar{lis}\Mass \tsvar{lis} \Mmagicrrec }
\subddefnB[{ helper constructor }]{TCP\_Sock}{\tsaux{TCP\_Sock} \;\tsunknown{v} = \tscon{TCP\_PROTO}(\tsaux{TCP\_Sock0} \;\tsunknown{v})}
\subddefnB[{ helper constructor }]{UDP\_Sock0}{(\tsaux{UDP\_Sock0}:\tsunknown{dgram} \;\tstype{list}\Mtotype \tsunknown{udp\_socket}) \tsvar{rcvq} = \Mmagiclrec  \tsvar{rcvq}\Mass \tsvar{rcvq} \Mmagicrrec }
\subddefnB[{ helper constructor }]{UDP\_Sock}{\tsaux{UDP\_Sock} \;\tsunknown{v} = \tscon{UDP\_PROTO}(\tsaux{UDP\_Sock0} \;\tsunknown{v})}
\subddefnB[{ helper constructor }]{Sock}{\tscon{Sock}(\tsvar{fid}, \tsvar{sf}, \tsvar{is}_{1}, \tsvar{ps}_{1}, \tsvar{is}_{2}, \tsvar{ps}_{2}, \tsvar{es}, \tsunknown{csm}, \tsunknown{crm}, \tsvar{pr}){}\\{}
...
\subddefnB[{ helper accessor }]{proto\_of}{\tsaux{proto\_of} (\tscon{TCP\_PROTO}(\tsunknown{\_1})) = \tsunknown{PROTO\_TCP} \Mwedge {}\\{}
...
\ddefnc{privilegedTports}{\iA{privileged\_ports}\iB{ephemeral\_ports}}{\subddefnA{privileged\_ports}{\tsaux{privileged\_ports} \;\tsunknown{h} = \{ \tsunknown{Port} \;\tsunknown{n} \mid  \tsunknown{n} < 1024 \}}
\subddefnB{ephemeral\_ports}{\tsaux{ephemeral\_ports} \;\tsunknown{h} = \{ \tsunknown{Port} \;\tsunknown{n} \mid  \tsunknown{n} \geq  \tsunknown{h}.\tsvar{params}.\tsunknown{min\_eph\_port} \Mwedge  \tsunknown{n} \leq  \tsunknown{h}.\tsvar{params}.\tsunknown{max\_eph\_port} \}}
}
{\rulesubsection{Description}
...
\ddefnn{typeTabbrevTtracerecord}{\iA{type\_abbrev\_tracerecord}}{\subddefnA{type\_abbrev\_tracerecord}{\tsholop{type\_abbrev} \;\tsunknown{tracerecord} : \tsunknown{traceflavour}{}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \# \tsunknown{port} \;\;\tstype{option} \tscomm{ ps1 }{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \# \tsunknown{ip} \;\;\tstype{option} \tscomm{ is2 }{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \# \tsunknown{port} \;\;\tstype{option} \tscomm{ ps2 }{}\\{}
...
\ddefnn{tracecbTeq}{\iA{tracecb\_eq}}{\subddefnA[{ compare two control blocks for "equality" modulo known issues }]{tracecb\_eq}{\tsaux{tracecb\_eq} (\tsunknown{flav}:\tsunknown{traceflavour}) (\tsvar{st}:\tsunknown{tcpstate}) (\tsvar{es}:\tsunknown{error} \;\;\tstype{option}) (\tsvar{cb}:\tstype{tcpcb}) (\tsvar{cb}':\tstype{tcpcb}){}\\{}
 = \Mtrue  \tsholcomm{ placeholder }}
}
{}


\ddefnn{tracesockTeq}{\iA{tracesock\_eq}}{\subddefnA[{ compare two sockets for "equality" modulo known issues }]{tracesock\_eq}{\tsaux{tracesock\_eq} (\tsunknown{flav},\tsunknown{sid},\tsunknown{quad},\tsvar{st},\tsvar{cb}) \tsunknown{sid'} \;\tsunknown{sock}{}\\{}
...
\quad \tsholcomm{ If trace is $\tsunknown{TA\_DROP}$ then the $\tsvar{is}_{2},\tsvar{ps}_{2}$ values in the trace may
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\Mif  \;\tsunknown{flav} = \tsunknown{TA\_DROP} \;\Mthen  \;\Mtrue  \;\Melse  \;\tsvar{is}_{2} = \tsunknown{sock}.\tsvar{is}_{2}) \Mwedge {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\Mif  \;\tsunknown{flav} = \tsunknown{TA\_DROP} \;\Mthen  \;\Mtrue  \;\Melse  \;\tsvar{ps}_{2} = \tsunknown{sock}.\tsvar{ps}_{2}) \Mdpipe {}\\{}
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
\def\rulesrcsid{\$ Id: TCP3\textunderscore{}streamTypesScript.sml,v 1.14 2009/02/19 17:47:27 tjr22 Exp \$}

\chaptersection{ Stream types}
\label{TCP3_streamTypes}%
\chapcomm{
...
\clustersection{(TCP and UDP)}{Stream types}
\seccomm{
Basic stream types.
...
\ddefnn{typeTabbrevTstreamid}{\iA{type\_abbrev\_streamid}}{\subddefnA{type\_abbrev\_streamid}{\tsholop{type\_abbrev} \;\tsunknown{streamid} :(\tsunknown{ip}\#\tsunknown{port}) \tstype{set}}
}
{}


\ddefnc{streamFlags}{\iA{streamFlags}}{\subddefnA[{ stream control information }]{streamFlags}{\tstype{streamFlags} = \Mmagiclrec {}\\{}
...
messages. For example, the $\tsvar{SYNACK}$ flag is set iff there is a
message at the protocol-level (in queues or on the wire) that has both
the $\tsvar{SYN}$ and the $\tsunknown{ACK}$ flags set, and which may be received as a
...
\ddefnc{tcpStream}{\iA{tcpStream}}{\subddefnA[{ unidirectional stream }]{tcpStream}{\tstype{tcpStream} = \Mmagiclrec {}\\{}
...
The $\tsunknown{ip}$ and $\tsunknown{port}$ record the origin of the stream, which is primarily used
to identify a unidirectional stream in an unordered pair of streams. The
$\tsvar{flgs}$ record the control-flow information. The $\tsvar{data}$ is simply
a list of bytes. The $\tsvar{destroyed}$ flag records whether the socket has been
...
\ddefnc{tcpStreams}{\iA{tcpStreams}}{\subddefnA[{ bidirectional stream }]{tcpStreams}{\tstype{tcpStreams} = \Mmagiclrec  \tsvar{streams} : \tstype{tcpStream} \;\tstype{set} \Mmagicrrec }
}
{\rulesubsection{Description}

A bidirectional stream is an unordered pair of streams, thus, we
expect that there are always two $\tstype{tcpStream}$s in $\tsvar{streams}$.
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
\def\rulesrcsid{\$ Id: TCP3\textunderscore{}host0Script.sml,v 1.5 2009/02/19 17:47:27 tjr22 Exp \$}
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
% TCP3_auxFnsScript.sml:54:4-55:9:            WARNING: Empty preamble in cluster comment
\def\rulesrcsid{\$ Id: TCP3\textunderscore{}auxFnsScript.sml,v 1.16 2009/02/20 13:08:08 tjr22 Exp \$}
...
\clustersection{(TCP and UDP)}{Stream versions of routing functions}
\clustersubsection{Summary}
\par\begin{ltstabulariii}
$\tsrule{stream\_test\_outroute}$
&
&  if destination IP specified, do $\tsunknown{test\_outroute\_ip}$ \\
$\tsrule{stream\_loopback\_on\_wire}$
&
&  check if a message bears a loopback address \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnc{streamTtestToutroute}{\iA{stream\_test\_outroute}}{\subddefnA[{ if destination IP specified, do $\tsunknown{test\_outroute\_ip}$ }]{stream\_test\_outroute}{\tsunknown{stream\_test\_outroute}(\tsvar{is}_{2},\tsvar{rttab},\tsvar{ifds},\tsvar{arch}){}\\{}
...
\ddefnc{streamTloopbackTonTwire}{\iA{stream\_loopback\_on\_wire}}{\subddefnA[{ check if a message bears a loopback address }]{stream\_loopback\_on\_wire}{\tsunknown{stream\_loopback\_on\_wire} (\tsvar{is}_{1},\tsvar{is}_{2}) (\tsvar{ifds}:\tsunknown{ifid} \mapsto  \tsunknown{ifd}) ={}\\{}
...
\ddefnc{saneTsocket}{\iA{sane\_socket}}{\subddefnA[{ socket sanity invariants hold }]{sane\_socket}{\tsaux{sane\_socket} \;\tsunknown{sock} = \Mtrue }
}
{\rulesubsection{Description}
...
\ddefnc{boundTportsTprotocolTautobind}{\iA{bound\_ports\_protocol\_autobind}}{\subddefnA[{ the set of ports currently bound by a socket for a protocol }]{bound\_ports\_protocol\_autobind}{\tsaux{bound\_ports\_protocol\_autobind} \;\tsvar{pr} \;\tsvar{socks} = \{\tsvar{p} \mid  \exists \tsvar{s}:\tsvar{socket}.{}\\{}
...
\ddefnc{boundTportTallowed}{\iA{bound\_port\_allowed}}{\subddefnA[{ is it permitted to bind the given (IP,port) pair? }]{bound\_port\_allowed}{\tsaux{bound\_port\_allowed} \;\tsvar{pr} \;\tsvar{socks} \;\tsvar{sf} \;\tsvar{arch} \;\tsunknown{is} \;\tsvar{p} ={}\\{}
 \tsvar{p} \;\notin {}\\{}
...
\quad (\Mif  \;\tsunknown{bsd\_arch} \;\tsvar{arch} \Mwedge  \tsunknown{SO\_REUSEADDR} \;\in  \;\tsvar{sf}.\tsunknown{b} \;\Mthen {}\\{}
\quad\quad\quad \tsvar{s}.\tsvar{is}_{2} = * \Mwedge  \tsvar{s}.\tsvar{is}_{1} = \tsunknown{is}{}\\{}
\quad\quad \Melse  \;\Mif  \;\tsunknown{linux\_arch} \;\tsvar{arch} \Mwedge  \tsunknown{SO\_REUSEADDR} \;\in  \;\tsvar{sf}.\tsunknown{b} \Mwedge  \tsunknown{SO\_REUSEADDR} \;\in  \;\tsvar{s}.\tsvar{sf}.\tsunknown{b} \Mwedge {}\\{}
\quad\quad\quad\quad\quad\quad ((\exists \tsunknown{tcp\_sock}. \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = \tsvar{s}.\tsvar{pr} \Mwedge  \neg{}(\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN})) \Mvee {}\\{}
...
\quad\quad \Melse  \;\Mif  \;\tsunknown{windows\_arch} \;\tsvar{arch} \Mwedge  \tsunknown{SO\_REUSEADDR} \;\in  \;\tsvar{sf}.\tsunknown{b} \;\Mthen {}\\{}
...
{\rulesubsection{Description}
   ...
   state of the sockets' $\tsunknown{SO\_REUSEADDR}$ flags.
...
\ddefnc{autobind}{\iA{autobind}}{\subddefnA[{ set of ports available for autobinding }]{autobind}{\tsaux{autobind}(\Msome  \;\tsvar{p},\tsunknown{\_},\tsunknown{\_},\tsunknown{\_}) = \{\tsvar{p}\} \Mwedge {}\\{}
...
{\rulesubsection{Description}
Note that $\tsunknown{SO\_REUSEADDR}$ is not considered when choosing a port to
autobind to.
...
\ddefnc{boundTafter}{\iA{bound\_after}\iB{match\_score}}{\subddefnA[{ was $\tsunknown{sid}$ bound more recently than $\tsunknown{sid'}$? }]{bound\_after}{\tsaux{bound\_after} \;\tsunknown{sid} \;\tsunknown{sid'} [\,] = \tsunknown{ASSERTION\_FAILURE} \text{``bound\textunderscore{}after''} \tscomm{ should never reach this case } \Mwedge {}\\{}
...
\subddefnB[{ score the match against the given pattern of the given quadruple }]{match\_score}{(\tsaux{match\_score} (\tsunknown{\_},*,\tsunknown{\_},\tsunknown{\_}) \tsunknown{\_} = 0n) \Mwedge {}\\{}
...
\ddefnc{lookupTudp}{\iA{lookup\_udp}}{\subddefnA[{ the set of sockets matching an address quad, for UDP }]{lookup\_udp}{\tsaux{lookup\_udp} \;\tsvar{socks} \;\tsunknown{quad} \;\tsvar{bound} \;\tsvar{arch} ={}\\{}
...
computed using $\tsaux{match\_score}$.
...
\ddefnc{tcpTsocketTbestTmatch}{\iA{tcp\_socket\_best\_match}}{\subddefnA[{ the set of sockets matching a quad, for TCP }]{tcp\_socket\_best\_match}{\tsaux{tcp\_socket\_best\_match} (\tsvar{socks} : \tsunknown{sid} \mapsto  \tstype{socket}) (\tsunknown{sid},\tsunknown{sock}) (\tsunknown{seg} : \tsunknown{tcpSegment}) \tsvar{arch} ={}\\{}
...
{\rulesubsection{Description}
 ...
 The score (obtained using $\tsaux{match\_score}$) for the given
...
\ddefnc{lookupTicmp}{\iA{lookup\_icmp}}{\subddefnA[{ the set of sockets matching a quad, for ICMP }]{lookup\_icmp}{\tsaux{lookup\_icmp} \;\tsvar{socks} \;\tsunknown{icmp} \;\tsvar{arch} \;\tsvar{bound} ={}\\{}
...
\ddefnc{calculateTbufTsizes}{\iA{calculate\_buf\_sizes}}{\subddefnA[{ Calculate buffer sizes for $\tsunknown{rcvbufsize}$, $\tsunknown{sndbufsize}$, $\tsunknown{t\_maxseg}$, and $\tsunknown{snd\_cwnd}$
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad \Melse  \;\tsholop{MIN} \;\tsunknown{SB\_MAX} (\tsunknown{roundup} \;\tsunknown{t\_maxseg''} \;\tsunknown{sndbufsize'})) \Min {}\\{}
 {}\\{}
 \Mlet  \;\tsunknown{do\_rfc3390} = \Mtrue  \;\Min {}\\{}
 {}\\{}
...
\ddefnc{sendTqueueTspace}{\iA{send\_queue\_space}}{\subddefnA{send\_queue\_space}{\tsaux{send\_queue\_space} (\tsunknown{sndq\_max} : \tstype{num}) \tsunknown{sndq\_size} \;\tsunknown{oob} \;\tsvar{arch} \;\tsunknown{maxseg} \;\tsvar{i}_{2} ={}\\{}
...
\subddefnB[{ path MTU plateaus to try }]{mtu\_tab}{\tsaux{mtu\_tab} \;\tsvar{arch} = \Mif  \;\tsunknown{linux\_arch} \;\tsvar{arch} \;\Mthen {}\\{}
...
&
&  do TCP output \\
$\tsrule{stream\_tcp\_output\_really}$
&
&  do TCP output \\
$\tsrule{tcp\_output\_perhaps}$
&
&  combination of $\tsaux{tcp\_output\_required}$ and $\tsaux{tcp\_output\_really}$ \\
$\tsrule{stream\_tcp\_output\_perhaps}$
&
&  combination of $\tsaux{tcp\_output\_required}$ and $\tsaux{tcp\_output\_really}$ \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnc{tcpToutputTrequired}{\iA{tcp\_output\_required}}{\subddefnA[{ determine whether TCP output is required }]{tcp\_output\_required}{\tsaux{tcp\_output\_required} (\tsunknown{do\_output}, \tsunknown{persist\_fun}) ={}\\{}
...
\ddefnc{tcpToutputTreally}{\iA{tcp\_output\_really}}{\subddefnA[{ do TCP output }]{tcp\_output\_really}{\tsaux{tcp\_output\_really} \;\tsunknown{sock} (\tsunknown{sock'},\tsunknown{outsegs'}) ={}\\{}
...
\quad\quad\quad\quad\quad\quad \tsunknown{SYN\_SENT}     \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st} \Mdpipe     \tsholcomm{ can't move yet -- wait until connection established (see $\tsunknown{deliver\_in\_2}$/$\tsunknown{deliver\_in\_3}$) }{}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{SYN\_RECEIVED} \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st} \Mdpipe     \tsholcomm{ can't move yet -- wait until connection established (see $\tsunknown{deliver\_in\_2}$/$\tsunknown{deliver\_in\_3}$) }{}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{ESTABLISHED}  \Mtotype  \tsunknown{FIN\_WAIT\_1} \Mdpipe {}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{CLOSE\_WAIT}   \Mtotype  \tsunknown{LAST\_ACK} \Mdpipe {}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{FIN\_WAIT\_1}   \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st} \Mdpipe     \tsholcomm{ FIN retransmission }{}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{FIN\_WAIT\_2}   \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st} \Mdpipe     \tsholcomm{ can't happen       }{}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{CLOSING}      \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st} \Mdpipe     \tsholcomm{ FIN retransmission }{}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{LAST\_ACK}     \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st} \Mdpipe     \tsholcomm{ FIN retransmission }{}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{TIME\_WAIT}    \Mtotype  \tsunknown{tcp\_sock}.\tsvar{st}       \tsholcomm{ can't happen       }{}\\{}
...
\ddefnc{streamTtcpToutputTreally}{\iA{stream\_tcp\_output\_really}}{\subddefnA[{ do TCP output }]{stream\_tcp\_output\_really}{\tsunknown{stream\_tcp\_output\_really} \;\tsunknown{sock} (\tsunknown{sock'},\tsvar{FIN}) ={}\\{}
 \Mlet  \;\tsunknown{tcp\_sock} = \tsaux{tcp\_sock\_of} \;\tsunknown{sock} \;\Min {}\\{}
 \Mlet  \;\tsvar{cb} = \tsunknown{tcp\_sock}.\tsvar{cb} \;\Min {}\\{}
 {}\\{}
 \tsholcomm{ Assert that the socket is fully bound and connected }{}\\{}
...
\ddefnn{tcpToutputTperhaps}{\iA{tcp\_output\_perhaps}}{\subddefnA[{ combination of $\tsaux{tcp\_output\_required}$ and $\tsaux{tcp\_output\_really}$ }]{tcp\_output\_perhaps}{\tsaux{tcp\_output\_perhaps} \;\tsunknown{sock} (\tsunknown{sock'},\tsunknown{outsegs}) ={}\\{}
...
\ddefnn{streamTtcpToutputTperhaps}{\iA{stream\_tcp\_output\_perhaps}}{\subddefnA[{ combination of $\tsaux{tcp\_output\_required}$ and $\tsaux{tcp\_output\_really}$ }]{stream\_tcp\_output\_perhaps}{\tsholcomm{ $\tsunknown{FINs}$ argument records whether any messages were sent, and if so, whether they were a $\tsvar{FIN}$ }{}\\{}
 \tsunknown{stream\_tcp\_output\_perhaps} \;\tsunknown{sock} (\tsunknown{sock'},\tsunknown{FINs}) ={}\\{}
 \exists  \tsunknown{do\_output} \;\tsunknown{persist\_fun}.{}\\{}
 (\tsaux{tcp\_output\_required} (\tsunknown{do\_output},\tsunknown{persist\_fun}) \Mwedge {}\\{}
 \Mlet  \;\tsunknown{sock''} = \tsunknown{sock} \;\Min {}\\{}
 \Mif  \;\tsunknown{do\_output} \;\Mthen {}\\{}
 \exists  \tsvar{FIN}.{}\\{}
 \tsunknown{stream\_tcp\_output\_really} \;\tsunknown{sock''} (\tsunknown{sock'},\tsvar{FIN}) \tscomm{ definitely does send a seg } \Mwedge {}\\{}
...
$\tsrule{stream\_rollback\_tcp\_output}$
&
&  Attempt to enqueue segments, reverting appropriate socket fields if the enqueue fails \\
$\tsrule{enqueue\_or\_fail}$
&
&  wrap $\tsaux{rollback\_tcp\_output}$ together with enqueue \\
$\tsrule{stream\_enqueue\_or\_fail}$
&
&  wrap $\tsaux{rollback\_tcp\_output}$ together with enqueue \\
$\tsrule{stream\_enqueue\_or\_fail\_sock}$
&
...
\ddefnn{streamTrollbackTtcpToutput}{\iA{stream\_rollback\_tcp\_output}}{\subddefnA[{ Attempt to enqueue segments, reverting appropriate socket fields if the enqueue fails }]{stream\_rollback\_tcp\_output}{\tsunknown{stream\_rollback\_tcp\_output} \;\tsunknown{rcvdsyn} (\tsvar{is}_{1},\tsvar{is}_{2}) \tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{cb\_in} (\tsvar{cb}',\tsvar{es}',\tsunknown{outsegs'}) ={}\\{}
 {}\\{}
 \tsholcomm{ NB: from $\tsvar{cb}_{0}$, only $\tsunknown{snd\_nxt}$, $\tsunknown{tt\_delack}$, $\tsunknown{last\_ack\_sent}$, $\tsunknown{rcv\_adv}$,
        $\tsunknown{tf\_rxwin0sent}$, $\tsunknown{t\_rttseg}$, $\tsunknown{snd\_max}$, $\tsunknown{tt\_rexmt}$ are
        used. }{}\\{}
 {}\\{}
 (\tsholop{choose} \;\tsunknown{allocated} \Mcons  (\Mif  \;\tsunknown{INFINITE\_RESOURCES} \;\Mthen  \{\Mtrue \} \Melse  \{\Mtrue ;\Mfalse \}).{}\\{}
 \Mlet  \;\tsunknown{route} = \tsunknown{stream\_test\_outroute} (\tsvar{is}_{2},\tsvar{rttab},\tsvar{ifds},\tsvar{arch}) \Min {}\\{}
 \Mlet  \;\tsunknown{f1} = \lambda \tsvar{cb}. \Mif  \neg{}\tsunknown{rcvdsyn} \;\Mthen {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{cb}{}\\{}
\quad\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{cb} \; \Mmagiclrec  \tscomm{ set soft error flag; on ip\textunderscore{}output routing failure }{}\\{}
...
\quad\quad \tsvar{cb}' = \tsunknown{cb\_in} \Mwedge  \tsunknown{outsegs'} = \Mfalse  \Mwedge  \tsvar{es}' = \Msome  \;\tsunknown{ENOBUFS}{}\\{}
 \Melse  \;\Mif  \;\tsunknown{route} = * \;\Mthen   \tscomm{ ill-formed segment }{}\\{}
\quad\quad \tsunknown{ASSERTION\_FAILURE} \text{``stream\textunderscore{}rollback\textunderscore{}tcp\textunderscore{}output:1''}  \tscomm{ should never happen }{}\\{}
 \Melse  \;\Mif  \exists \tsvar{e}. \tsunknown{route} = \Msome  (\Msome  \;\tsvar{e}) \Mthen   \tscomm{ routing failure }{}\\{}
\quad\quad \tsvar{cb}' = \tsunknown{f1} \;\tsunknown{cb\_in} \Mwedge  \tsunknown{outsegs'} = \Mfalse  \Mwedge  \tsvar{es}' = \tsholop{THE} \;\tsunknown{route}{}\\{}
 \Melse  \;\Mif  \;\tsunknown{stream\_loopback\_on\_wire} (\tsvar{is}_{1},\tsvar{is}_{2}) \tsvar{ifds} \;\Mthen  \tscomm{ loopback not allowed on wire - RFC1122 }{}\\{}
\quad\quad (\Mif  \;\tsunknown{windows\_arch} \;\tsvar{arch} \;\Mthen {}\\{}
...
\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad \tsunknown{ASSERTION\_FAILURE} \text{``stream\textunderscore{}rollback\textunderscore{}tcp\textunderscore{}output:2''} \tscomm{ never happen }{}\\{}
\quad\quad ){}\\{}
 \Melse {}\\{}
\quad\quad (\exists \tsvar{queued}.{}\\{}
...
\ddefnn{enqueueTorTfail}{\iA{enqueue\_or\_fail}}{\subddefnA[{ wrap $\tsaux{rollback\_tcp\_output}$ together with enqueue }]{enqueue\_or\_fail}{\tsaux{enqueue\_or\_fail} \;\tsunknown{rcvdsyn} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{outsegs} \;\tsvar{oq} \;\tsvar{cb}_{0} \;\tsunknown{cb\_in} (\tsvar{cb}',\tsvar{oq}') ={}\\{}
...
\ddefnn{streamTenqueueTorTfail}{\iA{stream\_enqueue\_or\_fail}}{\subddefnA[{ wrap $\tsaux{rollback\_tcp\_output}$ together with enqueue }]{stream\_enqueue\_or\_fail}{\tsunknown{stream\_enqueue\_or\_fail} \;\tsunknown{rcvdsyn} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} (\tsvar{is}_{1},\tsvar{is}_{2}) \tsunknown{cb\_in} \;\tsvar{cb}' ={}\\{}
 (\exists  \tsvar{es}' \;\tsvar{outsegs}'.\tsunknown{stream\_rollback\_tcp\_output} \;\tsunknown{rcvdsyn} (\tsvar{is}_{1},\tsvar{is}_{2}) \tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{cb\_in} (\tsvar{cb}',\tsvar{es}',\tsvar{outsegs}'))}
}
{}


\ddefnn{streamTenqueueTorTfailTsock}{\iA{stream\_enqueue\_or\_fail\_sock}}{\subddefnA[{ version of $\tsaux{enqueue\_or\_fail}$ that works with sockets rather than cbs }]{stream\_enqueue\_or\_fail\_sock}{\tsunknown{stream\_enqueue\_or\_fail\_sock} \;\tsunknown{rcvdsyn} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} (\tsvar{is}_{1},\tsvar{is}_{2}) \tsunknown{sock0} \;\tsunknown{sock} \;\tsunknown{sock'} ={}\\{}
 ...
 (\exists \tsvar{cb}'.{}\\{}
 \tsunknown{stream\_enqueue\_or\_fail} \;\tsunknown{rcvdsyn} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} (\tsvar{is}_{1},\tsvar{is}_{2}) (\tsaux{tcp\_sock\_of} \;\tsunknown{sock}).\tsvar{cb} \;\tsvar{cb}' \Mwedge {}\\{}
...
\ddefnn{enqueueTandTignoreTfail}{\iA{enqueue\_and\_ignore\_fail}}{\subddefnA[{ version of $\tsaux{enqueue\_or\_fail}$ that ignores errors and doesn't touch the tcpcb }]{enqueue\_and\_ignore\_fail}{\tsaux{enqueue\_and\_ignore\_fail} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{outsegs} \;\tsvar{oq} \;\tsvar{oq}' ={}\\{}
...
\ddefnn{enqueueTeachTandTignoreTfail}{\iA{enqueue\_each\_and\_ignore\_fail}}{\subddefnA[{ version of above that ignores errors and doesn't touch the tcpcb }]{enqueue\_each\_and\_ignore\_fail}{(\tsaux{enqueue\_each\_and\_ignore\_fail} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} [\,] \tsvar{oq} \;\tsvar{oq}' = (\tsvar{oq} = \tsvar{oq}')) \Mwedge {}\\{}
...
\ddefnn{streamTmliftTtcpToutputTperhapsTorTfail}{\iA{stream\_mlift\_tcp\_output\_perhaps\_or\_fail}}{\subddefnA[{ do mliftc for function returning at most one segment and not dealing with queueing flag }]{stream\_mlift\_tcp\_output\_perhaps\_or\_fail}{\tsunknown{stream\_mlift\_tcp\_output\_perhaps\_or\_fail} \tscomm{ X ts\textunderscore{}val X } \tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds}_{0} \;\tsunknown{s} (\tsunknown{s'},\tsvar{FIN}) ={}\\{}
\quad\quad\quad\quad \exists \tsvar{s}_{1} \;\tsvar{FINs}.{}\\{}
\quad\quad\quad\quad \tsunknown{stream\_tcp\_output\_perhaps} \;\tsunknown{s} (\tsvar{s}_{1},\tsvar{FINs}) \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsunknown{stream\_rollback\_tcp\_output} \;\Mtrue  (\tsvar{s}_{1}.\tsvar{is}_{1},\tsvar{s}_{1}.\tsvar{is}_{2}) \tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds}_{0}{}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{FIN} = (\tsvar{outsegs}' \Mwedge  \tsvar{FIN}') )}
}
{}
...
\ddefnn{updateTidle}{\iA{update\_idle}}{\subddefnA[{ Do updates appropriate to receiving a new segment on a connection }]{update\_idle}{\tsaux{update\_idle} \;\tsunknown{tcp\_sock} \;\tsunknown{tt\_keep'} ={}\\{}
 \tsholop{choose} \;\tsunknown{tf\_needfin} \Mcons  \{\Mtrue ;\Mfalse \}.{}\\{}
 \tsunknown{tt\_keep'} = (\Mif  \neg{}(\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge  \tsunknown{tf\_needfin}) \Mthen {}\\{}
...
$\tsrule{stream\_mlift\_dropafterack\_or\_fail}$
&
&  send immediate ACK to segment, but otherwise process it no further \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{dropwithreset}{\iA{dropwithreset}}{\subddefnA[{ emit a RST segment corresponding to the passed segment, unless that would be stupid. }]{dropwithreset}{\tsaux{dropwithreset} \;\tsunknown{segRST} (\tsvar{is}_{1},\tsvar{is}_{2}) \tsvar{ifds}_{0} \;\tsvar{RST} ={}\\{}
...
\ddefnn{streamTmliftTdropafterackTorTfail}{\iA{stream\_mlift\_dropafterack\_or\_fail}}{\subddefnA[{ send immediate ACK to segment, but otherwise process it no further }]{stream\_mlift\_dropafterack\_or\_fail}{\tsunknown{stream\_mlift\_dropafterack\_or\_fail} \;\tsunknown{segRST} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{sock} (\tsunknown{sock'},\tsvar{FIN},\tsvar{RST},\tsunknown{stop'}) ={}\\{}
 ...
 \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge {}\\{}
...
\quad\quad \tsunknown{stream\_tcp\_output\_really} \;\tsunknown{sock} (\tsvar{sock}_{1},\tsvar{msgFIN}) \Mwedge   \tsholcomm{ did set $\tsunknown{tf\_acknow}$ and call $\tsaux{tcp\_output\_perhaps}$, which seemed a bit silly }{}\\{}
...
\quad\quad \tsunknown{stream\_rollback\_tcp\_output} \;\Mtrue  (\tsunknown{sock}.\tsvar{is}_{1},\tsunknown{sock}.\tsvar{is}_{2}) \tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{tcp\_sock1}.\tsvar{cb} (\tsvar{cb}',\tsvar{es}',\tsvar{outsegs}') \Mwedge {}\\{}
...
\ddefnc{tcpTclose}{\iA{tcp\_close}}{\subddefnA[{ close the socket and remove the TCPCB }]{tcp\_close}{\tsaux{tcp\_close} \;\tsvar{arch} \;\tsunknown{sock} = \tsunknown{sock} \;{}\\{}
 ...
 \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{CLOSED};{}\\{}
 \tsvar{cb} \Mass  \tsaux{initial\_cb} \Mmagicrrec ){}\\{}
 \Mmagicbolrrec }
}
{\rulesubsection{Description}
...
\ddefnc{tcpTdropTandTclose}{\iA{tcp\_drop\_and\_close}}{\subddefnA[{ drop TCP connection, reporting the specified error.  If synchronised, send RST to peer }]{tcp\_drop\_and\_close}{\tsaux{tcp\_drop\_and\_close} \;\tsvar{arch} \;\tsunknown{err} \;\tsunknown{sock} (\tsunknown{sock'},(\tsunknown{oflgs},\tsunknown{odata}:\tsunknown{char} \;\tstype{list})) ={}\\{}
 \Mlet  \;\tsunknown{tcp\_sock} = \tsaux{tcp\_sock\_of} \;\tsunknown{sock} \;\Min  ({}\\{}
 (\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} \;\notin  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT}\} \Mthen {}\\{}
...
\clustersection{(TCP only)}{Socket quad testing and extraction}
\seccomm{
...
$\tsrule{quad\_of}$
&
&  extract the quad from the socket \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{existsTquadTof}{\iA{exists\_quad\_of}}{\subddefnA[{ test whether a socket quad is set }]{exists\_quad\_of}{\tsaux{exists\_quad\_of} (\tsunknown{sock}:\tsunknown{TCP3\_hostTypes}\;\tsunknown{\$socket}) ={}\\{}
\quad \exists  \tsvar{i}_{1} \;\tsvar{p}_{1} \;\tsvar{i}_{2} \;\tsvar{p}_{2}. (\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2}) = (\tsunknown{sock}.\tsvar{is}_{1},\tsunknown{sock}.\tsvar{ps}_{1},\tsunknown{sock}.\tsvar{is}_{2},\tsunknown{sock}.\tsvar{ps}_{2})}
}
{}


\ddefnn{quadTof}{\iA{quad\_of}}{\subddefnA[{ extract the quad from the socket }]{quad\_of}{\tsaux{quad\_of} (\tsunknown{sock}:\tsunknown{TCP3\_hostTypes}\;\tsunknown{\$socket}) ={}\\{}
\quad (\tsholop{THE} \;\tsunknown{sock}.\tsvar{is}_{1},\tsholop{THE} \;\tsunknown{sock}.\tsvar{ps}_{1},\tsholop{THE} \;\tsunknown{sock}.\tsvar{is}_{2},\tsholop{THE} \;\tsunknown{sock}.\tsvar{ps}_{2})}
}
{}
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
% TCP3_hostLTSScript.sml:83:6-15:             WARNING: Empty preamble in chapter comment
% TCP3_hostLTSScript.sml:5652:21-28:          WARNING: Empty errors preamble in cluster comment
\def\rulesrcsid{\$ Id: TCP3\textunderscore{}hostLTSScript.sml,v 1.39 2009/02/20 13:08:08 tjr22 Exp \$}

%                                             WARNING: Item sowriteable could not be dropped after pselect_1
%                                             WARNING: Item soreadable could not be dropped after pselect_1
\chaptersection{ Host LTS: Socket Calls}
\label{socket_calls}%
\chapcomm{}


\clustersection{(TCP only)}{$\tsunknown{accept}()$}
...
\par\begin{ltstabular}
$\tsunknown{EAGAIN}$
&  The socket has the $\tsunknown{O\_NONBLOCK}$ flag set and no connections are available on
...
\\\hline
$\tsunknown{EINVAL}$
&  Ths socket is not accepting connections, \ie,  it is not in the $\tsunknown{LISTEN}$ state,
  or is a UDP socket.
...
\seccomm{
  If the $\tsunknown{accept}()$ call blocks then state $\tsunknown{Accept2}(\tsunknown{sid})$ is entered, where $\tsunknown{sid}$ is the index
...
&  Fail with $\tsunknown{ECONNABORTED}$: the listening socket has $\tsvar{cantsndmore}$ set
     or has become $\tsunknown{CLOSED}$. Returns either immediately or from a blocked state. \\
$\tsrule{accept\_5}$
& \textbf{tcp: rc}
...
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\Msome  \;\tsvar{lis})));{}\\{}
...
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{ESTABLISHED},\tsvar{cb}',*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\tsvar{fd}',(\tsvar{i}_{2},\tsvar{p}_{2})))}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds}';{}\\{}
...
\quad\quad\quad\quad\quad \tsvar{cantsndmore}',\tsvar{cantrcvmore}', \tsaux{TCP\_Sock}(\tsunknown{ESTABLISHED},\tsvar{cb}',*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mboxedor{\tsvar{t} = \tsunknown{Run} \Mwedge {}\\{}
 \tsvar{lbl} = \MLhcall{\tsvar{tid}}{(\tsunknown{accept} \;\tsvar{fd})} \Mwedge {}\\{}
 \tsvar{rc} = \tsunknown{fast} \;\tsunknown{succeed} \Mwedge {}\\{}
 ...
 {}\\{}
 }{\tsvar{t} = \tsunknown{Accept2}(\tsvar{sid}) \Mwedge {}\\{}
\quad \tsvar{lbl} = \MLhtau  \Mwedge {}\\{}
\quad \tsvar{rc} = \tsunknown{slow} \;\tsunknown{urgent} \;\tsunknown{succeed}{}\\{}
 } \Mwedge {}\\{}
 {}\\{}
...
{\rulesubsection{Description}
   ...
   called from a thread $\tsvar{tid}$ in the $\tsunknown{Run}$ state, where $\tsvar{fd}$ refers to a TCP socket $\tsvar{sid}$,
   and (2) a previous call to $\tsunknown{accept}(\tsvar{fd})$ on socket $\tsvar{sid}$ blocked, leaving its calling thread
   $\tsvar{tid}$ in state $\tsunknown{Accept2}(\tsvar{sid})$, and a new connection has become available.
   ...
   finite map of sockets, $\tsvar{socks}$$\oplus\dots$. The socket is $\tsunknown{ESTABLISHED}$, is not shutdown for
   ...
   auxiliary $\tsunknown{nextfd}$, and an entry mapping $\tsvar{fd}'$ to $\tsvar{fid}'$ is added to the host's finite map
   of file descriptors.  If the calling thread was previously blocked in state $\tsunknown{Accept2}(\tsvar{sid})$ it
   proceeds via a $\MLhtau $ transition, otherwise by a $\MLhcall{\tsvar{tid}}{ (\tsunknown{accept} \;\tsvar{fd})}$ transition.
   The thread is left in state $\tsunknown{Ret} (\tsunknown{OK} (\tsvar{fd}',(\tsvar{i}_{2},\tsvar{p}_{2})))$ to return the file descriptor and remote
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{(\tsunknown{accept} \;\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Accept2}(\tsvar{sid})}{\tsunknown{never\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mfalse  \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\Msome  \;\tsvar{lis})) \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is initially in the $\tsunknown{Run}$ state, $\tsunknown{accept}(\tsvar{fd})$ is called where
   $\tsvar{fd}$ refers to listening TCP socket $\tsvar{sid}$ which is bound to local port $\tsvar{p}_{1}$, is not
   shutdown for reading and is in blocking mode: $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK})=\Mfalse $. The socket's queue of
   completed connections is empty, $\tsunknown{q} \Mass  [\,]$, hence the $\tsunknown{accept}()$ call blocks waiting for a
   successful new connection attempt, leaving the calling thread state $\tsunknown{Accept2}(\tsvar{sid})$.
...
\rrulecc{acceptTIII}{accept\_3}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$: no pending connections and non-blocking
     semantics set }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{(\tsunknown{accept} \;\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} = \tsvar{fid} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue  \Mwedge {}\\{}
 \tsvar{sid} \;\in  \Mfdom{\tsvar{h}.\tsvar{socks}} \Mwedge {}\\{}
 (\exists \tsvar{sf} \;\tsvar{is}_{1} \;\tsvar{p}_{1} \;\tsvar{cb} \;\tsvar{lis} \;\tsvar{es}.{}\\{}
...
{\rulesubsection{Description}
   ...
   for writing, and in non-blocking mode: $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue $. The socket's queue of completed
   connections is empty, $\tsunknown{q} \Mass  [\,]$, hence the $\tsunknown{accept}()$ call returns error $\tsunknown{EAGAIN}$,
   leaving the calling thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})$ after a $\MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})}$
   transition.
...
\rrulecc{acceptTIV}{accept\_4}{tcp: rc}{\tsholcomm{ Fail with $\tsunknown{ECONNABORTED}$: the listening socket has $\tsvar{cantsndmore}$ set
     or has become $\tsunknown{CLOSED}$. Returns either immediately or from a blocked state. }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsvar{t}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass {}\\{}
 \tsvar{socks} \oplus {}\\{}
...
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},\Msome  \;\tsvar{lis})))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ECONNABORTED}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass {}\\{}
 \tsvar{socks} \oplus {}\\{}
 [(\tsvar{sid} ,\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1},*,*,\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},\Msome  \;\tsvar{lis})))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mboxedor{\tsvar{t} = \tsunknown{Run} \Mwedge {}\\{}
 \tsvar{st} = \tsunknown{LISTEN} \Mwedge {}\\{}
 \tsvar{cantsndmore} = \Mtrue  \Mwedge {}\\{}
 \tsvar{lbl} = \MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})} \Mwedge {}\\{}
 \tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}){}\\{}
 }{\tsvar{t} = \tsunknown{Accept2}(\tsvar{sid}) \Mwedge {}\\{}
 ((\tsvar{cantrcvmore} = \Mtrue  \Mwedge  \tsvar{st} = \tsunknown{LISTEN}) \Mvee {}\\{}
 (\tsvar{st} = \tsunknown{CLOSED})) \Mwedge {}\\{}
 \tsvar{lbl} = \MLhtau  \Mwedge {}\\{}
 \tsvar{rc} = \tsunknown{slow} \;\tsunknown{urgent} \;\tsunknown{fail}{}\\{}
 }}
{\rulesubsection{Description}
   ...
   $\tsvar{sid}$ blocked, leaving a thread $\tsvar{tid}$ in state $\tsunknown{Accept2}(\tsvar{sid})$, but the socket has since
   either entered the $\tsunknown{CLOSED}$ state, or had $\tsvar{cantrcvmore}$ set. In both cases, $\tsunknown{ECONNABORTED}$
   is returned.
   ...
   $\tsvar{listen}()$ to be called in any (non $\tsunknown{CLOSED}$ or $\tsunknown{LISTEN}$) state, though should never happen
   under typical use.

   If the calling thread was previously blocked in state $\tsunknown{Accept2}(\tsvar{sid})$, it proceeds via an
   $\MLhtau $ transition, otherwise by a $\MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})}$ transition. The thread is
   left in state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ECONNABORTED}})$ to return the error $\tsunknown{ECONNABORTED}$ in response to
   ...
   socket to be placed in the $\tsunknown{LISTEN}$ state.

\rrulepad }


\rrulecc{acceptTV}{accept\_5}{tcp: rc}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$: socket not in LISTEN state }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsvar{t}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mboxedor{\tsvar{t} = \tsunknown{Run} \Mwedge {}\\{}
 \tsvar{lbl} = \MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})} \Mwedge {}\\{}
 \tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   $\tsunknown{LISTEN}$ state.

   This rule covers two cases: (1) on the non-listening TCP socket $\tsvar{sid}$, $\tsunknown{accept}()$ is called
   from a thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, and (2) a previous call to $\tsunknown{accept}()$ on
   TCP socket $\tsvar{sid}$ blocked because no completed connections were available, leaving thread
   $\tsvar{tid}$ in state $\tsunknown{Accept2}(\tsvar{sid})$ and after the $\tsunknown{accept}()$ call blocked the socket changed to a
   state other than $\tsunknown{LISTEN}$.
   ...
   transition. In either case, the thread is left in state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})$ to return error
   ...
   caused the socket to change from the $\tsunknown{LISTEN}$ state.

\rrulepad }


\rrulecc{acceptTVI}{accept\_6}{tcp: rc}{\tsholcomm{ Fail with $\tsunknown{EMFILE}$: out of file descriptors }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsvar{t}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMFILE}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mboxedor{\tsvar{t} = \tsunknown{Run} \Mwedge {}\\{}
 \tsvar{lbl} = \MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})} \Mwedge {}\\{}
 \tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{lbl} = \MLhtau  \Mwedge {}\\{}
 \tsvar{rc} = \tsunknown{slow} \;\tsunknown{nonurgent} \;\tsunknown{fail}{}\\{}
 } \Mwedge {}\\{}
 \tsholop{CARD} (\Mfdom{\tsvar{h}.\tsvar{fds}}) \geq  \tsunknown{OPEN\_MAX}}
{\rulesubsection{Description}

   This rule covers two cases: (1) from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, an
   $\tsunknown{accept}(\tsvar{fd})$ call is made where $\tsvar{fd}$ refers to a TCP socket $\tsvar{sid}$, and (2) a previous call
   to $\tsunknown{accept}()$ blocked leaving thread $\tsvar{tid}$ in the $\tsunknown{Accept2}(\tsvar{sid})$ state. In either case the
   ...
   In the first case the error is returned immediately ($\tsunknown{fast} \;\tsunknown{fail}$) by performing an
   $\MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})}$ transition, leaving the thread state $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{EMFILE}})$. In the
   second, the thread is unblocked, also leaving the thread state $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{EMFILE}})$, by
...
\rrulecc{acceptTVII}{accept\_7}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EOPNOTSUPP}$ or $\tsunknown{EINVAL}$: $\tsunknown{accept}()$ called on
     a UDP socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sid} \;\in  \Mfdom{\tsvar{h}.\tsvar{socks}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, an $\tsunknown{accept}(\tsvar{fd})$ call is made where $\tsvar{fd}$
   refers to a UDP socket identified by $\tsvar{sid}$. The call proceeds by a $\MLhcall{\tsvar{tid}}{\tsunknown{accept}(\tsvar{fd})}$
   transition leaving the thread state $\tsunknown{Ret}(\tscon{FAIL}\;{\tsvar{err}})$ to return error $\tsvar{err}$. On FreeBSD
...
\clustersection{(TCP and UDP)}{$\tsunknown{bind}()$}
\seccomm{ \[ \tsunknown{bind}: (\tsunknown{fd} * \tsunknown{ip} \;\;\tstype{option} * \tsunknown{port} \;\;\tstype{option}) \Mtotype  \tstype{unit} \]
  ...
  $\tsunknown{SO\_REUSEADDR}$ appropriately: see \ltslink{boundTportTallowed}{$\tsaux{bound\_port\_allowed}$}.
  ...
  socket using the same protocol. The error may occur in the following situations only:
    \begin{itemize}
      ...
      \item $\tsunknown{bind}(\tsunknown{\_},\tsunknown{\_},\Msome  \;\tsvar{p})$ will fail with $\tsunknown{EADDRINUSE}$ if another socket is bound to port
       $\tsvar{p}$. This error may be preventable by setting the $\tsunknown{SO\_REUSEADDR}$ socket option.
      ...
      \item $\tsunknown{bind}(\tsunknown{\_},\Msome  \;\tsvar{i},\Msome  \;\tsvar{p})$ will fail with $\tsunknown{EADDRINUSE}$ if another socket is bound to
       ...
       not occur if the $\tsunknown{SO\_REUSEADDR}$ option is correctly used to allow multiple sockets to be
...
\seccomm{
  ...
  $\tsunknown{LISTEN}$ state to accept incoming connections to this address: $\tsunknown{socket\_1}$; $\tsunknown{return\_1}$;
...
\rrulecc{bindTI}{bind\_1}{all: fast succeed}{\tsholcomm{ Successfully assign a local address to a socket (possibly by
     autobinding the port) }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\tsvar{ps}_{1})} }{1}}
{(\tsvar{h},\tsvar{SS},\tsvar{MM})}
{\tsvar{h}_{0} = \tsvar{h}' \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 ...
 \tsvar{h}  = \tsvar{h}' \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
 ...
 (\Mcase  \;\tsvar{pr} \;\Mof {}\\{}
\quad \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mtotype  \tsunknown{tcp\_sock} = \tsaux{TCP\_Sock0}(\tsunknown{CLOSED},\tsvar{cb},*) \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   descriptor $\tsvar{fd}$ from a thread $\tsvar{tid}$ in the $\tsunknown{Run}$ state. The socket $\tsvar{sid}$ is currently
...
\Msome  \;\tsvar{p}$ $\tsaux{autobind}$ simply returns the singleton set $\{\tsvar{p}\}$, constraining the local port
   ...
   host, but also the status of the socket flag $\tsunknown{SO\_REUSEADDR}$ for socket $\tsvar{sid}$ and the
   conflicting sockets. The use of the socket flag $\tsunknown{SO\_REUSEADDR}$ can permit sockets to share
   ...
   The call proceeds by performing a $\MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\tsvar{ps}_{1})}$ transition returning $\tsunknown{OK}()$
...
\rrulecc{bindTII}{bind\_2}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRINUSE}$: the specified address is already in use }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRINUSE}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sock} = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1})$ call is performed
   ...
   state $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{EADDRINUSE}})$ to return error $\tsunknown{EADDRINUSE}$ to the caller.

\rrulepad }


\rrulecc{bindTIII}{bind\_3}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRNOTAVAIL}$: the specified IP address is not available on the host }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\Msome  \;\tsvar{i}_{1},\tsvar{ps}_{1})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRNOTAVAIL}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{bind}(\tsvar{fd},\Msome  \;\tsvar{i}_{1},\tsvar{ps}_{1})$ call is made where
   ...
   state $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{EADDRNOTAVAIL}})$ to return error $\tsunknown{EADDRNOTAVAIL}$ to the caller.

\rrulepad }


\rrulecc{bindTV}{bind\_5}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$: the socket is already bound to an address and does not support rebinding; or socket has been shutdown for writing on FreeBSD }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\tsvar{ps}_{1})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
\quad \Mtrue  ) ))}
{\rulesubsection{Description}
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\tsvar{ps}_{1})$ call is made where
...
*$, and rebinding is not supported.
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\tsvar{ps}_{1})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})$.
...
\rrulecc{bindTVII}{bind\_7}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EACCES}$: the specified port is priveleged and the current process does not have permission to bind to it }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EACCES}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1})$ call is made where
   ...
   The call proceeds by a $\MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1})}$ transition leaving the thread in
   state $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{EACCES}})$ to return the access violation error $\tsunknown{EACCES}$ to the caller.

\rrulepad }


\rrulecc{bindTIX}{bind\_9}{all: fast badfail}{\tsholcomm{ Fail with $\tsunknown{ENOBUFS}$: no ephemeral ports free for autobinding or, on WinXP only, insufficient buffers available. }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{bind}(\tsvar{fd},\tsvar{is}_{1},\tsvar{ps}_{1})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOBUFS}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{ps}_{1} = * \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{ENOBUFS}})$ to return the out of resources error $\tsunknown{ENOBUFS}$ to the caller.
...
\clustersection{(TCP and UDP)}{$\tsunknown{close}()$}
\seccomm{ \[ \tsunknown{close}: \tsunknown{fd} \Mtotype  \tstype{unit} \]
  ...
  \begin{itemize}
   ...
   \item A TCP socket may have the $\tsunknown{SO\_LINGER}$ option set which specifies a maximum duration in
    seconds that a $\tsunknown{close}(\tsunknown{fd})$ call is permitted to block.
    \begin{itemize}

      \item In the normal case the $\tsunknown{SO\_LINGER}$ option is not set, the close call returns
       immediately and asynchronously sends any remaining data and gracefully closes the connection.

      \item If $\tsunknown{SO\_LINGER}$ is set to a non-zero duration, the $\tsunknown{close}(\tsunknown{fd})$ call will block while
      ...
      \item The $\tsunknown{SO\_LINGER}$ option may be set to zero to indicate that $\tsunknown{close}(\tsunknown{fd})$ should be
   ...
   \item If $\tsunknown{close}(\tsunknown{fd})$ is called on a TCP socket in a pre-established state the file description
    and socket are simply closed and removed, regardless of how $\tsunknown{SO\_LINGER}$ is set, except on
    Linux platforms where $\tsunknown{SYN\_RECEIVED}$ is dealt with as an established state for the purposes of
...
\seccomm{
  ...
  $\tsunknown{recv}()$, but the $\tsunknown{SO\_LINGER}$ option is not set. $\tsunknown{close}()$ is then called and the connection
...
$\tsrule{close\_7}$
& \textbf{tcp: fast succeed}
&  Successfully close the last file descriptor for a socket in the $\tsunknown{CLOSED}$, $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$ states. \\
$\tsrule{close\_8}$
& \textbf{tcp: fast succeed}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds}' \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    the successful return state $\tsunknown{Ret} (\tsunknown{OK}())$. In the final host state, the mapping of file
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})],\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds}';{}\\{}
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')],\tsvar{MM})}
{(\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED};\tsunknown{FIN\_WAIT\_1};\tsunknown{CLOSING};\tsunknown{FIN\_WAIT\_2};{}\\{}
\quad\quad\quad\quad \tsunknown{TIME\_WAIT};\tsunknown{CLOSE\_WAIT};\tsunknown{LAST\_ACK}\} \Mvee {}\\{}
 \tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  {}\\{}
 (\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) = \infty \Mvee {}\\{}
 \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue  \Mwedge  \tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) \neq  0 \Mwedge  \neg{}\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsunknown{fid\_ref\_count}(\tsvar{fds},\tsvar{fid}) = 1 \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    $\geq  \tsunknown{ESTABLISHED}$, or on Linux it may be in the $\tsunknown{SYN\_RECEIVED}$ state.

    In the common case the socket's linger option is not set, $\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) = \infty$, and
    regardless of whether the socket is in non-blocking mode or not, i.e. $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK})$ is
    unconstrained, the call to $\tsunknown{close}()$ proceeds successfully without blocking.

    On all platforms except for Linux, if the socket is in non-blocking mode $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) =
\Mtrue $ the linger option may be set with a positive duration: $\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) \neq  0)$. In
    ...
    The $\tsunknown{close}(\tsvar{fd})$ call proceeds by a $\MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})}$ transition leaving the host in
    the successful return state $\tsunknown{Ret} (\tsunknown{OK}())$. The final socket is marked as unable to send and
...
Linux
&
    The socket can be in the $\tsunknown{SYN\_RECEIVED}$ state or in one of the synchronised states $\geq
\tsunknown{ESTABLISHED}$.

    On Linux, non-blocking semantics do not take precedence over the $\tsunknown{SO\_LINGER}$ option, i.e. if
    the socket is non-blocking, $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue $ and a linger option is set to a non-zero
    value, $\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) \neq  0$, the socket may block on a call to $\tsunknown{close}()$. See also
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}};{}\\{}
 ...
 \tsvar{SS}'',\tsvar{MM})}
{(\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED};\tsunknown{FIN\_WAIT\_1};\tsunknown{CLOSING};\tsunknown{FIN\_WAIT\_2};{}\\{}
\quad\quad\quad \tsunknown{TIME\_WAIT};\tsunknown{CLOSE\_WAIT};\tsunknown{LAST\_ACK}\} \Mvee {}\\{}
 \tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  {}\\{}
...
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)) \Mwedge {}\\{}
 \tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) = 0 \Mwedge   {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsunknown{fid\_ref\_count}(\tsvar{fds},\tsvar{fid}) = 1 \Mwedge {}\\{}
 \tsvar{fds}' = \tsvar{fds} \backslash{}\backslash{} \tsvar{fd} \Mwedge {}\\{}
 ...
 \tsvar{SS} = \tsvar{SS}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s})] \Mwedge {}\\{}
 \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 \tsvar{SS}' = \tsvar{SS}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')] \Mwedge {}\\{}
 \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsvar{SS}' \;\tsvar{SS}''}
{\rulesubsection{Description}

    A $\tsunknown{close}(\tsvar{fd})$ call is performed on the TCP socket $\tsvar{sid}$ referenced by file descriptor $\tsvar{fd}$
    which is the only file descriptor referencing the socket's file description:
    $\tsunknown{fid\_ref\_count}(\tsvar{fds},\tsvar{fid}) = 1$. The TCP socket $\tsvar{sid}$ is in a synchronised state, i.e. a state >=
    $\tsunknown{ESTABLISHED}$, except on Linux platforms where it may be in the $\tsunknown{SYN\_RECEIVED}$ state.

    The socket's linger option is set to a duration of zero, $\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) = 0$, to signify
    that an abortive closure of socket $\tsvar{sid}$ is required.

    The $\tsunknown{close}(\tsvar{fd})$ call proceeds by a $\MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})}$ transition leaving the host in
    the successful return state $\tsunknown{Ret} (\tsunknown{OK}())$. A reset segment $\tsunknown{seg}$ is constructed from the
    ...
    from the finite map of file descriptions. The socket is put in the $\tsunknown{CLOSED}$ state, shutdown
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Close2}(\tsvar{sid})}{\tsunknown{slow\_timer} (\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}))}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds}';{}\\{}
 \tsvar{files} \Mass  \tsvar{files};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(*,\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\Mtrue ,\Mtrue ,{}\\{}
...
\quad\quad\quad \tsunknown{TIME\_WAIT};\tsunknown{CLOSE\_WAIT};\tsunknown{LAST\_ACK}\} \Mvee {}\\{}
 \tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  {}\\{}
 \tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) \notin  \{0; \infty\} \Mwedge {}\\{}
 (\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mfalse  \Mvee  (\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue  \Mwedge  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch})) \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsunknown{fid\_ref\_count}(\tsvar{fds},\tsvar{fid}) = 1 \Mwedge {}\\{}
 \tsvar{fds}' = \tsvar{fds} \backslash{}\backslash{} \tsvar{fd} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mfalse $, and is in a synchronised state, i.e. a state $\geq  \tsunknown{ESTABLISHED}$.

    On Linux, the socket is also permitted to be in the $\tsunknown{SYN\_RECEIVED}$ state and it may have
    non-blocking semantics $\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue $, because the linger option takes precedence over
    ...
    not been set), $\tsvar{sf}.\tsunknown{t}(\tsunknown{SO\_LINGER}) \notin  \{0; \infty\}$. The close call blocks for a
    ...
    The $\tsunknown{close}(\tsvar{fd})$ call proceeds by a $\MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})}$ transition leaving the host in
    the blocked state $\tsunknown{Close2}(\tsvar{sid})$.  The socket is marked as unable to send and receive
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Close2}(\tsvar{sid})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(*,\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\Mtrue ,\Mtrue ,{}\\{}
...
\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{st} \;\in  \{\tsunknown{TIME\_WAIT};\tsunknown{CLOSED};\tsunknown{FIN\_WAIT\_2}\}{}\\{}
 }
{\rulesubsection{Description}

    A previous call to $\tsunknown{close}()$ with the linger option set on the socket blocked leaving thread
    $\tsvar{tid}$ in the $\tsunknown{Close2}(\tsvar{sid})$ state. The socket $\tsvar{sid}$ has successfully transmitted all the
    data in its send queue, $\tsvar{sndq} = [\,]$, and has completed a graceful close of the connection: $\tsvar{st}
\in  \{\tsunknown{TIME\_WAIT}; \tsunknown{CLOSED}; \tsunknown{FIN\_WAIT\_2}\}$.

    The rule proceeds via a $\MLhtau $ transition leaving thread $\tsvar{tid}$ in the $\tsunknown{Ret}(\tsunknown{OK} ())$
...
\rrulecc{closeTVI}{close\_6}{tcp: slow nonurgent fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$: unsuccessful completion of a lingering close on a synchronised socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Close2}(\tsvar{sid})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})]{}\\{}
 \Mmagicbolrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})]{}\\{}
 \Mmagicbolrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
...
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)) \Mwedge {}\\{}
 ...
 \tsvar{st} \;\notin  \{\tsunknown{TIME\_WAIT}; \tsunknown{CLOSED}\}}
{\rulesubsection{Description}

    A previous call to $\tsunknown{close}()$ with the linger option set on the socket blocked, leaving thread
    $\tsvar{tid}$ in the $\tsunknown{Close2}(\tsvar{sid})$ state. The linger timer has expired, $\tsunknown{timer\_expires} \;\tsvar{d}$, before
    the socket has been successfully closed: $\tsvar{st} \;\notin  \{\tsunknown{TIME\_WAIT}; \tsunknown{CLOSED}\}$.

    The rule proceeds via a $\MLhtau $ transition leaving thread $\tsvar{tid}$ in the $\tsunknown{Ret}(\tscon{FAIL}\;{\tsunknown{EAGAIN}})$
    ...
    of these operations, i.e. $\tsvar{st} \;\notin  \{\tsunknown{TIME\_WAIT}; \tsunknown{CLOSED}\}$. When the linger timer expires the
...
\rrulecc{closeTVII}{close\_7}{tcp: fast succeed}{\tsholcomm{ Successfully close the last file descriptor for a socket in the $\tsunknown{CLOSED}$, $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$ states. }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds};{}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{ \tsunknown{sched\_timer}}};{}\\{}
 ...
 \tsvar{SS}',\tsvar{MM})}
{(\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED}; \tsunknown{SYN\_SENT}\} \Mvee {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge  \neg{}\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge {}\\{}
 ...
 \tsvar{fds}' = \tsvar{fds} \backslash{}\backslash{} \tsvar{fd} \Mwedge {}\\{}
 {}\\{}
 \Mcase  \;\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED};\tsunknown{LISTEN}\} \Mof {}\\{}
\quad\quad \Mtrue  \Mtotype  \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad \Mdpipe  \Mfalse  \Mtotype  \Mif  \;\tsaux{exists\_quad\_of} \;\tsvar{sock} \;\Mthen {}\\{}
\quad\quad\quad\quad\quad\quad \tsaux{destroy} (\tsaux{quad\_of} \;\tsvar{sock}) \tsvar{SS} \;\tsvar{SS}'{}\\{}
\quad\quad\quad\quad \Melse  \;\tsvar{SS}' = \tsvar{SS}}
{\rulesubsection{Description}
    ...
    synchronised state: $\tsvar{st} \;\in  \{\tsunknown{CLOSED}; \tsunknown{SYN\_SENT}\}$.

    The $\tsunknown{close}(\tsvar{fd})$ call proceeds by a $\MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})}$ transition leaving the host in
    the successful return state $\tsunknown{Ret} (\tsunknown{OK} ())$.
...
Linux
&
    The rule does not apply if the socket is in state $\tsunknown{SYN\_RECEIVED}$: for the purposes of
    ...
    socket's $\tsunknown{SO\_LINGER}$ option is not constrained because it has no effect regardless of how it
    may be set.
...
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\Msome  \;\tsvar{lis})) \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsunknown{fid\_ref\_count}(\tsvar{fds},\tsvar{fid}) = 1 \Mwedge {}\\{}
 \tsvar{fid} \;\notin  (\Mfdom{\tsvar{files}}) \Mwedge {}\\{}
...
\quad\quad \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) (\tsvar{SS} \Mfapply{}{\tsvar{streamid}}) (\tsvar{SS}' \Mfapply{}{\tsvar{streamid}})) \Mwedge {}\\{}
 {}\\{}
...
\quad\quad \tsvar{SS}' \Mfapply{}{\tsvar{streamid}} = \tsvar{SS} \Mfapply{}{\tsvar{streamid}}) \Mwedge {}\\{}
 {}\\{}
 \tsvar{fds}' = \tsvar{fds} \backslash{}\backslash{} \tsvar{fd} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad (\tsvar{sock}.\tsvar{is}_{1},\tsvar{sock}.\tsvar{ps}_{1},\tsvar{sock}.\tsvar{is}_{2},\tsvar{sock}.\tsvar{ps}_{2}) = (\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2}) \} \Min {}\\{}
 ...
 \tsaux{destroy\_quads} \;\tsvar{destroyed} \;\tsvar{SS}' \;\tsvar{SS}''}
{\rulesubsection{Description}
    ...
    local IP addresses $\tsvar{is}_{1}$, and is in the $\tsunknown{LISTEN}$ state.

    The listening socket $\tsvar{sock}$ may have $\tsunknown{ESTABLISHED}$ incoming connections on its connection
    ...
    A set of reset seqments $\tsunknown{rsts\_to\_go}$ is created for each of the sockets referenced by both queues. This is
    ...
    $(\tsvar{sock}'.\tsvar{is}_{1},\tsvar{sock}'.\tsvar{is}_{2},\tsvar{sock}'.\tsvar{ps}_{1},\tsvar{sock}'.\tsvar{ps}_{2})$ and control blocks $\tsvar{cb}$.
...
\rulesubsection{Model details}
    ...
    socket entering the $\tsunknown{LISTEN}$ state.
...
{\rulesubsection{Description}
    ...
    indexed by $\tsvar{fid}$, $\tsunknown{fid\_ref\_count}(\tsvar{fds},\tsvar{fid}) = 1$. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$
    state, a $\tsunknown{close}(\tsvar{fd})$ call is made and succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{close}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}())$. The
...
\clustersection{(TCP and UDP)}{$\tsunknown{connect}()$}
\seccomm{ \[ \tsunknown{connect}: \tsunknown{fd} * \tsunknown{ip} * \tsunknown{port} \;\;\tstype{option} \Mtotype  \tstype{unit} \]
  ...
  $\tsunknown{ECONNRESET}$ or $\tsunknown{ECONNREFUSED}$ error. The local socket must be in the $\tsunknown{CLOSED}$ state: attempts to
  ...
  If the socket is a blocking one (the $\tsunknown{O\_NONBLOCK}$ flag for $\tsunknown{fd}$ is not set), then the call
  ...
  If the socket is non-blocking (the $\tsunknown{O\_NONBLOCK}$ flag is set for $\tsunknown{fd}$), then the $\tsunknown{connect}()$
  ...
  successfully or not. On Linux, unsetting the $\tsunknown{O\_NONBLOCK}$ flag for $\tsunknown{fd}$ and then calling
  ...
  Upon completion of connection establishment the socket will be in state $\tsunknown{ESTABLISHED}$, ready to
  send and receive data, or $\tsunknown{CLOSE\_WAIT}$ if it received a FIN segment during connection
  establishment.
...
&  A connection attempt is already in progress on the socket but not
  yet complete: it is in state $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$. [TCP ONLY]
...
\seccomm{
  If the call blocks then the thread enters state $\tsunknown{Connect2}(\tsunknown{sid})$ where $\tsunknown{sid}$ is the identifier
...
&  Fail with the pending error on a socket in the $\tsunknown{CLOSED}$ state \\
$\tsrule{connect\_4}$
& \textbf{tcp: slow urgent fail}
...
$\tsrule{connect\_5d}$
& \textbf{tcp: block}
&  Block, entering state $\tsunknown{Connect2}$: connection attempt already in progress and connect called with blocking semantics \\
$\tsrule{connect\_6}$
& \textbf{tcp: fast fail}
...
{{}\\{}
 ...
 {}\\{}
 {}\\{}
 \tsholcomm{ Thread $\tsvar{tid}$ is in state $\tsunknown{Run}$ and TCP socket $\tsvar{sid}$ has binding quad $(\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2})$.  }{}\\{}
 \tsvar{h}  = \tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsunknown{ts\_}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
...
\quad \tsholcomm{ Notice that $\tsunknown{auto\_outroute}$ never fails if $\tsvar{is}_{1}\neq *$ (i.e., is specified in the socket). }{}\\{}
 ...
 {}\\{}
 \tsholcomm{ The socket can be in one of two states: (1) it is in state $\tsunknown{CLOSED}$ in which case its
         ...
         is in state $\tsunknown{TIME\_WAIT}$, and either $\tsvar{is}_{2}$ and $\tsvar{ps}_{2}$ are both set or both are not set.
       The fact that BSD allows a $\tsunknown{TIME\_WAIT}$ socket to be reconnected means that some
       fields may contain old data, so we leave them unconstrained here. This is particularly
       important in the $\tsvar{cb}$.
     }{}\\{}
 {}\\{}
 (\tsvar{st} = \tsunknown{CLOSED} \Mwedge  \tsvar{is}_{2} = * \Mwedge  \tsvar{ps}_{2} = * \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad \tsaux{proto\_of} \;\tsvar{s}.\tsvar{pr} = \tsunknown{PROTO\_TCP}) \Mwedge {}\\{}
 ...
 \tsholcomm{ Make a $\tsvar{SYN}$ segment based on the updated control block and the socket's address quad;
     see \ltslink{makeTsynTflgsTdata}{$\tsaux{make\_syn\_flgs\_data}$} for details. }{}\\{}
 ...
 \tsholcomm{ If possible, enqueue the segment $\tsunknown{seg}$ on the host's outqueue. The auxiliary function
     \ltslink{streamTrollbackTtcpToutput}{$\tsunknown{stream\_rollback\_tcp\_output}$} is used for this; if the segment is a well-formed segment,
     ...
     made. }{}\\{}
 \exists \tsvar{outsegs}'.  {}\\{}
 \tsunknown{stream\_rollback\_tcp\_output} \;\Mfalse  (\Msome  \;\tsvar{i}'_{1}, \Msome  \;\tsvar{i}_{2}) \tsvar{h}.\tsvar{arch} \;\tsvar{h}.\tsvar{rttab} \;\tsvar{h}.\tsvar{ifds} \;\tsvar{cb}' (\tsvar{cb}'',\tsvar{es}',\tsvar{outsegs}') \Mwedge {}\\{}
 ...
 {}\\{}
 {}\\{}
 \tsholcomm{ If the socket is a blocking one, its $\tsunknown{O\_NONBLOCK}$ flag is not set, then the call will
         block, entering state $\tsunknown{Connect2}(\tsvar{sid})$ and leaving the socket in state $\tsunknown{SYN\_SENT}$ with
	 ...
	 If the socket is non-blocking, its $\tsunknown{O\_NONBLOCK}$ flag is set, and the segment was enqueued
	 on the host's outqueue, then the call will fail with an $\tsunknown{EINPROGRESS}$ error (or $\tsunknown{EAGAIN}$
	 on WinXP). The socket will be left in state $\tsunknown{SYN\_SENT}$ with peer address $(\Msome  \;\tsvar{i}_{2},\Msome
\tsvar{p}_{2})$. Otherwise, if the segment was not enqueued, then the call will fail with the error
	 ...
	 $\tsunknown{CLOSED}$ with no peer address set.
     }{}\\{}
 {}\\{}
 ...
 ((\neg{}\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) \Mvee  (\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsvar{i}_{2} \;\in  \;\tsunknown{local\_ips} \;\tsvar{h}.\tsvar{ifds})) \Mwedge {}\\{}
\quad\quad \tsvar{t}' = \Mtimed{\tsunknown{Connect2}(\tsvar{sid})}{\tsunknown{never\_timer}} \Mwedge  \tsvar{rc} = \tsunknown{block} \Mwedge {}\\{}
\quad\quad \tsvar{es}''=\tsvar{es}' \Mwedge  \tsvar{st}' = \tsunknown{SYN\_SENT} \Mwedge  \tsvar{is}'_{2} = \Msome  \;\tsvar{i}_{2} \Mwedge  \tsvar{ps}'_{2} = \Msome  \;\tsvar{p}_{2} \Mwedge {}\\{}
...
\quad\quad\quad \tsvar{SS}' = \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]) \Mvee {}\\{}
 \tsholcomm{ non-blocking socket }{}\\{}
 (\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) \Mwedge {}\\{}
...
\quad\quad \tsvar{t}' = \Mtimed{\tsunknown{Ret}(\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}} \Mwedge  \tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail} \Mwedge  \tsvar{es}''=* \Mwedge {}\\{}
\quad\quad \Mif  \neg{}\tsvar{queued} \;\Mthen {}\\{}
\quad\quad\quad\quad \tsvar{st}' = \tsunknown{CLOSED} \Mwedge  \tsvar{is}'_{2} = * \Mwedge  \tsvar{ps}'_{2} = * \Mwedge {}\\{}
\quad\quad\quad\quad \tsholcomm{ under BSD $\tsvar{st}$ could be $\tsunknown{TIME\_WAIT}$ }{}\\{}
\quad\quad\quad\quad \tsholcomm{ REMARK this fail quick behaviour breaks abstraction boundaries }{}\\{}
\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad \Melse {}\\{}
\quad\quad\quad\quad \tsvar{st}' = \tsunknown{SYN\_SENT} \Mwedge  \tsvar{is}'_{2} = \Msome  \;\tsvar{i}_{2} \Mwedge  \tsvar{ps}'_{2} = \Msome  \;\tsvar{p}_{2} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]){}\\{}
 )}
{\rulesubsection{Description}

   From thread $\tsvar{tid}$, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ call is made where $\tsvar{fd}$ refers to a TCP
   socket. The socket is in state $\tsunknown{CLOSED}$ with no peer address set, no pending error, and not
   ...
   If the socket is a blocking one (its $\tsunknown{O\_NONBLOCK}$ flag is not set) then the call will block: a
   $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})}$ transition is made, leaving the thread state
   $\tsunknown{Connect2}(\tsvar{sid})$. If the socket is non-blocking (its $\tsunknown{O\_NONBLOCK}$ flag is set) and the segment
   enqueuing was successful then the call will fail: a $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})}$
   transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINPROGRESS}})$ (or $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})$ on WinXP); connection establishment will proceed asynchronously. Otherwise, if the enqueueing did not succeed, the call will fail with an
   ...
   in state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$.
...
FreeBSD
&
   The socket may also be in state $\tsunknown{TIME\_WAIT}$ when the $\tsunknown{connect}()$ call is made, with either
...
\rrulecc{connectTIa}{connect\_1a}{tcp: rc}{\tsholcomm{ Begin connection establishment by creating a SYN and trying to enqueue it on host's outqueue }}
{(\tsvar{h},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h}',\tsvar{SS}',\tsvar{MM})}
{{}\\{}
...
\quad \tsholcomm{ Notice that $\tsunknown{auto\_outroute}$ never fails if $\tsvar{is}_{1}\neq *$ (i.e., is specified in the socket). }{}\\{}
 ...
 {}\\{}
 (\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsvar{st} = \tsunknown{TIME\_WAIT} \Mwedge {}\\{}
...
\quad\quad \tsvar{t}' = \Mtimed{\tsunknown{Connect2}(\tsvar{sid})}{\tsunknown{never\_timer}} \Mwedge  \tsvar{rc} = \tsunknown{block} \Mwedge {}\\{}
\quad\quad \tsvar{es}''=\tsvar{es}' \Mwedge  \tsvar{st}' = \tsunknown{SYN\_SENT} \Mwedge  \tsvar{is}'_{2} = \Msome  \;\tsvar{i}_{2} \Mwedge  \tsvar{ps}'_{2} = \Msome  \;\tsvar{p}_{2} \Mwedge {}\\{}
\quad\quad\quad \tsholcomm{ BSD and $\tsvar{st}=\tsunknown{TIME\_WAIT}$, so new new stream created }{}\\{}
\quad\quad\quad \tsvar{lbl} = \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})} \Mwedge {}\\{}
\quad\quad\quad \tsvar{SS} = \tsvar{SS}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})]  \Mwedge {}\\{}
\quad\quad\quad \tsaux{write} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
\quad\quad\quad \tsvar{SS}' = \tsvar{SS}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})]) \Mvee {}\\{}
 \tsholcomm{ non-blocking socket }{}\\{}
 (\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) \Mwedge {}\\{}
\quad\quad \tsvar{es} = * \Mwedge {}\\{}
\quad\quad (\tsvar{err} = (\Mif  \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsunknown{EAGAIN} \;\Melse  \;\tsunknown{EINPROGRESS}) \Mvee  \Msome  \;\tsvar{err} = \tsvar{es}') \Mwedge {}\\{}
...
\quad\quad \Mif  \neg{}\tsvar{queued} \;\Mthen {}\\{}
\quad\quad\quad\quad \tsvar{st}' = \tsunknown{CLOSED} \Mwedge  \tsvar{is}'_{2} = * \Mwedge  \tsvar{ps}'_{2} = * \Mwedge {}\\{}
\quad\quad\quad\quad \tsholcomm{ under BSD $\tsvar{st}=\tsunknown{TIME\_WAIT}$, and we destroy a stream }{}\\{}
\quad\quad\quad\quad \tsholcomm{ REMARK this fail quick behaviour breaks abstraction boundaries }{}\\{}
\quad\quad\quad\quad {}\\{}
\quad\quad\quad\quad \exists  \tsvar{i}_{1} \;\tsvar{p}_{1}. (\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1}) = (\tsvar{is}_{1},\tsvar{ps}_{1}) \Mwedge {}\\{}
\quad\quad\quad\quad \tsaux{destroy} (\tsvar{i}'_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsvar{SS} \;\tsvar{SS}' \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad \tsvar{SS} = \tsvar{SS}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})]  \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsaux{write} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}'_{1},\tsvar{p}'_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')]){}\\{}
 {}\\{}
 )}
{\rulesubsection{Description}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Connect2} \;\tsvar{sid}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{pr} \Mwedge {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED};\tsunknown{CLOSE\_WAIT}\} \Mwedge {}\\{}
 (\neg{}\exists \tsvar{tid}' \;\tsvar{d}'. (\tsvar{tid}' \;\in  \Mfdom{\tsvar{ts}}) \Mwedge  (\tsvar{tid}' \neq  \tsvar{tid}) \Mwedge {}\\{}
\quad\quad\quad\quad\quad\quad \tsvar{ts} \Mfapply{}{\tsvar{tid}'} = \Mtimed{\tsunknown{Connect2} \;\tsvar{sid}}{\tsvar{d}'})}
{\rulesubsection{Description}

   Thread $\tsvar{tid}$ is blocked in state $\tsunknown{Connect2}(\tsvar{sid})$ where $\tsvar{sid}$ identifies a TCP socket which
   is in state $\tsunknown{ESTABLISHED}$: the connection establishment has been successfully completed; or
   $\tsunknown{CLOSE\_WAIT}$: connection establishment successfully completed but a $\tsvar{FIN}$ was received during
   ...
   A $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK} ())$.

\rrulepad }


\rrulecc{connectTIII}{connect\_3}{tcp: slow urgent fail}{\tsholcomm{ Fail with the pending error on a socket in the $\tsunknown{CLOSED}$ state }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Connect2} \;\tsvar{sid}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  \Msome  \;\tsvar{e} \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  * \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = \tsvar{sock}.\tsvar{pr} \Mwedge {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED}}
{\rulesubsection{Description}

   Thread $\tsvar{tid}$ is blocked in the $\tsunknown{Connect2}(\tsvar{sid})$ state where $\tsvar{sid}$ identifies a TCP socket
   $\tsvar{sock}$ that is in the $\tsunknown{CLOSED}$ state: connection establishment has failed, leaving the socket
   ...
   A $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$.
...
\quad [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock}')] \Mmagicrrec ,{}\\{}
 \tsvar{SS}',\tsvar{MM})}
...
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{SYN\_SENT},\tsvar{cb},*)) \Mwedge {}\\{}
 {}\\{}
...
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{SYN\_SENT},\tsvar{cb},*)) \Mwedge {}\\{}
\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad \Melse {}\\{}
\quad\quad\quad \tsvar{sock}' = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\tsvar{ps}_{1},*,*,*,\Mfalse ,\Mfalse ,{}\\{}
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{CLOSED},\tsaux{initial\_cb},*)) \Mwedge {}\\{}
\quad\quad\quad \Mcase  \;\tsvar{ps}_{1} \;\Mof  \;\Msome  \;\tsvar{p}_{1} \Mtotype  \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsvar{SS} \;\tsvar{SS}'{}\\{}
\quad\quad\quad\quad\quad \Mdpipe  * \Mtotype  \tsvar{SS}' = \tsvar{SS}{}\\{}
 \Melse {}\\{}
...
\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{CLOSED},\tsvar{cb}',*)) \Mwedge {}\\{}
\quad \tsvar{cb}' = \tsaux{initial\_cb} \Mwedge {}\\{}
\quad \Mcase  \;\tsvar{ps}_{1} \;\Mof  \;\Msome  \;\tsvar{p}_{1} \Mtotype  \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsvar{SS} \;\tsvar{SS}'{}\\{}
\quad\quad\quad \Mdpipe  * \Mtotype  \tsvar{SS}' = \tsvar{SS}}
{\rulesubsection{Description}

   Thread $\tsvar{tid}$ is blocked in the $\tsunknown{Connect2}(\tsvar{sid})$ state waiting for a connection to be
   ...
   socket is in state $\tsunknown{SYN\_SENT}$, is not listening, has empty send and receive queues, and no
   urgent marks set. The call fails, returning the pending error.

   A $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$. The socket is
   left in state $\tsunknown{CLOSED}$ with its peer address not set, its pending error cleared, and its control
...
&
   ...
   the socket stays the same: it is in state $\tsunknown{SYN\_SENT}$ so the $\tsvar{SYN}$ will be retransmitted until
   it times out.
...
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = \tsvar{sock}.\tsvar{pr} \Mwedge {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED}  \}}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ call is
    made. $\tsvar{fd}$ refers to a TCP socket $\tsvar{sock}$, identified by $\tsvar{sid}$, with pending error $\tsvar{err}$
    and in state $\tsunknown{CLOSED}$. The call fails with the pending error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsunknown{ip},\tsunknown{port})}$ transition is made, leaving the thread state $\tsunknown{Ret}
...
\rrulecc{connectTV}{connect\_5}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EALREADY}$, $\tsunknown{EINVAL}$, $\tsunknown{EISCONN}$, $\tsunknown{EOPNOTSUPP}$: socket already in use }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
\quad\quad \tsunknown{SYN\_SENT}     \Mtotype  \Mif      \;\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue  \;\Mthen  \;\tsvar{err} = \tsunknown{EALREADY} \tsholcomm{ connection already in progress }{}\\{}
...
\quad\quad \tsunknown{SYN\_RECEIVED} \Mtotype  \Mif      \;\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) = \Mtrue  \;\Mthen  \;\tsvar{err} = \tsunknown{EALREADY} \tsholcomm{ connection already in progress }{}\\{}
...
\quad\quad \tsunknown{LISTEN}      \Mtotype  \Mif       \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{err} = \tsunknown{EINVAL}  \tsholcomm{ socket is listening }{}\\{}
...
\quad\quad \tsunknown{ESTABLISHED} \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe   \tsholcomm{ socket already connected }{}\\{}
\quad\quad \tsunknown{FIN\_WAIT\_1} \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe    \tsholcomm{ socket already connected }{}\\{}
\quad\quad \tsunknown{FIN\_WAIT\_2} \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe    \tsholcomm{ socket already connected }{}\\{}
\quad\quad \tsunknown{CLOSING} \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe       \tsholcomm{ socket already connected }{}\\{}
\quad\quad \tsunknown{CLOSE\_WAIT} \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe    \tsholcomm{ socket already connected }{}\\{}
\quad\quad \tsunknown{LAST\_ACK} \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe      \tsholcomm{ socket already connected; seems that fd is valid in this state }{}\\{}
\quad\quad \tsunknown{TIME\_WAIT} \Mtotype  (\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mvee  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad \tsholcomm{ BSD allows a $\tsunknown{TIME\_WAIT}$ socket to be reconnected }{}\\{}
\quad\quad \tsunknown{CLOSED} \Mtotype  \tsvar{err} = \tsunknown{EINVAL} \Mwedge  \tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}}
{\rulesubsection{Description}

   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ call is made
   where $\tsvar{fd}$ refers to a TCP socket identified by $\tsvar{sid}$. The call fails with an error $\tsvar{err}$:
   if the socket is in state $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$ and the socket is non-blocking or the
   host is a WinXP architecture then $\tsvar{err}=\tsunknown{EALREADY}$ ($\tsunknown{EISCONN}$ on FreeBSD); if it is in state $\tsunknown{LISTEN}$ then on WinXP
   ...
   $\tsunknown{ESTABLISHED}$, $\tsunknown{FIN\_WAIT\_1}$, $\tsunknown{FIN\_WAIT\_2}$, $\tsunknown{CLOSING}$, $\tsunknown{CLOSE\_WAIT}$, or $\tsunknown{TIME\_WAIT}$ on
   Linux and WinXP, $\tsvar{err}=\tsunknown{EISCONN}$; if it is in state $\tsunknown{CLOSED}$ on FreeBSD and has its
   $\tsunknown{bsd\_cantconnect}$ flag set then $\tsvar{err}=\tsunknown{EINVAL}$.

   A $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tscon{FAIL}\;{\tsvar{err}})$.
...
FreeBSD
&
   If the socket is in state $\tsunknown{TIME\_WAIT}$ then the call does not fail: the socket may be
...
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{is}_{1} \Mass  \tsvar{is}'_{1}; \tsvar{ps}_{1} \Mass  \tsvar{ps}'_{1} \Mmagicrrec )];{}\\{}
 ...
 \tsvar{SS},\tsvar{MM})}
{\tsholcomm{ REMARK although this rule may result in a quad becoming bound, we assume $(\tsvar{i}_{2},\tsvar{p}_{2})$ not bound }{}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   set. The { $\tsunknown{test\_outroute\_ip}$} function is used to check if there is a route from the host
...
\rrulecc{connectTVb}{connect\_5b}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRINUSE}$: address already in use }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock})];{}\\{}
 \tsvar{bound} \Mass  \tsvar{bound} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRINUSE}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\rrulecc{connectTVc}{connect\_5c}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRNOTAVAIL}$: no ephemeral ports left }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRNOTAVAIL}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ is made. $\tsvar{fd}$
...
\rrulecc{connectTVd}{connect\_5d}{tcp: block}{\tsholcomm{ Block, entering state $\tsunknown{Connect2}$: connection attempt already in progress and connect called with blocking semantics }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Connect2}(\tsvar{sid})}{\tsunknown{never\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{pr} \Mwedge {}\\{}
 ...
 \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}\}}
{\rulesubsection{Description}

   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ call is
   made. $\tsvar{fd}$ refers to a TCP socket identified by $\tsvar{sid}$ which is in state $\tsunknown{SYN\_SENT}$ or
   $\tsunknown{SYN\_RECEIVED}$: in other words, a connection attempt is already in progress for the socket
   (this could be an asynchronous connection attempt or one in another thread). The open file
   description referred to by $\tsvar{fd}$ does not have its $\tsunknown{O\_NONBLOCK}$ flag set so the call blocks,
...
\rrulecc{connectTVI}{connect\_6}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$: socket has been shutdown for writing }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{cantsndmore} \Mass  \Mtrue ; \tsvar{pr} \Mass  \tscon{TCP\_PROTO}(\tsvar{tcp} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{CLOSED} \Mmagicrrec ) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{cantsndmore} \Mass  \Mtrue ; \tsvar{pr} \Mass  \tscon{TCP\_PROTO}(\tsvar{tcp} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{CLOSED} \Mmagicrrec ) \Mmagicrrec  )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
     ...
     On FreeBSD, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$
     call is made. $\tsvar{fd}$ refers to a TCP socket $\tsvar{sock}$ identified by $\tsvar{sid}$ which is in state
     $\tsunknown{CLOSED}$ and has been shutdown for writing.
...
{(\tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
      ...
      set. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\tsvar{ps}_{2})$ call is
      ...
      A $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i}_{2},\tsvar{ps}_{2})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. The socket's local address is set to $(\Msome  \;\tsvar{i}'_{1},\Msome  \;\tsvar{p}'_{1})$, and its peer address
...
\tsvar{p}_{1})$. Its peer address may or may not be set. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$
     ...
     in state $\tsunknown{Ret} (\tsunknown{OK}())$. The socket has its peer address set to $(\Msome  \;\tsvar{i},\tsvar{ps})$.
...
\rrulecc{connectTIX}{connect\_9}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRNOTAVAIL}$: port must be specified in $\tsunknown{connect}()$ call on FreeBSD }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRNOTAVAIL}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i},*)$ call is made. Because no port is specified, the call
    fails with an $\tsunknown{EADDRNOTAVAIL}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i},*)}$ transition is made, leaving the thread state $\tsunknown{Ret}
...
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i},\tsvar{ps})} }{1}}
{(\tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
     ...
     $\tsvar{err}$. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{connect}(\tsvar{fd},\tsvar{i},\tsvar{ps})$ call is
     ...
     A $\MLhcall{\tsvar{tid}}{\tsunknown{connect}(\tsvar{fd},\tsvar{i},\tsvar{ps})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$. The socket's peer address is set to $(\Msome  \;\tsvar{i},\tsvar{ps})$, and the error is cleared from the
     socket.
...
\clustersection{(TCP and UDP)}{$\tsunknown{disconnect}()$}
...
\rrulecc{disconnectTIV}{disconnect\_4}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAFNOSUPPORT}$: address family not supported; $\tsunknown{EOPNOTSUPP}$: operation not supported; $\tsunknown{EALREADY}$: connection already in progress; or $\tsunknown{EISCONN}$: socket already connected }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \neg{}(\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge {}\\{}
 \Mcase  \;\tsunknown{tcp\_sock}.\tsvar{st} \;\Mof {}\\{}
\quad\quad \tsunknown{CLOSED}      \Mtotype  \Mif  \;\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{err} = \tsunknown{EINVAL} \Mvee  \tsvar{err} = \tsunknown{EAFNOSUPPORT}{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad \Melse  \;\tsvar{err} = \tsunknown{EAFNOSUPPORT} \Mdpipe {}\\{}
\quad\quad \tsunknown{LISTEN}      \Mtotype  \Mif       \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{err} = \tsunknown{EAFNOSUPPORT}  \tsholcomm{ socket is listening }{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad \Melse  \;\Mif  \;\tsunknown{bsd\_arch}     \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{err} = \tsunknown{EOPNOTSUPP}{}\\{}
...
\quad\quad \tsunknown{SYN\_SENT}    \Mtotype  \tsvar{err} = \tsunknown{EALREADY} \Mdpipe  \tsholcomm{ connection already in progress }{}\\{}
\quad\quad \tsunknown{SYN\_RECEIVED} \Mtotype  \tsvar{err} = \tsunknown{EALREADY} \Mdpipe  \tsholcomm{ connection already in progress }{}\\{}
\quad\quad \tsunknown{ESTABLISHED}  \Mtotype  \tsvar{err} = \tsunknown{EISCONN} \Mdpipe   \tsholcomm{ socket already connected }{}\\{}
\quad\quad \tsunknown{TIME\_WAIT}    \Mtotype  \Mif  \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{err} = \tsunknown{EISCONN}{}\\{}
...
{\rulesubsection{Description}
    ...
    Consider a TCP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$ on a non-Linux architecture. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$
    state, a $\tsunknown{disconnect}(\tsvar{fd})$ call is made. The call fails with an error $\tsvar{err}$ which depends on
    the the state of the socket: If the socket is in the $\tsunknown{CLOSED}$ state then it fails with
    $\tsunknown{EAFNOSUPPORT}$, except if on FreeBSD its $\tsunknown{bsd\_cantconnect}$ flag is set, in which case it
    fails with $\tsunknown{EINVAL}$;if it is in the $\tsunknown{LISTEN}$ state the error is $\tsunknown{EAFNOSUPPORT}$ on WinXP
    and $\tsunknown{EOPNOTSUPP}$ on FreeBSD; if it is in the $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$ state the error
    is $\tsunknown{EALREADY}$; if it is in the $\tsunknown{ESTABLISHED}$ state the error is $\tsunknown{EISCONN}$; if it is in the
    $\tsunknown{TIME\_WAIT}$ state the error is $\tsunknown{EISCONN}$ on WinXP and $\tsunknown{EAFNOSUPPORT}$ on FreeBSD; in all
    other states the error is $\tsunknown{EISCONN}$.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{disconnect}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$ where $\tsvar{err}$ is one of the above errors.
...
{\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = \tsvar{sock}.\tsvar{pr} \Mwedge {}\\{}
 (\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{SYN\_RECEIVED}; \tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSE\_WAIT}\} \Mthen {}\\{}
\quad\quad \tsaux{tcp\_drop\_and\_close} \;\tsvar{h}.\tsvar{arch} \;* \;\tsvar{sock} (\tsvar{sock}',(\tsvar{oflgs},\tsvar{odata})) \Mwedge {}\\{}
...
\quad\quad\quad\quad \tsaux{destroy} (\tsaux{quad\_of} \;\tsvar{sock}) (\tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsaux{quad\_of} \;\tsvar{sock}),\tsvar{s}')]) \tsvar{SS}'{}\\{}
\quad\quad \Melse {}\\{}
\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
 \Melse {}\\{}
\quad\quad \tsvar{sock} = \tsvar{sock}' \Mwedge {}\\{}
\quad\quad \tsvar{oq} = \tsvar{oq}' \Mwedge {}\\{}
\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
 )}
{\rulesubsection{Description}

    On Linux, consider a TCP socket $\tsvar{sid}$, referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in
    the $\tsunknown{Run}$ state, a $\tsunknown{disconnect}(\tsvar{fd})$ call is made and succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{disconnect}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. If the socket is in the $\tsunknown{SYN\_RECEIVED}$, $\tsunknown{ESTABLISHED}$, $\tsunknown{FIN\_WAIT\_1}$,
    $\tsunknown{FIN\_WAIT\_2}$, or $\tsunknown{CLOSE\_WAIT}$ state then the connection is dropped, a RST segment is
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsunknown{ts\_}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid}, \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},\tscon{UDP\_PROTO}(\tsvar{udp})))]{}\\{}
 ...
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{disconnect}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsunknown{ts\_}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsvar{ret})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 (\Mif  \;\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{ret} = \tsunknown{OK}(){}\\{}
 \Melse  \;\Mif  \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \exists \tsvar{i}'_{2}.\tsvar{is}_{2}=\Msome  \;\tsvar{i}'_{2} \;\Mthen  \;\tsvar{ret} = \tsunknown{OK}(){}\\{}
...
{\rulesubsection{Description}
    ...
    quad. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{disconnect}(\tsvar{fd})$ call is made. On
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{disconnect}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}())$
    or $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAFNOSUPPORT}})$. The socket has its peer address set to $(*,*)$, and its
...
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{disconnect} \;\tsvar{fd}} }{1}}
{(\tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsunknown{ts\_}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tsvar{ret})}{ \tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid}, \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},*,\Msome  \;\tsvar{p}_{1},*,*,\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},\tscon{UDP\_PROTO}(\tsvar{udp})))];{}\\{}
 \tsvar{bound} \Mass  \tsvar{sid}\Mcons \tsvar{h}_{0}.\tsvar{bound} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{h}_{0} = \tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsunknown{ts\_}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    $(*,*,*,*)$. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{disconnect}(\tsvar{fd})}$ transition is made, leaving the thread either in state $\tsunknown{Ret}
(\tsunknown{OK}())$, or in state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAFNOSUPPORT}})$. The socket is autobound to a local ephemeral
...
\rrulecc{disconnectTIII}{disconnect\_3}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$, $\tsunknown{EADDRNOTAVAIL}$, or $\tsunknown{ENOBUFS}$: there are no ephemeral ports left }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{disconnect} \;\tsvar{fd}} }{1}}
{(\tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{h}_{0} = \tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},*,*,*,*,\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},\tscon{UDP\_PROTO}(\tsvar{udp})))] \Mmagicrrec  \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{disconnect}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$ where $\tsvar{e}$ is one of the above errors.

\rrulepad }


\clustersection{(TCP and UDP)}{$\tsunknown{dup}()$}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} \;\tsvar{fd}')}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{fds} \Mass  \tsvar{fds}' \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{dup}(\tsvar{fd})$ call is made where $\tsvar{fd}$ is a
   file descriptor referring to an open file description identified by $\tsvar{fid}$. A new file
   descriptor, $\tsvar{fd}'$ can be created in an architecture-specific way according to the { $\tsunknown{nextfd}$}
   function. $\tsvar{fd}'$ is less than the maximum open file descriptor, $\tsunknown{OPEN\_MAX\_FD}$. The call
   succeeds returning $\tsvar{fd}'$.

   A $\MLhcall{\tsvar{tid}}{\tsunknown{dup}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK} \;\tsvar{fd}')$. The
...
\rrulecc{dupTII}{dup\_2}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EMFILE}$: no more file descriptors available }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{dup}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMFILE}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{unix\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{dup}(\tsvar{fd})$ call is made where $\tsvar{fd}$ is
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{dup}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMFILE}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{dupfd}()$}
...
{\tsunknown{unix\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \tsvar{fid} = \tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsvar{n} \geq  0 \Mwedge {}\\{}
 \tsunknown{FD} (\tsholop{Num} \;\tsvar{n}) < \tsunknown{OPEN\_MAX\_FD} \Mwedge   {}\\{}
 \tsvar{fd}' = \tsunknown{FD} (\tsholop{LEAST} \;\tsvar{n}'. \tsholop{Num} \;\tsvar{n} \leq  \tsvar{n}' \Mwedge  \tsunknown{FD} \;\tsvar{n}' < \tsunknown{OPEN\_MAX\_FD} \Mwedge  \tsunknown{FD} \;\tsvar{n}' \;\notin  \Mfdom{\tsvar{fds}}) \Mwedge {}\\{}
 \tsvar{fds}' = \tsvar{fds} \oplus  (\tsvar{fd}', \tsvar{fid})}
{\rulesubsection{Description}

   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})$ call is made. The host's
   ...
   A $\MLhcall{\tsvar{tid}}{\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}
...
\rrulecc{dupfdTIII}{dupfd\_3}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$: $\tsvar{n}$ is negative or greater than the maximum allowed file descriptor }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{unix\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})$ call is made. $\tsvar{n}$ is
   ...
   A $\MLhcall{\tsvar{tid}}{\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})$.
...
\rrulecc{dupfdTIV}{dupfd\_4}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EMFILE}$: no more file descriptors available }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMFILE}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{unix\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsvar{n} \geq  0 \Mwedge {}\\{}
 \tsvar{fd}' = \tsunknown{FD} (\tsholop{LEAST} \;\tsvar{n}'. \tsholop{Num} \;\tsvar{n} \leq  \tsvar{n}' \Mwedge  \tsunknown{OPEN\_MAX\_FD} \leq  \tsunknown{FD} \;\tsvar{n}' \Mwedge  \tsunknown{FD} \;\tsvar{n}' \;\notin  \Mfdom{\tsvar{h}.\tsvar{fds}})}
{\rulesubsection{Description}

   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})$ call is made. $\tsvar{fd}$ is a
   ...
   A $\MLhcall{\tsvar{tid}}{\tsunknown{dupfd}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMFILE}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getfileflags}()$}
\seccomm{ \[ \tsunknown{getfileflags}: \tsunknown{fd} \Mtotype  \tsunknown{filebflag} \;\tstype{list} \]
   ...
   \begin{itemize}
     \item $\tsunknown{O\_ASYNC}$ Reports whether signal driven I/O is enabled.
     \item $\tsunknown{O\_NONBLOCK}$ Reports whether a socket is non-blocking.
   \end{itemize}
  ...
  \end{tabular}
   ...
   \begin{itemize}
     ...
     \item \wasverb{cmd} is a command to perform an operation on the file. This is set to
      ...
      \wasverb{FIONBIO} to get the $\tsunknown{O\_NONBLOCK}$ flag; there is no $\tsunknown{O\_ASYNC}$ flag on WinXP.
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} \;\tsvar{flags})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getfileflags}(\tsvar{fd})$ call is made. $\tsvar{fd}$
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getfileflags}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}(\tsvar{flags}))$.

\rrulepad }


\clustersection{(TCP and UDP)}{$\tsunknown{getifaddrs}()$}
...
{(\tsvar{h} \; \;\tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getifaddrs} ()} }{1}}
{(\tsvar{h} \; \;\tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tsunknown{OK} \;\tsvar{iflist})}{\tsunknown{sched\_timer}}},\tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
     ...
     On a Unix architecture, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getifaddrs}()$
     ...
     A $\MLhcall{\tsvar{tid}}{\tsunknown{getifaddrs}()}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}
\tsvar{iflist})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getpeername}()$}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\tsvar{i}_{2},\tsvar{p}_{2}))}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sock} = \tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\tsvar{p}_{2} = \tsunknown{Port} \;0) \Mwedge  \tsaux{proto\_of} \;\tsvar{sock}.\tsvar{pr} = \tsunknown{PROTO\_UDP}) ) \Mwedge {}\\{}
 ((\forall \tsunknown{tcp\_sock}. \tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \implies {}\\{}
\quad\quad\quad\quad\quad\quad \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{CLOSE\_WAIT}; \tsunknown{LAST\_ACK};{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsunknown{FIN\_WAIT\_1}; \tsunknown{CLOSING}\} \Mvee {}\\{}
\quad\quad\quad\quad\quad\quad (\neg{}\tsvar{sock}.\tsvar{cantrcvmore} \Mwedge  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{FIN\_WAIT\_2}) \Mvee {}\\{}
\quad\quad\quad\quad\quad\quad (\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED}) \Mvee {}\\{}
\quad\quad\quad\quad\quad\quad \tsholcomm{ BSD listen bug }{}\\{}
\quad\quad\quad\quad\quad\quad (\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN}) ) \Mvee {}\\{}
 \tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch}){}\\{}
 {}\\{}
 {}\\{}
 }
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getpeername}(\tsvar{fd})$ call is made. $\tsvar{fd}$
...
\tsvar{i}_{2}$ and its peer port address set to $\Msome  \;\tsvar{p}_{2}$. If $\tsvar{sock}$ is a TCP socket then either it is
    in state $\tsunknown{ESTABLISHED}$, $\tsunknown{CLOSE\_WAIT}$, $\tsunknown{LAST\_ACK}$, $\tsunknown{FIN\_WAIT\_1}$, or $\tsunknown{CLOSING}$; or it is
    in state $\tsunknown{FIN\_WAIT\_2}$ and is not shutdown for reading. The call succeeds, returning
    $(\tsvar{i}_{2},\tsvar{p}_{2})$, the socket's peer address.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getpeername}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret}( \tsunknown{OK}
...
FreeBSD
&
    If $\tsvar{sock}$ is a TCP socket then it may be in state $\tsunknown{LISTEN}$; this is due to the FreeBSD bug
    that allows $\tsvar{listen}()$ to be called on a synchronised socket.

\\\hline
Linux
&
    If $\tsvar{sock}$ is a TCP socket then it may also be in state $\tsunknown{SYN\_RECEIVED}$.

\\\hline
WinXP
&
    If $\tsvar{sock}$ is a UDP socket and has no peer port set, $\tsvar{sock}.\tsvar{ps}_{2} = *$ then the call may
    still succeed with $\tsvar{p}_{2} = \tsunknown{Port} \;0$. Additionally, if $\tsvar{sock}$ is a TCP socket then it may be in
    any state.
...
\rrulecc{getpeernameTII}{getpeername\_2}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTCONN}$: socket not connected to a peer }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getpeername}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sock} = \tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}} \Mwedge {}\\{}
...
\quad\quad\quad \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{CLOSE\_WAIT}; \tsunknown{LAST\_ACK}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{CLOSING} \} \Mvee {}\\{}
\quad\quad\quad (\neg{}\tsvar{sock}.\tsvar{cantrcvmore} \Mwedge  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{FIN\_WAIT\_2}) \Mvee {}\\{}
\quad\quad\quad (\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED}) \Mvee {}\\{}
\quad\quad\quad {}\\{}
\quad\quad\quad \tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch}))}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getpeername}(\tsvar{fd})$ call is made where
    $\tsvar{fd}$ refers to a socket $\tsvar{sock}$ identified by $\tsvar{sid}$. The socket does not have both its peer
    IP and port set, If it is a TCP socket then it is not in state $\tsunknown{ESTABLISHED}$, $\tsunknown{CLOSE\_WAIT}$,
    $\tsunknown{LAST\_ACK}$, $\tsunknown{FIN\_WAIT\_1}$ or $\tsunknown{CLOSING}$; or in state $\tsunknown{FIN\_WAIT\_2}$ and not shutdown for
    reading. The call fails with an $\tsunknown{ENOTCONN}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getpeername}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getsockbopt}()$}
\seccomm{  \[ \tsunknown{getsockbopt}: (\tsunknown{fd} * \tsunknown{sockbflag}) \Mtotype  \tstype{bool} \]
  ...
  \begin{itemize}
    ...
    \item $\tsunknown{SO\_BSDCOMPAT}$ Reports whether the BSD semantics for delivery of ICMPs to UDP sockets
     with no peer address set is enabled.

    \item $\tsunknown{SO\_DONTROUTE}$ Reports whether outgoing messages bypass the standard routing facilities.

    \item $\tsunknown{SO\_KEEPALIVE}$ Reports whether connections are kept active with periodic transmission of
     messages, if this is supported by the protocol.

    \item $\tsunknown{SO\_OOBINLINE}$ Reports whether the socket leaves received out-of-band data (data marked
     urgent) inline.

    \item $\tsunknown{SO\_REUSEADDR}$ Reports whether the rules used in validating addresses supplied to
...
\seccomm{
  ...
  \begin{itemize}
    ...
    \item \wasverb{level} is the protocol level at which the flag resides: \wasverb{SOL\textunderscore{}SOCKET} for
     ...
     \wasverb{option\textunderscore{}name} are limited to: $\tsunknown{SO\_BSDCOMPAT}$, $\tsunknown{SO\_DONTROUTE}$, $\tsunknown{SO\_KEEPALIVE}$,
     $\tsunknown{SO\_OOBINLINE}$, and $\tsunknown{SO\_REUSEADDR}$.
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\tsvar{sf}.\tsunknown{b}(\tsvar{f})))}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
...
\quad \implies  \tsvar{f} \;\notin  \{\tsunknown{SO\_KEEPALIVE}\})}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsockbopt}(\tsvar{fd},\tsvar{f})$ call is made. $\tsvar{fd}$
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockbopt}(\tsvar{fd},\tsvar{f})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}(\tsvar{sf}.\tsunknown{b}(\tsvar{f})))$ where $\tsvar{sf}.\tsunknown{b}(\tsvar{f})$ is the boolean value of the socket's flag $\tsvar{f}$.

\rulesubsection{Variations}
\par\begin{ltstabular}
WinXP
&
    As above, except that if $\tsvar{sid}$ is a UDP socket, then $\tsvar{f}$ cannot be $\tsunknown{SO\_KEEPALIVE}$ or
    $\tsunknown{SO\_OOBINLINE}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{getsockboptTII}{getsockbopt\_2}{udp: fast succeed}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: option not valid on WinXP UDP socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid}, \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getsockbopt}(\tsvar{fd},\tsvar{f})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{f} \;\in  \{\tsunknown{SO\_KEEPALIVE}\}}
{\rulesubsection{Description}

    On WinXP, consider a UDP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in
    the $\tsunknown{Run}$ state, a $\tsunknown{getsockbopt}(\tsvar{fd},\tsvar{f})$ call is made, where $\tsvar{f}$ is either $\tsunknown{SO\_KEEPALIVE}$
    or $\tsunknown{SO\_OOBINLINE}$. The call fails with an $\tsunknown{ENOPROTOOPT}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockbopt}(\tsvar{fd},\tsvar{f})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getsockerr}()$}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsockerr}(\tsvar{fd})$ call is made. $\tsvar{fd}$
    refers to a socket $\tsvar{sid}$ which has no pending errors. The call succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockerr}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$.
...
{\rulesubsection{Description}
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockerr}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$ and cleaing the error $\tsvar{e}$ from the socket.

\rrulepad }


\clustersection{(TCP and UDP)}{$\tsunknown{getsocklistening}()$}
\seccomm{ \[ \tsunknown{getsocklistening}: \tsunknown{fd} \Mtotype  \tstype{bool} \]
  ...
  or $\Mfalse $ otherwise. For TCP a socket is listening if it is in the $\tsunknown{LISTEN}$ state. For UDP, which
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} \;\tsvar{b})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{pr} \Mwedge {}\\{}
 \tsvar{b} = (\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN}) \Mwedge {}\\{}
 \neg{}(\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch})}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsocklistening}(\tsvar{fd})$ call is
    made where $\tsvar{fd}$ refers to a TCP socket $\tsvar{sid}$.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsocklistening}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK} \;\tsvar{b})$ where $\tsvar{b}=\Mtrue $ if the socket is in the $\tsunknown{LISTEN}$ state, and $\tsvar{b}=\Mfalse $ otherwise.
...
\rrulecc{getsocklisteningTIII}{getsocklistening\_3}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: on FreeBSD operation not supported }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getsocklistening}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    On FreeBSD, a $\tsunknown{getsocklistening}(\tsvar{fd})$ call is made from thread $\tsvar{tid}$ which is in the $\tsunknown{Run}$
...
\rrulecc{getsocklisteningTII}{getsocklistening\_2}{udp: rc}{\tsholcomm{ Return $\Mfalse $ or fail with $\tsunknown{ENOPROTOOPT}$: a UDP socket cannot be listening }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getsocklistening}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsvar{ret})}{ \tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsaux{proto\_of} (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{pr} = \tsunknown{PROTO\_UDP} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \Mif  \;\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{rc} = \tsunknown{fast} \;\tsunknown{succeed} \Mwedge  \tsvar{ret} = \tsunknown{OK} \;\Mfalse {}\\{}
 \Melse                       \;\tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail}    \Mwedge  \tsvar{ret} = \tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}}}
{\rulesubsection{Description}

    Consider a UDP socket $\tsvar{sid}$, referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in the
    $\tsunknown{Run}$ state, a $\tsunknown{getsocklistening}(\tsvar{fd})$ call is made. On Linux the call succeeds, returning
    $\Mfalse $; on FreeBSD and WinXP the call fails with an $\tsunknown{ENOPROTOOPT}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsocklistening}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}(\Mfalse ))$ on Linux, and $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})$ on FreeBSD and Linux.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getsockname}()$}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\tsvar{sock}.\tsvar{is}_{1},\tsvar{sock}.\tsvar{ps}_{1}))}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sock} = \tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsockname}(\tsvar{fd})$ call is made where
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockname}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}
(\tsvar{sock}.\tsvar{is}_{1}, \tsvar{sock}.\tsvar{ps}_{1}))$.
...
\rrulecc{getsocknameTII}{getsockname\_2}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ECONNRESET}$: previous connection attempt has failed on FreeBSD }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getsockname}(\tsvar{fd})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ECONNRESET}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    On FreeBSD, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsockname}(\tsvar{fd})$ call is
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockname}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ECONNRESET}})$.
...
\rrulecc{getsocknameTIII}{getsockname\_3}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$: socket not bound on WinXP }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    On WinXP, a $\tsunknown{getsockname}(\tsvar{fd})$ call is made from thread $\tsvar{tid}$ which is in the $\tsunknown{Run}$
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsockname}(\tsvar{fd})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getsocknopt}()$}
\seccomm{ \[ \tsunknown{getsocknopt}: (\tsunknown{fd} * \tsunknown{socknflag}) \Mtotype  \tstype{int} \]
  ...
  \begin{itemize}
    \item $\tsunknown{SO\_RCVBUF}$ Reports receive buffer size information.
    \item $\tsunknown{SO\_RCVLOWAT}$ Reports the minimum number of bytes to process for socket input
     operations.
    \item $\tsunknown{SO\_SNDBUF}$ Reports send buffer size information.
    \item $\tsunknown{SO\_SNDLOWAT}$ Reports the minimum number of bytes to process for socket output
     operations.
  \end{itemize}
...
\seccomm{
  ...
  \begin{itemize}
    ...
    \item \wasverb{level} is the protocol level at which the option resides: \wasverb{SOL\textunderscore{}SOCKET}
     ...
     values of \wasverb{option\textunderscore{}name} are limited to $\tsunknown{SO\_RCVBUF}$, $\tsunknown{SO\_RCVLOWAT}$, $\tsunknown{SO\_SNDBUF}$
     and $\tsunknown{SO\_SNDLOWAT}$.
...
& \textbf{all: fast fail}
&  Fail with $\tsunknown{ENOPROTOOPT}$: value of $\tsunknown{SO\_RCVLOWAT}$ and $\tsunknown{SO\_SNDLOWAT}$ not retrievable \end{ltstabulariii}\par
\clustersubsection{Rules}
~
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\tsholop{int\_of\_num} (\tsvar{sf}.\tsunknown{n}(\tsvar{f}))))}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sf} = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{sf} \Mwedge {}\\{}
 (\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \implies  \tsvar{f} \;\notin  \{\tsunknown{SO\_RCVLOWAT}; \tsunknown{SO\_SNDLOWAT}\})}
{\rulesubsection{Description}

    Consider the socket $\tsvar{sid}$, referenced by $\tsvar{fd}$, with socket flags $\tsvar{sf}$. From thread
    $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsocknopt}(\tsvar{fd},\tsvar{f})$ call is made. $\tsvar{f}$ is a numeric
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsocknopt}(\tsvar{fd},\tsvar{f})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}
...
WinXP
&
    The flag $\tsvar{f}$ is not $\tsunknown{SO\_RCVLOWAT}$ or $\tsunknown{SO\_SNDLOWAT}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{getsocknoptTIV}{getsocknopt\_4}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: value of $\tsunknown{SO\_RCVLOWAT}$ and $\tsunknown{SO\_SNDLOWAT}$ not retrievable }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getsocknopt}(\tsvar{fd},\tsvar{f})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 \tsvar{f} \;\in  \{\tsunknown{SO\_RCVLOWAT}; \tsunknown{SO\_SNDLOWAT}\}}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsocknopt}(\tsvar{fd},\tsvar{f})$ call is made where
    $\tsvar{fd}$ is a file descriptor. $\tsvar{f}$ is a numeric socket flag: either $\tsunknown{SO\_RCVLOWAT}$ or
    $\tsunknown{SO\_SNDLOWAT}$, both flags whose value is non-retrievable. The call fails with an
    $\tsunknown{ENOPROTOOPT}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsocknopt}(\tsvar{fd},\tsvar{f})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{getsocktopt}()$}
\seccomm{ \[ \tsunknown{getsocktopt}: (\tsunknown{fd} * \tsunknown{socktflag}) \Mtotype  (\tstype{int} * \tstype{int}) \;\tstype{option} \]
  ...
  \begin{itemize}
    \item $\tsunknown{SO\_RCVTIMEO}$ Reports the timeout value for input operations.

    \item $\tsunknown{SO\_SNDTIMEO}$ Reports the timeout value specifying the amount of time that an output
...
\seccomm{
  ...
  \begin{itemize}
    ...
    \item \wasverb{level} is the protocol level at which the option resides: \wasverb{SOL\textunderscore{}SOCKET}
     ...
     values of \wasverb{option\textunderscore{}name} are limited to $\tsunknown{SO\_RCVTIMEO}$ and $\tsunknown{SO\_SNDTIMEO}$.
...
& \textbf{all: fast fail}
&  Fail with $\tsunknown{ENOPROTOOPT}$: on WinXP $\tsunknown{SO\_LINGER}$ not retrievable for UDP sockets \end{ltstabulariii}\par
\clustersubsection{Rules}
~
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} \;\tsvar{t})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{sf} = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{sf} \Mwedge {}\\{}
...
\quad \tsvar{f} = \tsunknown{SO\_LINGER})}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsocktopt}(\tsvar{fd},\tsvar{f})$ call is made. $\tsvar{fd}$
    is a file descriptor referring to the socket $\tsvar{sid}$ which has socket flags $\tsvar{sf}$, and $\tsvar{f}$ is
    a time-option flag. The call succeeds, returning $\tsunknown{OK} (\tsvar{t})$ where $\tsvar{t}$ is the value of the
    socket's flag $\tsvar{f}$.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsocktopt}(\tsvar{fd},\tsvar{f})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}
\tsvar{t})$.
...
WinXP
&
    As above but in addition if $\tsvar{fd}$ refers to a UDP socket then the flag is not $\tsunknown{SO\_LINGER}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{getsocktoptTIV}{getsocktopt\_4}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: on WinXP $\tsunknown{SO\_LINGER}$ not retrievable for UDP sockets }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{getsocktopt}(\tsvar{fd},\tsvar{f})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsaux{proto\_of} (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{pr} = \tsunknown{PROTO\_UDP} \Mwedge {}\\{}
 \tsvar{f} = \tsunknown{SO\_LINGER}}
{\rulesubsection{Description}

    On WinXP, from thread $\tsvar{tid}$ which is in the $\tsunknown{Run}$ state, a $\tsunknown{getsocktopt}(\tsvar{fd},\tsvar{f})$ call is
    made. $\tsvar{fd}$ is a file descriptor referring to a UDP socket $\tsvar{sid}$ and $\tsvar{f}$ is the socket flag
    $\tsunknown{SO\_LINGER}$.  The flag $\tsvar{f}$ is not retrievable so the call fails with an $\tsunknown{ENOPROTOOPT}$
    error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{getsocktopt}(\tsvar{fd},\tsvar{f})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{ENOPROTOOPT})$.
...
\clustersection{(TCP only)}{$\tsvar{listen}()$}
\seccomm{  \[ \tsvar{listen}: \tsunknown{fd} * \tstype{int} \Mtotype  \tstype{unit}  \]

   A call to $\tsvar{listen}(\tsunknown{fd},\tsunknown{n})$ puts a TCP socket that is in the $\tsunknown{CLOSED}$ state into the $\tsunknown{LISTEN}$
   ...
   socket to put into the $\tsunknown{LISTEN}$ state and $\tsunknown{n}$ is the \textit{backlog} used to calculate the
   ...
   Once a socket is in the $\tsunknown{LISTEN}$ state, $\tsvar{listen}()$ can be called again to change the backlog
   value.
...
&  On FreeBSD the socket has been shutdown for writing; on Linux the socket is not
   in the $\tsunknown{CLOSED}$ or $\tsunknown{LISTEN}$ state; or on WinXP the socket is not bound,

\\\hline
$\tsunknown{EISCONN}$
&  On WinXP the socket is already connected: it is not in the $\tsunknown{CLOSED}$ or
   $\tsunknown{LISTEN}$ state.
...
\seccomm{
   ...
   the $\tsunknown{LISTEN}$ state which can accept new incoming connections: $\tsunknown{socket\_1}$; $\tsunknown{return\_1}$;
...
\seccomm{
   ...
   \begin{itemize}
     ...
     \item \wasverb{socket} is a file descriptor referring to the socket to put into the $\tsunknown{LISTEN}$
...
$\tsrule{listen\_1}$
& \textbf{tcp: fast succeed}
&  Successfully put socket in $\tsunknown{LISTEN}$ state \\
$\tsrule{listen\_1b}$
& \textbf{tcp: fast succeed}
&  Successfully update backlog value \\
$\tsrule{listen\_1c}$
& \textbf{tcp: fast succeed}
&  Successfully put socket in the $\tsunknown{LISTEN}$ state from any non-$\{\tsunknown{CLOSED};\tsunknown{LISTEN}\}$ state on FreeBSD \\
$\tsrule{listen\_2}$
& \textbf{tcp: fast fail}
&  Fail with $\tsunknown{EINVAL}$ on WinXP: socket not bound to local port \\
$\tsrule{listen\_3}$
& \textbf{tcp: fast fail}
&  Fail with $\tsunknown{EINVAL}$ on Linux or $\tsunknown{EISCONN}$ on WinXP: socket not in $\tsunknown{CLOSED}$ or $\tsunknown{LISTEN}$ state \\
$\tsrule{listen\_4}$
& \textbf{tcp: fast fail}
...
\rrulecc{listenTI}{listen\_1}{tcp: fast succeed}{\tsholcomm{ Successfully put socket in $\tsunknown{LISTEN}$ state }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{CLOSED},\tsvar{cb},*)))] ;{}\\{}
...
\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\Msome  \;\tsvar{lis})))] ;{}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is currently in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is
   made. $\tsvar{fd}$ is a file descriptor referring to a TCP socket identified by $\tsvar{sid}$ which is not
   shutdown for writing, is in the $\tsunknown{CLOSED}$ state, has an empty send and receive queue, and does
   ...
   state $\tsunknown{Ret} (\tsunknown{OK}())$. The socket is put in the $\tsunknown{LISTEN}$ state, with an empty listen queue,
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\Mfalse ,\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\Msome  \;\tsvar{lis})))] ;{}\\{}
 \tsvar{listen} \Mass  \tsvar{listen}_{0} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} ())}{\tsunknown{sched\_timer}}};{}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is made. $\tsvar{fd}$
   refers to a TCP socket identified by $\tsvar{sid}$ which is currently in the $\tsunknown{LISTEN}$ state. The host
   has a list of listening sockets, $\tsvar{listen}_{0}$. The call succeeds.

   A $\MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. The backlog value of the socket's listen queue, $\tsvar{lis}.\tsunknown{qlimit}$ is updated to be $\tsvar{n}$,
...
\rrulecc{listenTIc}{listen\_1c}{tcp: fast succeed}{\tsholcomm{ Successfully put socket in the $\tsunknown{LISTEN}$ state from any non-$\{\tsunknown{CLOSED};\tsunknown{LISTEN}\}$ state on FreeBSD }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock})];{}\\{}
 \tsvar{listen} \Mass  \tsvar{listen}_{0} \Mmagicrrec ,{}\\{}
...
{\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \tsunknown{tcp\_sock}.\tsvar{st} \;\notin  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}\} \Mwedge {}\\{}
 \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{LISTEN}; \tsvar{lis} \Mass  \Msome  \;\tsvar{lis} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
 \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsvar{SS} \;\tsvar{SS}' \Mwedge {}\\{}
 \tsvar{lis} = \Mmagiclrec  \tsunknown{q0} \Mass  [\,];{}\\{}
 \tsunknown{q}  \Mass  [\,];{}\\{}
 \tsunknown{qlimit} \Mass  \tsvar{n} \Mmagicrrec }
{\rulesubsection{Description}
   ...
   socket is just changed to $\tsunknown{LISTEN}$.

   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is made. $\tsvar{fd}$
   refers to a TCP socket identified by $\tsvar{sid}$ which is currently in any non-$\{\tsunknown{CLOSED};\tsunknown{LISTEN}\}$
   state. The call succeeds.

   A $\MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. The socket state is updated to $\tsunknown{LISTEN}$, with empty listen queues.


\rrulepad }


\rrulecc{listenTII}{listen\_2}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$ on WinXP: socket not bound to local port }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge   {}\\{}
...
{\rulesubsection{Description}
   ...
   On WinXP, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is
   ...
   A $\MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})$.
...
\rrulecc{listenTIII}{listen\_3}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$ on Linux or $\tsunknown{EISCONN}$ on WinXP: socket not in $\tsunknown{CLOSED}$ or $\tsunknown{LISTEN}$ state }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
   ...
   From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is made. $\tsvar{fd}$
   refers to a TCP socket $\tsvar{sock}$, identified by $\tsvar{sid}$, which is not in the $\tsunknown{CLOSED}$ or
   $\tsunknown{LISTEN}$ state. On Linux the call fails with an $\tsunknown{EINVAL}$ error; on WinXP it fails with an
   $\tsunknown{EISCONN}$ error.

   A $\MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$ where $\tsvar{err}$ is one of the above errors.
...
\rrulecc{listenTIV}{listen\_4}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRINUSE}$ on Linux: another socket already listening on local port }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRINUSE}})}{ \tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 ...
 \tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}} = \tsvar{sock} \Mwedge {}\\{}
 \tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsunknown{tcp\_sock'}.\tsvar{st} = \tsunknown{LISTEN} \Mwedge  \tsvar{sock}'.\tsvar{ps}_{1} = \tsvar{sock}.\tsvar{ps}_{1} \Mwedge {}\\{}
...
{\rulesubsection{Description}
     ...
     On Linux, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is
     made. $\tsvar{fd}$ refers to a TCP socket $\tsvar{sock}$, identified by $\tsvar{sid}$, in state $\tsunknown{CLOSED}$ and
     bound to local port $\tsvar{p}_{1}$. There is another TCP socket, $\tsvar{sock}'$, in the host's finite map of
     sockets, $\tsvar{h}.\tsvar{socks}$ that is also bound to local port $\tsvar{p}_{1}$, and is in the $\tsunknown{LISTEN}$
     ...
     A $\MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRINUSE}})$.
...
\rrulecc{listenTV}{listen\_5}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$ on BSD: socket shutdown for writing or $\tsunknown{bsd\_cantconnect}$ flag set }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \tsvar{st} \;\in  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}\} \Mwedge  {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 (\tsvar{cantsndmore} = \Mtrue  \Mvee  \Mtrue  )}
{\rulesubsection{Description}

    On FreeBSD, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is
    made. $\tsvar{fd}$ refers to a TCP socket $\tsvar{sock}$, identified by $\tsvar{sid}$, which is in the $\tsunknown{CLOSED}$
    or $\tsunknown{LISTEN}$ state. The socket is either shutdown for writing or has its $\tsunknown{bsd\_cantconnect}$
...
\rrulecc{listenTVII}{listen\_7}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EOPNOTSUPP}$: $\tsvar{listen}()$ called on UDP socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    Consider a UDP socket $\tsvar{sid}$, referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in the
    $\tsunknown{Run}$ state, a $\tsvar{listen}(\tsvar{fd},\tsvar{n})$ call is made. The call fails with an $\tsunknown{EOPNOTSUPP}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsvar{listen}(\tsvar{fd},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})$.
...
\clustersection{(TCP only)}{$\tsunknown{recv}()$}
\seccomm{ \[ \tsunknown{recv}: \tsunknown{fd} * \tstype{int} * \tsunknown{msgbflag} \;\tstype{list} \Mtotype  (\tstype{string} * ((\tsunknown{ip} * \tsunknown{port}) * \tstype{bool}) \;\tstype{option})  \]
  ...
  \item $\tsunknown{MSG\_DONTWAIT}$: Do not block if there is no data available.

  \item $\tsunknown{MSG\_OOB}$: Return out-of-band data.

  \item $\tsunknown{MSG\_PEEK}$: Read data but do not remove it from the socket's receive queue.

  \item $\tsunknown{MSG\_WAITALL}$: Block until all $\tsunknown{n}$ bytes of data are available.
...
\tstype{bool}) \;\tstype{option}$ is always returned as $*$ for a TCP socket.
  ...
  $\tsunknown{O\_NONBLOCK}$ flag is not set and the $\tsunknown{MSG\_DONTWAIT}$ flag was not used) then the $\tsunknown{recv}()$ call
  ...
  The $\tsunknown{MSG\_OOB}$ flag can be set in order to receive out-of-band data; for this,
the socket's $\tsunknown{SO\_OOBINLINE}$ cannot be set (i.e.~out-of-band data must not be being returned inline).
...
\\\hline
$\tsunknown{EINVAL}$
&  Out-of-band data requested and $\tsunknown{SO\_OOBINLINE}$ flag set or the out-of-band
...
\seccomm{
  If the call blocks then the thread enters state $\tsunknown{Recv2}(\tsunknown{sid},\tsunknown{n},\tsunknown{opts})$ where:
...
$\tsrule{recv\_2}$
& \textbf{tcp: block}
&  Block, entering state $\tsunknown{Recv2}$ as not enough data is available \\
$\tsrule{recv\_3}$
& \textbf{tcp: slow nonurgent succeed}
&  Blocked call returns from $\tsunknown{Recv2}$ state \\
$\tsrule{recv\_4}$
& \textbf{tcp: fast fail}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\tsholop{IMPLODE} \;\tsvar{str},*))}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')],\tsvar{MM})}
{((\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSING};{}\\{}
\quad \tsunknown{TIME\_WAIT}; \tsunknown{CLOSE\_WAIT}; \tsunknown{LAST\_ACK}\} \Mwedge {}\\{}
\quad \tsvar{is}_{1} = \Msome  \;\tsvar{i}_{1} \Mwedge  \tsvar{ps}_{1} = \Msome  \;\tsvar{p}_{1} \Mwedge  \tsvar{is}_{2}=\Msome  \;\tsvar{i}_{2} \Mwedge  \tsvar{ps}_{2}=\Msome  \;\tsvar{p}_{2}) \Mvee {}\\{}
 ...
 \tsholcomm{ We return now if we can fill the buffer, or we can reach the low-water mark (usually
         ignored if $\tsunknown{MSG\_WAITALL}$ is set), or we can reach EOF or the next urgent-message boundary.
         Pending errors are not checked. }{}\\{}
 \exists  \tsvar{rcvq}.{}\\{}
 \Mlet  \;\tsunknown{have\_all\_data}     = (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsvar{n}) \Min  {}\\{}
 \Mlet  \;\tsunknown{have\_enough\_data}  = (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVLOWAT})) \Min {}\\{}
 \Mlet  \;\tsunknown{partial\_data\_ok}   = (\tsunknown{MSG\_WAITALL} \;\notin  \;\tsvar{opts} \Mvee  \tsvar{n} > \tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVBUF}) \Mvee {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\neg{}(\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  \tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts})) \Min {}\\{}
 ...
 {}\\{}
 \tsvar{peek} = (\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made where
    ...
    socket is uninitialised and in state $\tsunknown{CLOSED}$.
    ...
    operations, $\tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVLOWAT})$, and the call does not have to return all $\tsvar{n}$ bytes of data;
    either because (i) the $\tsunknown{MSG\_WAITALL}$ flag is not set in $\tsvar{opts}_{0}$, (ii) the number of bytes requested
    is greater than the number of bytes in the socket's receive queue, or (iii) on non-FreeBSD
    architectures the $\tsunknown{MSG\_PEEK}$ flag is set in $\tsvar{opts}_{0}$ (the $\tsunknown{have\_enough\_data} \Mwedge
\tsunknown{partial\_data\_ok}$ case above); (3) there is urgent data available in the socket's receive queue
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$ transition is made leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{str},*))$. If the $\tsunknown{MSG\_PEEK}$ flag was set in $\tsvar{opts}_{0}$ then the socket's
...
\rrulecc{recvTII}{recv\_2}{tcp: block}{\tsholcomm{ Block, entering state $\tsunknown{Recv2}$ as not enough data is available }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})],\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})}{\tsunknown{never\_timer}}} \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')],\tsvar{MM})}
{\tsvar{n} = \tsunknown{clip\_int\_to\_num} \;\tsvar{n}_{0} \Mwedge {}\\{}
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)) \Mwedge {}\\{}
 \tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}\} \Mwedge {}\\{}
 {}\\{}
 \tsholcomm{ We block if not enough (see \ltslink{recvTI}{$\tsunknown{recv\_1}$}) data is available and there is no pending error. }{}\\{}
 \exists  \tsvar{rcvq}.{}\\{}
 \Mlet  \;\tsunknown{blocking}          = \neg{}(\tsunknown{MSG\_DONTWAIT} \;\in  \;\tsvar{opts} \Mvee  \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK})) \Min {}\\{}
 \Mlet  \;\tsunknown{have\_all\_data}     = (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsvar{n}) \Min  {}\\{}
 \Mlet  \;\tsunknown{have\_enough\_data}  = (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVLOWAT})) \Min {}\\{}
 \Mlet  \;\tsunknown{partial\_data\_ok}   = (\tsunknown{MSG\_WAITALL} \;\notin  \;\tsvar{opts} \Mvee  \tsvar{n} > \tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVBUF}) \Mvee {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\neg{}(\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  \tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts})) \Min {}\\{}
...
{\rulesubsection{Description}
    ...
    $\tsunknown{ESTABLISHED}$, $\tsunknown{SYN\_SENT}$, $\tsunknown{SYN\_RECEIVED}$, $\tsunknown{FIN\_WAIT\_1}$, or $\tsunknown{FIN\_WAIT\_2}$, with binding
    quad $(\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ and no pending error. The call is blocking: the
    $\tsunknown{MSG\_DONTWAIT}$ flag is not set in $\tsvar{opts}_{0}$ and the socket's $\tsunknown{O\_NONBLOCK}$ flag is not set.
    ...
    must return all $\tsvar{n}$ bytes of data: (i) the $\tsunknown{MSG\_WAITALL}$ flag is set in $\tsvar{opts}_{0}$, (ii) the
    number of bytes requested is greater than the length of the socket's receive queue, and (iii)
    the $\tsunknown{MSG\_PEEK}$ flag is not set in $\tsvar{opts}_{0}$; (3) there is no urgent data ahead in the socket's
    receive queue; and (4) the socket is not shutdown for reading.

    The call blocks in state $\tsunknown{Recv2}$ waiting for data; a $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$
    transition is made, leaving the thread state $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})$.
...
FreeBSD
&
    In case (iii) above, the $\tsunknown{MSG\_PEEK}$ flag may be set in $\tsvar{opts}_{0}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{recvTIII}{recv\_3}{tcp: slow nonurgent succeed}{\tsholcomm{ Blocked call returns from $\tsunknown{Recv2}$ state }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})],\tsvar{MM})}
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')],\tsvar{MM})}
{((\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSING};{}\\{}
\quad\quad\quad\quad \tsunknown{TIME\_WAIT}; \tsunknown{CLOSE\_WAIT}; \tsunknown{LAST\_ACK}\} \Mwedge  {}\\{}
\quad \tsvar{is}_{1} = \Msome  \;\tsvar{i}_{1} \Mwedge  \tsvar{ps}_{1} = \Msome  \;\tsvar{p}_{1} \Mwedge  \tsvar{is}_{2} = \Msome  \;\tsvar{i}_{2} \Mwedge  \tsvar{ps}_{2} = \Msome  \;\tsvar{p}_{2}) \Mvee {}\\{}
 \tsvar{st} = \tsunknown{CLOSED}) \Mwedge {}\\{}
 {}\\{}
 \exists  \tsvar{rcvq}.{}\\{}
...
{\rulesubsection{Description}
    ...
    Thread $\tsvar{tid}$ is in the $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})$ state after a previous $\tsunknown{recv}()$ call
    blocked. $\tsvar{sid}$ refers either to a synchronised TCP socket with binding quad $(\Msome  \;\tsvar{i}_{1},\Msome
\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$; or to a TCP socket in state $\tsunknown{CLOSED}$.
    ...
    for socket $\tsunknown{recv}()$ operations, $\tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVLOWAT})$, and the call does not have to return
    all $\tsvar{n}$ bytes of data (the $\tsunknown{partial\_data\_ok}$ case): either (i) the $\tsunknown{MSG\_WAITALL}$ flag is
    not set in $\tsvar{opts}$, (ii) the number of bytes requested is greater than the number of bytes in
    the socket's receive queue, or (iii) on non-FreeBSD architectures the $\tsunknown{MSG\_PEEK}$ flag is set
    ...
    A $\MLhtau $ transition is made leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{str},*))$. If
    the $\tsunknown{MSG\_PEEK}$ flag was set in $\tsvar{opts}$ then the socket's receive queue remains unchanged;
...
\rrulecc{recvTIV}{recv\_4}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$: non-blocking call would block waiting for data }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})],\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')],\tsvar{MM})}
{\tsvar{n} = \tsunknown{clip\_int\_to\_num} \;\tsvar{n}_{0} \Mwedge {}\\{}
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thead $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made where
    out-of-band data is not requested. $\tsvar{fd}$ refers to a TCP socket $\tsvar{sid}$ with binding quad
    $(\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$ and no pending error, which is in state $\tsunknown{ESTABLISHED}$,
    $\tsunknown{SYN\_SENT}$, $\tsunknown{SYN\_RECEIVED}$, $\tsunknown{FIN\_WAIT\_1}$, or $\tsunknown{FIN\_WAIT\_2}$. The $\tsunknown{recv}()$ call is
    non-blocking: either the $\tsunknown{MSG\_DONTWAIT}$ flag was set in $\tsvar{opts}_{0}$ or the socket's
    $\tsunknown{O\_NONBLOCK}$ flag is set.
    ...
    return all $\tsvar{n}$ bytes of data: (i) the $\tsunknown{MSG\_WAITALL}$ flag is set in $\tsvar{opts}_{0}$, (ii) the
    number of bytes requested is greater than the length of the socket's receive queue, and (iii)
    the $\tsunknown{MSG\_PEEK}$ flag is not set in $\tsvar{opts}_{0}$; (3) there is no urgent data ahead in the socket's
    ...
    made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})$.
...
\rrulecc{recvTVII}{recv\_7}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTCONN}$: socket not connected }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{sock} = \tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}} \Mwedge {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = \tsvar{sock}.\tsvar{pr} \Mwedge {}\\{}
 (\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN} \Mvee  {}\\{}
 (\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED} \Mwedge  \tsvar{sock}.\tsvar{cantrcvmore}=\Mfalse ){}\\{}
   {}\\{}
 {}\\{}
 )}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made. $\tsvar{fd}$
    refers to a TCP socket $\tsvar{sock}$ identified by $\tsvar{sid}$ which is either in the $\tsunknown{LISTEN}$ state or
    is not shutdown for reading in the $\tsunknown{CLOSED}$ state. The call fails with an $\tsunknown{ENOTCONN}$ error.
...
{\tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 ...
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 ((\tsunknown{tcp\_sock}.\tsvar{st} \;\notin  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}\} \Mwedge  \tsvar{is}_{2} = \Msome  \;\tsvar{i}_{2} \Mwedge  \tsvar{ps}_{2} = \Msome  \;\tsvar{p}_{2}) \Mvee {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED}) \Mwedge {}\\{}
 {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\neg{}(\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  \tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts})) \Min {}\\{}
 ...
 {}\\{}
 \tsvar{es} = \Mif  \;\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \;\Mthen  \;\Msome  \;\tsvar{e} \;\Melse  \;*}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made. $\tsvar{fd}$
    refers to a TCP socket that either is in state $\tsunknown{CLOSED}$ or is in state other than $\tsunknown{CLOSED}$
    or $\tsunknown{LISTEN}$ with peer address set to $(\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$. The socket has a pending error
    $\tsvar{e}$.
    ...
    one: the $\tsunknown{MSG\_DONTWAIT}$ flag is set in $\tsvar{opts}_{0}$ or the socket's $\tsunknown{O\_NONBLOCK}$ flag is set,
    ...
    made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$. If the $\tsunknown{MSG\_PEEK}$ flag was set in
...
\quad [(\tsvar{sid}, \tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  \tsvar{es}; \tsvar{pr} \Mass  \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{rcvq} = ([\,]:\tsunknown{char} \;\tstype{list}) \Mwedge {}\\{}
 {}\\{}
 {}\\{}
 ...
 \Mlet  \;\tsunknown{have\_all\_data}     = (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsvar{n}) \Min  {}\\{}
 \Mlet  \;\tsunknown{have\_enough\_data}  = (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsvar{sock}.\tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVLOWAT})) \Min {}\\{}
 \Mlet  \;\tsunknown{partial\_data\_ok}   = (\tsunknown{MSG\_WAITALL} \;\notin  \;\tsvar{opts} \Mvee  \tsvar{n} > \tsvar{sock}.\tsvar{sf}.\tsvar{n}(\tsunknown{SO\_RCVBUF}) \Mvee {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad (\neg{}(\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge  \tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts})) \Min {}\\{}
 \neg{}(\tsunknown{have\_all\_data} \Mvee  (\tsunknown{have\_enough\_data} \Mwedge  \tsunknown{partial\_data\_ok})) \Mwedge {}\\{}
 {}\\{}
 (\tsvar{es} = \Mif  \;\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \;\Mthen  \;\Msome  \;\tsvar{e} \;\Melse  \;*)}
{\rulesubsection{Description}
    ...
    Thread $\tsvar{tid}$ is blocked in state $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})$ where $\tsvar{sid}$ identifies a socket with
    ...
    of data: (i) the $\tsunknown{MSG\_WAITALL}$ flag is set in $\tsvar{opts}$, (ii) the number of bytes requested is
    greater than the length of the socket's receive queue, and (iii) the $\tsunknown{MSG\_PEEK}$ flag is not
    ...
    is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$. If the $\tsunknown{MSG\_PEEK}$ flag was set in
...
FreeBSD
&
    In case (iii) above, the $\tsunknown{MSG\_PEEK}$ flag may be set in $\tsvar{opts}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{recvTIX}{recv\_9}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ESHUTDOWN}$: socket shut down for reading on WinXP }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ESHUTDOWN}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{cantrcvmore} \Mass  \Mtrue ; \tsvar{pr} \Mass  \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
{\rulesubsection{Description}
     ...
     On WinXP, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n},\tsvar{opts})$ call is
...
\clustersection{(UDP only)}{$\tsunknown{recv}()$}
\seccomm{ \[ \tsunknown{recv}: (\tsunknown{fd} * \tstype{int} * \tsunknown{msgbflag} \;\tstype{list}) \Mtotype  (\tstype{string} * ((\tsunknown{ip} * \tsunknown{port}) * \tstype{bool}) \;\tstype{option}) \]
  ...
  \begin{itemize}
    ...
    \item $\tsunknown{MSG\_DONTWAIT}$: non-blocking behaviour is requested for this call. This flag only has
     effect on Linux. FreeBSD and WinXP ignore it. See rules $\tsunknown{recv\_12}$ and $\tsunknown{recv\_13}$.

    \item $\tsunknown{MSG\_PEEK}$: return data from the datagram on the head of the receive queue, without
     removing that datagram from the receive queue.

    \item $\tsunknown{MSG\_WAITALL}$: do not return until all $\tsunknown{n}$ bytes of data have been read. Linux and
    ...
    \item $\tsunknown{MSG\_OOB}$: return out-of-band data. This flag is ignored on Linux. On WinXP and FreeBSD
...
\tsunknown{port}$), and a flag specifying whether or not all of the datagram's data was read (the
  ...
  If a non-blocking $\tsunknown{recv}()$ call is made (the socket's $\tsunknown{O\_NONBLOCK}$ flag is set) and there are
...
&  The call would block and non-blocking behaviour is requested. This is done
   either via the $\tsunknown{MSG\_DONTWAIT}$ flag being set in the $\tsunknown{recv}()$ flags or the socket's
   $\tsunknown{O\_NONBLOCK}$ flag being set.
...
&  Operation not supported: out-of-band data is requested on FreeBSD and WinXP,
   or the $\tsunknown{MSG\_WAITALL}$ flag is set on a $\tsunknown{recv}()$ call on WinXP.
...
\seccomm{
  ...
  \begin{itemize}
    ...
    \item \wasverb{EINVAL} may be returned if the $\tsunknown{MSG\_OOB}$ flag is set and no out-of-band data is
...
$\tsrule{recv\_12}$
& \textbf{udp: block}
&  Block, entering $\tsunknown{Recv2}$ state as no datagrams available on socket \\
$\tsrule{recv\_13}$
& \textbf{udp: fast fail}
&  Fail with $\tsunknown{EAGAIN}$: call would block and socket is non-blocking or, on Linux, non-blocking behaviour has been requested with the $\tsunknown{MSG\_DONTWAIT}$ flag \\
$\tsrule{recv\_14}$
& \textbf{udp: fast fail}
...
&  Blocked call returns from $\tsunknown{Recv2}$ state with data \\
$\tsrule{recv\_16}$
& \textbf{udp: fast fail}
&  Fail with $\tsunknown{EOPNOTSUPP}$: $\tsunknown{MSG\_WAITALL}$ flag not supported on WinXP, or $\tsunknown{MSG\_OOB}$ flag not supported on FreeBSD and WinXP \\
$\tsrule{recv\_17}$
& \textbf{udp: rc}
...
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{ \tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{data}',\Msome ((\tsvar{i}_{3},\tsvar{ps}_{3}),\tsvar{b})))}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
\quad \tsvar{rcvq} = (\tsunknown{Dgram\_msg}(\Mmagiclrec  \tsunknown{is} \Mass  \tsvar{i}_{3}; \tsunknown{ps} \Mass  \tsvar{ps}_{3}; \tsvar{data} \Mass  \tsvar{data} \Mmagicrrec ))\Mcons \tsvar{rcvq}'' \Mwedge {}\\{}
...
\quad \tsvar{rcvq}' = (\Mif  \;\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \;\Mthen  \;\tsvar{rcvq} \;\Melse  \;\tsvar{rcvq}'')}
{\rulesubsection{Description}

    Consider a UDP socket $\tsvar{sid}$, referenced by $\tsvar{fd}$. It is not shutdown for reading, has no
    pending errors, and is bound to local port $\tsvar{p}_{1}$. Thread $\tsvar{tid}$ is in the $\tsunknown{Run}$ state.
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$ transition is made. The thread is left in state $\tsunknown{Ret}
(\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{data}',\Msome (\tsvar{i}_{3},\tsvar{ps}_{3})))$, where $\tsvar{data}'$ is either:
    ...
    If the $\tsunknown{MSG\_PEEK}$ option is set in $\tsvar{opts}_{0}$ then the entire datagram stays on the receive
...
\rrulecc{recvTXII}{recv\_12}{udp: block}{\tsholcomm{ Block, entering $\tsunknown{Recv2}$ state as no datagrams available on socket }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})}{\tsunknown{never\_timer}}};{}\\{}
...
\quad [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec   \Mwedge {}\\{}
 ...
 \neg{}((\tsunknown{MSG\_DONTWAIT} \;\in  \;\tsvar{opts} \Mwedge  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mvee  \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK})) \Mwedge {}\\{}
...
{\rulesubsection{Description}
     ...
     shutdown for reading, has an empty receive queue, and does not have its $\tsunknown{O\_NONBLOCK}$ flag
     set. The socket is either bound to a local port $\Msome  \;\tsvar{p}'_{1}$ or can be autobound to a local
     port $\Msome  \;\tsvar{p}'_{1}$. From thread $\tsvar{tid}$, which in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call
     ...
     $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})$. If autobinding occurred then $\tsvar{sid}$ will be placed on the head of the
...
Linux
&
     As above, with the added condition that the $\tsunknown{MSG\_DONTWAIT}$ flag is not set in $\tsvar{opts}_{0}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{recvTXIII}{recv\_13}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$: call would block and socket is non-blocking or, on Linux, non-blocking behaviour has been requested with the $\tsunknown{MSG\_DONTWAIT}$ flag }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
...
\quad [(\tsvar{sid},\tsvar{s} \; \Mmagiclrec  \tsvar{es} \Mass  *; \tsvar{pr} \Mass  \tsaux{UDP\_Sock}([\,]) \Mmagicrrec )] \Mmagicrrec  \Mwedge {}\\{}
 ...
 \Mfapply{\tsvar{h}_{0}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 ((\tsunknown{MSG\_DONTWAIT} \;\in  \;\tsvar{opts} \Mwedge  \tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch}) \Mvee  \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}))}
{\rulesubsection{Description}

     Consider a UDP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$. It has no pending errors, and an empty
     receive queue. The socket is non-blocking: its $\tsunknown{O\_NONBLOCK}$ flag has been set. From thread
     $\tsvar{tid}$, in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n},\tsvar{opts}_{0})$ call is made. The call would block
     because the socket has an empty receive queue, so the call fails with an $\tsunknown{EAGAIN}$ error.

     A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n},\tsvar{opts}_{0})}$ transition is made, leaving the thread state $\tsunknown{Ret}
...
Linux
&
     As above, but the rule also applies if the socket's $\tsunknown{O\_NONBLOCK}$ flag is not set but the
     $\tsunknown{MSG\_DONTWAIT}$ flag is set in $\tsvar{opts}_{0}$. Also, note that $\tscon{EWOULDBLOCK}$ and $\tsunknown{EAGAIN}$ are
     aliased on Linux.
...
\rrulecc{recvTXIV}{recv\_14}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$, $\tsunknown{EADDRNOTAVAIL}$, or $\tsunknown{ENOBUFS}$: there are no ephemeral ports left }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n},\tsvar{opts})} }{1}}
{(\tsvar{h}_{0} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{h}_{0} = \tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
...
{\rulesubsection{Description}
     ...
     $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n},\tsvar{opts})$ call is made. There is no ephemeral port to autobind the
     socket to, so the call fails with either $\tsunknown{EAGAIN}$, $\tsunknown{EADDRNOTAVAIL}$ or $\tsunknown{ENOBUFS}$.

     A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n},\tsvar{opts})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$ where e is one of the above errors.

\rrulepad }


\rrulecc{recvTXV}{recv\_15}{udp: slow urgent succeed}{\tsholcomm{ Blocked call returns from $\tsunknown{Recv2}$ state with data }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad [(\tsvar{sid}, \tsvar{sock} \; \Mmagiclrec  \tsvar{ps}_{1} \Mass  \Msome  \;\tsvar{p}_{1}; \tsvar{es} \Mass  *; \tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}') \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{rcvq} = (\tsunknown{Dgram\_msg}(\Mmagiclrec  \tsunknown{is} \Mass  \tsvar{i}_{3}; \tsunknown{ps} \Mass  \tsvar{ps}_{3}; \tsvar{data} \Mass  \tsvar{data} \Mmagicrrec ))\Mcons \tsvar{rcvq}'' \Mwedge {}\\{}
 (\tsvar{rcvq}' = \Mif  \;\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \;\Mthen  \;\tsvar{rcvq} \;\Melse  \;\tsvar{rcvq}'') \Mwedge {}\\{}
...
{\rulesubsection{Description}
     ...
     $(\tsvar{i}_{3},\tsvar{ps}_{3})$ and data $\tsvar{data}$. Thread $\tsvar{tid}$ is blocked in state $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})$.
     ...
     A $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}(\tsholop{IMPLODE}
\tsvar{data}',\Msome ((\tsvar{i}_{3},\tsvar{ps}_{3}),\tsvar{b})))$. If the $\tsunknown{MSG\_PEEK}$ flag was set in $\tsvar{opts}$ then the datagram
...
\rrulecc{recvTXVI}{recv\_16}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EOPNOTSUPP}$: $\tsunknown{MSG\_WAITALL}$ flag not supported on WinXP, or $\tsunknown{MSG\_OOB}$ flag not supported on FreeBSD and WinXP }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 (\tsunknown{MSG\_WAITALL} \;\in  \;\tsvar{opts} \Mwedge  \tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch})}
{\rulesubsection{Description}

    Consider a UDP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, in the $\tsunknown{Run}$ state, a
    $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made. The $\tsunknown{MSG\_OOB}$ or $\tsunknown{MSG\_WAITALL}$ flags are set in
    $\tsvar{opts}_{0}$. The call fails with an $\tsunknown{EOPNOTSUPP}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})$.
...
Posix
&
    As above, except the rule only applies when $\tsunknown{MSG\_OOB}$ is set in $\tsvar{opts}_{0}$.
...
\rrulecc{recvTXVII}{recv\_17}{udp: rc}{\tsholcomm{ Socket shutdown for reading: fail with $\tsunknown{ESHUTDOWN}$ on WinXP or succeed on Linux and FreeBSD }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts}\Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{cantrcvmore} \Mass  \Mtrue ; \tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{ \tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tsvar{ret})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{cantrcvmore} \Mass  \Mtrue ; \tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \Mif       \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{ret} = \tscon{FAIL}\;{(\tsunknown{ESHUTDOWN})} \Mwedge  \tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail}{}\\{}
 \Melse  \;\Mif  \;\tsunknown{bsd\_arch}     \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{ret} = \tsunknown{OK}(\text{``''},\Msome ((*,*),\tsvar{b})) \Mwedge  \tsvar{rc} = \tsunknown{fast} \;\tsunknown{succeed} \Mwedge {}\\{}
 \tsvar{sock}.\tsvar{es} = *{}\\{}
 \Melse  \;\Mif  \;\tsunknown{linux\_arch}   \;\tsvar{h}.\tsvar{arch} \;\Mthen {}\\{}
\quad \tsvar{rcvq} = [\,] \Mwedge  \tsvar{ret} = \tsunknown{OK}(\text{``''},\Msome ((*,*),\tsvar{b})) \Mwedge  \tsvar{rc} = \tsunknown{fast} \;\tsunknown{succeed} \Mwedge  \tsvar{sock}.\tsvar{es} = *{}\\{}
...
{\rulesubsection{Description}
   ...
   thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made. On FreeBSD
   ...
   A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}(\text{``''},\Msome ((*,*),\tsvar{b})))$ on FreeBSD and Linux, or $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ESHUTDOWN}})$ on WinXP.
...
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{data}',\Msome ((\tsvar{i}_{3},\tsvar{ps}_{3}),\Mfalse )))}{ \tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
\quad\quad (\tsvar{rcvq}' = \Mif  \;\tsunknown{MSG\_PEEK} \;\in  (\tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0}) \Mthen  \;\tsvar{rcvq} \;\Melse  \;\tsvar{rcvq}'') \Mwedge {}\\{}
...
\quad\quad \tsvar{t} = \tsunknown{Run} \Mwedge {}\\{}
\quad\quad \tsvar{rc} = \tsunknown{fast} \;\tsunknown{succeed} \Mwedge {}\\{}
...
\quad\quad \tsvar{t} = \tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts}) \Mwedge {}\\{}
\quad\quad \tsvar{rc} = \tsunknown{slow} \;\tsunknown{urgent} \;\tsunknown{succeed} \Mwedge {}\\{}
\quad\quad \tsvar{data}' = \tsunknown{TAKE} \;\tsvar{n} \;\tsvar{data} \Mwedge {}\\{}
\quad\quad \tsvar{n} < \tsholop{LENGTH} \;\tsvar{data} \Mwedge {}\\{}
\quad\quad \tsvar{rcvq}' = \Mif  \;\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \;\Mthen  \;\tsvar{rcvq} \;\Melse  \;\tsvar{rcvq}''))}
{\rulesubsection{Description}
...
\tsunknown{ps} \Mass  \tsvar{ps}_{3}$ and data $\tsvar{data}$. This rule covers two cases:
   ...
   In the first, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is
   ...
   transition is made leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{data}',\Msome ((\tsvar{i}_{3},\tsvar{ps}_{3}),\Mfalse )))$ where
   the $\Mfalse $ indicates that not all of the datagram's data was read. The datagram is discarded from
   the socket's receive queue unless the $\tsunknown{MSG\_PEEK}$ flag was set in $\tsvar{opts}_{0}$, in which case the
   whole datagram remains on the socket's receive queue.

   In the second case, thread $\tsvar{tid}$ is blocked in state $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts})$ where the number of
   bytes to be read, $\tsvar{n}$, is less than the number of bytes of data in the datagram. There is now
   data to be read so a $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}(\tsholop{IMPLODE}
\tsvar{data}',\Msome ((\tsvar{i}_{3},\tsvar{ps}_{3}),\Mfalse )))$ where the $\Mfalse $ indicated that not all of the datagram's data was
   read. The datagram is discarded from the socket's receive queue unless the $\tsunknown{MSG\_PEEK}$ flag was
...
\rulesubsection{Model details}
   ...
   In the model the return value is $\tsunknown{OK}(\tsholop{IMPLODE} \;\tsvar{data}',\Msome ((\tsvar{i}_{3},\tsvar{p}_{3}),\Mfalse ))$ where the $\Mfalse $ represents
...
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tsaux{UDP\_Sock}([\,]) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tsunknown{OK}(\text{``''},\Msome ((*,*),\tsvar{b})))}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tsaux{UDP\_Sock}([\,]) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
\rrulecc{recvTXXII}{recv\_22}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$ on WinXP: socket is unbound }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    port. A $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0}$ call is made from thread $\tsvar{tid}$ which is in the $\tsunknown{Run}$ state. The
    call fails with an $\tsunknown{EINVAL}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$ transition is made, leaving the thread state
    $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})$.
...
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}') \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 \tsvar{rcvq} = (\tsunknown{Dgram\_error}(\Mmagiclrec  \tsunknown{e} \Mass  \tsvar{err} \Mmagicrrec ))\Mcons \tsvar{rcvq}' \Mwedge {}\\{}
 ((\exists \tsvar{fd} \;\tsvar{n}_{0} \;\tsvar{opts}_{0} \;\tsvar{fid} \;\tsvar{ff}. \tsvar{t} = \tsunknown{Run} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{rc} = \tsunknown{fast} \;\tsunknown{fail} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff})) \Mvee {}\\{}
 (\exists \tsvar{n} \;\tsvar{opts}. \tsvar{t} = \tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts}) \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsvar{lbl} = \MLhtau  \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsvar{rc} = \tsunknown{slow} \;\tsunknown{urgent} \;\tsunknown{fail}))}
{\rulesubsection{Description}
    ...
    In the first, thread $\tsvar{tid}$ is in the $\tsunknown{Run}$ state and a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is
    ...
    This leaves the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$, and the socket with the ICMP message removed
    from its receive queue.

    In the second case, thread $\tsvar{tid}$ is blocked in state $\tsunknown{Recv2}(\tsvar{sid},\tsvar{n}_{0},\tsvar{opts}_{0})$. A $\MLhtau $
    transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$, and the socket with the ICMP
...
{\rulesubsection{Description}
     ...
     From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})$ call is made.
     ...
     The call fails returning the pending error: a $\MLhcall{\tsvar{tid}}{\tsunknown{recv}(\tsvar{fd},\tsvar{n}_{0},\tsvar{opts}_{0})}$ transition is
     made leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})$. If the $\tsunknown{MSG\_PEEK}$ flag was set in
     $\tsvar{opts}_{0}$ then the socket's pending error remains, otherwise it is cleared.
...
\clustersection{(TCP only)}{$\tsunknown{send}()$}
\seccomm{ \[ \tsunknown{send}: \tsunknown{fd} * (\tsunknown{ip} * \tsunknown{port}) \;\tstype{option} * \tstype{string} * \tsunknown{msgbflag} \;\tstype{list} \Mtotype  \tstype{string}  \]
  ...
  Finally, $\tsunknown{flags}$ is a list of flags for the $\tsunknown{send}()$ call; possible flags are: $\tsunknown{MSG\_OOB}$, specifying
  that the data to be sent is out-of-band data, and $\tsunknown{MSG\_DONTWAIT}$, specifying that non-blocking
  behaviour is to be used for this call. The $\tsunknown{MSG\_WAITALL}$ and $\tsunknown{MSG\_PEEK}$ flags may also be set,
...
\\\hline
$\tsunknown{EOPNOTSUPP}$
&  Message flags $\tsunknown{MSG\_PEEK}$ and $\tsunknown{MSG\_WAITALL}$ not supported. Linux and WinXP.
...
\seccomm{
  If the call blocks then the thread enters state $\tsunknown{Send2}(\tsunknown{sid},*,\tsunknown{str},\tsunknown{opts})$ (the optional
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s}')],\tsvar{MM})}
{\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{CLOSE\_WAIT}\} \Mwedge {}\\{}
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 ...
 {}\\{}
 (\{\tsunknown{MSG\_PEEK}; \tsunknown{MSG\_WAITALL}\} \cap  \;\tsvar{opts} = \emptyset  \Mvee  \tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge {}\\{}
 {}\\{}
 (\Mif  \;\tsvar{space} \geq  \tsholop{LENGTH} \;\tsvar{str} \;\Mthen {}\\{}
\quad\quad \tsvar{str}'=\tsvar{str} \Mwedge  \tsvar{str}''=[\,]{}\\{}
 \Melse {}\\{}
\quad\quad (\tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK}) \Mvee  (\tsunknown{MSG\_DONTWAIT} \;\in  \;\tsvar{opts} \Mwedge  \neg{}\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch})) \Mwedge {}\\{}
\quad\quad (\Mif  \;\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{space} \geq  \tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDLOWAT}){}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call
...
\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$, has no pending error, is not shutdown for writing, and is in state
    $\tsunknown{ESTABLISHED}$ or $\tsunknown{CLOSE\_WAIT}$. The $\tsunknown{MSG\_PEEK}$ and $\tsunknown{MSG\_WAITALL}$ flags are not set in
    ...
    (2) there is not space for all the data but the call is non-blocking (the $\tsunknown{MSG\_DONTWAIT}$ flag
    is set in $\tsvar{opts}$ or the socket's $\tsunknown{O\_NONBLOCK}$ flag is set), and the space is greater than
    zero, or, on FreeBSD, greater than the minimum number of bytes for $\tsunknown{send}()$ operations on the
    socket, $\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDLOWAT})$.
    ...
    leaving the thread state $\tsunknown{Ret} (\tsunknown{OK} (\tsholop{IMPLODE} \;\tsvar{str}''))$. If the data was marked as out-of-band,
    $\tsunknown{MSG\_OOB} \;\in  \;\tsvar{opts}$, then the socket's send urgent pointer will point to the end of the send
    queue.
...
\rulesubsection{Model details}
    ...
    The $\tsvar{opts}_{0}$ argument is of type $\tstype{list}$. In the model it is converted to a $\tstype{set}$ $\tsvar{opts}$
    using $\tsholop{LIST\_TO\_SET}$. The presence of $\tsunknown{MSG\_PEEK}$ is checked for in $\tsvar{opts}$ rather than in
    $\tsvar{opts}_{0}$.
...
FreeBSD
&
    The $\tsunknown{MSG\_PEEK}$ and $\tsunknown{MSG\_WAITALL}$ flags may be set in $\tsvar{opts}_{0}$ but for the call to be
    non-blocking the socket's $\tsunknown{O\_NONBLOCK}$ flag must be set: the $\tsunknown{MSG\_DONTWAIT}$ flag has no
    effect.
...
\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})}{\tsunknown{never\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},*,\Mfalse ,\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 ...
 \tsvar{fid} = \tsvar{h}.\tsvar{fds} \Mfapply{}{\tsvar{fd}} \Mwedge {}\\{}
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \neg{}((\neg{}\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge   \tsunknown{MSG\_DONTWAIT} \;\in  \;\tsvar{opts}) \Mvee  \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK})) \Mwedge {}\\{}
 {}\\{}
 \tsvar{space} \;\in  \;\tsunknown{UNIV} \Mwedge {}\\{}
 {}\\{}
 (\{\tsunknown{MSG\_PEEK}; \tsunknown{MSG\_WAITALL}\} \cap  \;\tsvar{opts} = \emptyset  \Mvee  \tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch})\Mwedge {}\\{}
...
\quad \tsvar{space} < \tsholop{LENGTH} \;\tsvar{str}) \Mvee {}\\{}
 (\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsvar{st} \;\in  \{\tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}\}))}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call
    is made. $\tsvar{fd}$ refers to a TCP socket $\tsvar{sid}$ that has binding quad $(\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome
\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$, has no pending error, is not shutdown for writing, and is in state
    $\tsunknown{ESTABLISHED}$ or $\tsunknown{CLOSE\_WAIT}$. The call is a blocking one: the socket's $\tsunknown{O\_NONBLOCK}$ flag
    is not set and the $\tsunknown{MSG\_DONTWAIT}$ flag is not set in $\tsvar{opts}_{0}$. The $\tsunknown{MSG\_PEEK}$ and
    $\tsunknown{MSG\_WAITALL}$ flags are not set in $\tsvar{opts}_{0}$.
    ...
    The call blocks, leaving the thread state $\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})$ via a
...
FreeBSD
&
    The $\tsunknown{MSG\_PEEK}$, $\tsunknown{MSG\_WAITALL}$, and $\tsunknown{MSG\_DONTWAIT}$ flags may all be set in $\tsvar{opts}_{0}$: all
...
&
    ...
    place for the socket: it is in state $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$.
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},*,\Mfalse ,\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)))] \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s})],\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    Thread $\tsvar{tid}$ is blocked in state $\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})$ where the TCP socket $\tsvar{sid}$ has
    ...
    writing, and is in state $\tsunknown{ESTABLISHED}$ or $\tsunknown{CLOSE\_WAIT}$.
    ...
    transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK} \text{``''})$. If the data was marked as
    out-of-band, $\tsunknown{MSG\_OOB} \;\in  \;\tsvar{opts}$, then the socket's urgent pointer will be updated to point to
...
{\rulesubsection{Description}
    ...
    Thread $\tsvar{tid}$ is blocked in state $\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})$ where TCP socket $\tsvar{sid}$ has
    binding quad $(\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2})$, has no pending error, is not shutdown for
    writing, and is in state $\tsunknown{ESTABLISHED}$ or $\tsunknown{CLOSE\_WAIT}$. The amount of space in the socket's
    ...
    A $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str}'',\tsvar{opts})$
    where $\tsvar{str}''$ is the remaining data to be sent. If the data in $\tsvar{str}$ is out-of-band,
    $\tsunknown{MSG\_OOB}$ is set in $\tsvar{opts}$, then the socket's urgent pointer is updated to point to the end
    of the socket's send queue.

    Note it is unclear whether or not $\tsunknown{MSG\_OOB}$ should be removed from $\tsvar{opts}$ in the state.


\rrulepad }


\rrulecc{sendTIV}{send\_4}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$: non-blocking semantics requested and call would block }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
\quad \neg{}(\tsvar{space} \geq  \tsholop{LENGTH} \;\tsvar{str} \Mvee  (\Mif  \;\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{space} \geq  \tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDLOWAT}) \Melse  \;\tsvar{space} > 0))) \Mvee {}\\{}
 (\tsvar{st} \;\in  \{\tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}\} \Mwedge  {}\\{}
...
\tsvar{p}_{2})$, has no pending error, is not shutdown for writing, and is in state $\tsunknown{ESTABLISHED}$ or
    $\tsunknown{CLOSE\_WAIT}$. The call is a non-blocking one: either the socket's $\tsunknown{O\_NONBLOCK}$ flag is set
    or the $\tsunknown{MSG\_DONTWAIT}$ flag is set in $\tsvar{opts}_{0}$. The $\tsunknown{MSG\_PEEK}$ and $\tsunknown{MSG\_WAITALL}$ flags are
    not set in $\tsvar{opts}_{0}$.

    The space in the socket's send queue, $\tsvar{space}$ (calculated using \ltslink{sendTqueueTspace}{$\tsaux{send\_queue\_space}$}),
    is less than both the length of the data to send $\tsvar{str}$; and on FreeBSD is less than the
    minimum number of bytes for socket send operations, $\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDLOWAT})$, or on Linux and WinXP
    ...
    state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})$.
...
FreeBSD
&
    For the call to be non-blocking, the socket's $\tsunknown{O\_NONBLOCK}$ flag must be set; the
    $\tsunknown{MSG\_DONTWAIT}$ flag is ignored. Additionally, the $\tsunknown{MSG\_PEEK}$ and $\tsunknown{MSG\_WAITALL}$ flags may
    be set in $\tsvar{opts}_{0}$ as they are also ignored.

\\\hline
Linux
&
    This rule also applies if the socket is in state $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$, in which case
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call
...
\tsvar{e}$. The call fails, returning the pending error.
    ...
    state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$.
...
{\rulesubsection{Description}
    ...
    Thread $\tsvar{tid}$ is blocked in state $\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})$ from an earlier $\tsunknown{send}()$
...
\rrulecc{sendTVI}{send\_6}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTCONN}$ or $\tsunknown{EPIPE}$: socket not connected }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 (\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}\} \Mvee {}\\{}
\quad  {}\\{}
...
\quad (\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}\} \Mwedge  \neg{}(\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch})) \Mvee {}\\{}
...
{\rulesubsection{Description}
    ...
    pending error. The socket is not synchronised: it is in state $\tsunknown{CLOSED}$, $\tsunknown{LISTEN}$,
    $\tsunknown{SYN\_SENT}$, or $\tsunknown{SYN\_RECEIVED}$. The call fails with an $\tsunknown{ENOTCONN}$ error, or $\tsunknown{EPIPE}$ on
    Linux.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})}$ transition is made, leaving the thread in
    state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})$ where $\tsvar{err}$ is one of the above errors.
...
Linux
&
    The rule does not apply if the socket is in state $\tsunknown{SYN\_RECEIVED}$ or $\tsunknown{SYN\_SENT}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{sendTVII}{send\_7}{tcp: rc}{\tsholcomm{ Fail with $\tsunknown{EPIPE}$ or $\tsunknown{ESHUTDOWN}$: socket shut down for writing }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsvar{t}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad \tsvar{t} = \tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts}) \Mwedge {}\\{}
\quad \tsvar{lbl} = \MLhtau  \Mwedge {}\\{}
\quad \tsvar{rc} = \tsunknown{slow} \;\tsunknown{urgent} \;\tsunknown{fail}{}\\{}
\quad } \Mwedge {}\\{}
 (\Mif  \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  \;\tsvar{err} = \tsunknown{ESHUTDOWN}{}\\{}
 \Melse                         \;\tsvar{err} = \tsunknown{EPIPE})}
{\rulesubsection{Description}

    This rule covers two cases: (1) from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a
    $\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call is made; and (2) thread $\tsvar{tid}$ is blocked in state
    $\tsunknown{Send2}(\tsvar{sid},*,\tsvar{str},\tsvar{opts})$. In (1), fd refers to a TCP socket $\tsvar{sid}$ that has binding quad
    ...
    The thread is left in state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EPIPE}})$, via a $\MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})}$ transition in (1) or a $\MLhtau $ transition in (2).
...
\rrulecc{sendTVIII}{send\_8}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EOPNOTSUPP}$:  message flag not valid }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 (\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \Mvee  \tsunknown{MSG\_WAITALL} \;\in  \;\tsvar{opts}) \Mwedge {}\\{}
 \neg{}\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch}}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call
    is made. $\tsvar{fd}$ refers to a TCP socket identified by $\tsvar{sid}$. Either the $\tsunknown{MSG\_PEEK}$ or
    $\tsunknown{MSG\_WAITALL}$ flag is set in $\tsvar{opts}_{0}$. These flags are not supported so the call fails with
    an $\tsunknown{EOPNOTSUPP}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})}$ transition is made, leaving the thread in
    state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})$.
...
\clustersection{(UDP only)}{$\tsunknown{send}()$}
\seccomm{ \[ \tsunknown{send}: (\tsunknown{fd} * (\tsunknown{ip} * \tsunknown{port}) \;\tstype{option} * \tstype{string} * \tsunknown{msgbflag} \;\tstype{list}) \Mtotype  \tstype{string} \]
  ...
  are $\tsunknown{MSG\_DONTWAIT}$ and $\tsunknown{MSG\_OOB}$. $\tsunknown{MSG\_DONTWAIT}$ specifies that non-blocking behaviour
  should be used for this call: see rules $\tsunknown{send\_10}$ and $\tsunknown{send\_11}$.  $\tsunknown{MSG\_OOB}$ specifies that
...
&  The $\tsunknown{send}()$ call would block and non-blocking behaviour is requested. This
   may have been done either via the $\tsunknown{MSG\_DONTWAIT}$ flag being set in the $\tsunknown{send}()$ flags or the
   socket's $\tsunknown{O\_NONBLOCK}$ flag being set.
...
\\\hline
$\tsunknown{EOPNOTSUPP}$
&  The $\tsunknown{MSG\_OOB}$ flag is set on Linux or WinXP.
...
\seccomm{
  If the call blocks then the thread enters state $\tsunknown{Send2}(\tsunknown{sid},\Msome (\tsunknown{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsunknown{str},\tsunknown{opts})$ where
...
$\tsrule{send\_18}$
& \textbf{udp: fast fail}
&  Fail with $\tsunknown{EOPNOTSUPP}$: $\tsunknown{MSG\_PEEK}$ flag not supported for $\tsunknown{send}()$ calls on WinXP; or $\tsunknown{MSG\_OOB}$ flag not supported on WinXP and Linux  \\
$\tsrule{send\_19}$
& \textbf{udp: fast fail}
...
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tsunknown{OK} (\text{``''}))}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  \tsvar{es}; \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec  \Mwedge {}\\{}
 ...
 (\Mif  \;\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen  (\tsvar{h}_{0}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDBUF}) \geq  \tsunknown{STRLEN} (\tsholop{IMPLODE} \;\tsvar{str}){}\\{}
...
{\rulesubsection{Description}
    ...
    pending errors. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a call
    $\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ succeeds if:

    \begin{itemize}

      \item the length of $\tsvar{str}$ is less than { $\tsunknown{UDPpayloadMax}$}, the architecture-dependent
...
\tsvar{p}'_{1},\tsvar{sock}.\tsvar{is}_{2},\tsvar{sock}.\tsvar{ps}_{2})$, the destination address argument $\tsvar{addr}$, and the data
    ...
    state $\tsunknown{Ret} (\tsunknown{OK}(\text{``''}))$ and the host with new outqueue $\tsvar{oq}'$. If the socket was autobound to a
...
Posix
&
    The $\tsunknown{MSG\_OOB}$ flag is not set in $\tsvar{opts}_{0}$.
...
WinXP
&
    The $\tsunknown{MSG\_OOB}$ flag is not set in $\tsvar{opts}_{0}$ and any pending errors are ignored.
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \Mtimed{\tsunknown{Send2}(\tsvar{sid},\Msome  (\tsvar{addr},\tsvar{sock}.\tsvar{is}_{1},\Msome  \;\tsvar{p}'_{1},\tsvar{sock}.\tsvar{is}_{2},\tsvar{sock}.\tsvar{ps}_{2}), \tsvar{str},\tsvar{opts})}{ \tsunknown{never\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  \tsvar{es}; \tsvar{ps}_{1} \Mass  \Msome  \;\tsvar{p}'_{1}; \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )];{}\\{}
 \tsvar{bound} \Mass  \tsvar{bound};{}\\{}
 \tsvar{oq} \Mass  \tsvar{oq}' \Mmagicrrec ,{}\\{}
\quad \tsvar{SS},\tsvar{MM})}
{\tsvar{h}_{0} = \tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  \tsvar{es}; \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec  \Mwedge {}\\{}
 \tsvar{fd} \;\in  \Mfdom{\tsvar{h}_{0}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 \neg{}((\neg{}\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge \tsunknown{MSG\_DONTWAIT} \;\in  \;\tsvar{opts}) \Mvee  \tsvar{ff}.\tsunknown{b}(\tsunknown{O\_NONBLOCK})) \Mwedge {}\\{}
 ((\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mvee  \tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch}) \implies  \Mtrue  ) \Mwedge {}\\{}
 {}\\{}
 \tsvar{p}'_{1} \;\in  \;\tsaux{autobind}(\tsvar{sock}.\tsvar{ps}_{1},\tsunknown{PROTO\_UDP},\tsvar{h}_{0},\tsvar{h}_{0}.\tsvar{socks}) \Mwedge {}\\{}
 (\Mif  \;\tsvar{sock}.\tsvar{ps}_{1} = * \;\Mthen  \;\tsvar{bound} = \tsvar{sid}\Mcons \tsvar{h}_{0}.\tsvar{bound} \;\Melse  \;\tsvar{bound} = \tsvar{h}_{0}.\tsvar{bound}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    in the $\tsunknown{Run}$ state.

    Either the socket is a blocking one: its $\tsunknown{O\_NONBLOCK}$ flag is not set, or the call is a
    blocking one: the $\tsunknown{MSG\_DONTWAIT}$ flag is not set in $\tsvar{opts}_{0}$.
...
\tsvar{p}'_{1},\tsvar{sock}.\tsvar{is}_{2},\tsvar{sock}.\tsvar{ps}_{2}$, the destination address argument $\tsvar{addr}$, and the data $\tsvar{str}$, cannot
    ...
    left in state $\tsunknown{Send2}(\tsvar{sid},\Msome (\tsvar{addr},\tsvar{sock}.\tsvar{is}_{1},\Msome  \;\tsvar{p}'_{1},\tsvar{sock}.\tsvar{is}_{2},\tsvar{sock}.\tsvar{ps}_{2}),\tsvar{str},\tsvar{opts})$. If the
...
FreeBSD
&
    The $\tsunknown{MSG\_DONTWAIT}$ flag may be set in $\tsvar{opts}_{0}$: it is ignored by FreeBSD.

\\\hline
Linux
&
    The $\tsunknown{MSG\_OOB}$ flag must not be set in $\tsvar{opts}_{0}$.

\\\hline
WinXP
&
    The $\tsunknown{MSG\_OOB}$ flag must not be set in $\tsvar{opts}_{0}$, and any pending error on the socket is
    ignored.
...
\rrulecc{sendTXI}{send\_11}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$: call would block and non-blocking behaviour has been requested }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EAGAIN}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    Consider a UDP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$ that is not shutdown for writing and has no
    pending errors. The thread $\tsvar{tid}$ is in the $\tsunknown{Run}$ state and a call $\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE}
\tsvar{str},\tsvar{opts}_{0}$ is made.
    ...
    Either the socket is non-blocking: its $\tsunknown{O\_NONBLOCK}$ flag is set, or the call is non-blocking:
    $\tsunknown{MSG\_DONTWAIT}$ flag was set in the $\tsvar{opts}_{0}$ argument of $\tsunknown{send}()$.
...
FreeBSD
&
    The socket's $\tsunknown{O\_NONBLOCK}$ flag must be set for the rule to apply; the $\tsunknown{MSG\_DONTWAIT}$ flag is
    ignored by FreeBSD.
...
\rrulecc{sendTXII}{send\_12}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTCONN}$: no peer address set in socket and no destination address provided }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},*,\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{err}})}{ \tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    A call $\tsunknown{send}(\tsvar{fd},\tsunknown{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0}$ is made from thread $\tsvar{tid}$ which is in the $\tsunknown{Run}$
    ...
    in state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}}$. If the socket was autobound then $\tsvar{sid}$ is appended to the
...
\rrulecc{sendTXIII}{send\_13}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EMSGSIZE}$: string to be sent is bigger than $\tsunknown{UDPpayloadMax}$ }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMSGSIZE}})}{ \tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad\quad (\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsunknown{STRLEN} (\tsholop{IMPLODE} \;\tsvar{str}) > (\tsvar{h}_{0}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDBUF}))) \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    made from thread $\tsvar{tid}$ which is in the $\tsunknown{Run}$ state.
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})}$ transition is made leaving the thread in
    state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMSGSIZE}})$.  Additionally, the socket's local port $\tsvar{ps}_{1}$ may be autobound
...
&
    ...
    greater than the value of the socket's $\tsunknown{SO\_SNDBUF}$ option.

\end{ltstabular}\par
\rrulepad }


\rrulecc{sendTXIV}{send\_14}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EAGAIN}$, $\tsunknown{EADDRNOTAVAIL}$ or $\tsunknown{ENOBUFS}$: there are no ephemeral ports left }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    From the $\tsunknown{Run}$ state, thread $\tsvar{tid}$ makes a $\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call.  The
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Send2}(\tsvar{sid},\Msome  (\tsvar{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsvar{str},\tsvar{opts})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    thread $\tsvar{tid}$ is blocked in state $\tsunknown{Send2}(\tsvar{sid},\Msome (\tsvar{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsvar{str})$.
    ...
    An $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}(\text{``''}))$, and the host
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{ \Mtimed{\tsunknown{Send2}(\tsvar{sid},\Msome  (\tsvar{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsvar{str})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
    ...
    in state $\tsunknown{Send2}(\tsvar{sid},\Msome  (\tsvar{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsvar{str})$. The error, $\tsvar{e}$, will be returned to
    the caller.

    At $\MLhtau $ transition is made, leaving the thread state $\tsunknown{RET} (\tscon{FAIL}\;{\tsvar{e}})$.

    Note that the error has occurred after the thread entered the $\tsunknown{Send2}$ state: rule $\tsunknown{send\_11}$
...
\rrulecc{sendTXVII}{send\_17}{udp: slow urgent fail}{\tsholcomm{ Fail with $\tsunknown{EMSGSIZE}$ or $\tsunknown{ENOTCONN}$: blocked socket has had peer address unset or string to be sent is too big }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Send2}(\tsvar{sid},\Msome (\tsvar{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsvar{str},\tsvar{opts})}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad (\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsunknown{STRLEN} (\tsholop{IMPLODE} \;\tsvar{str}) > \tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDBUF}) \Mwedge  (\tsvar{e} = \tsunknown{EMSGSIZE})) \Mvee {}\\{}
...
{\rulesubsection{Description}
    ...
    $\tsunknown{Send2}(\tsvar{sid},\Msome (\tsvar{addr},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}),\tsvar{str})$.
    ...
    In either case, a $\MLhtau $ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$
...
&
    ...
    the socket's $\tsunknown{SO\_SNDBUF}$ option.
...
\rrulecc{sendTXVIII}{send\_18}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EOPNOTSUPP}$: $\tsunknown{MSG\_PEEK}$ flag not supported for $\tsunknown{send}()$ calls on WinXP; or $\tsunknown{MSG\_OOB}$ flag not supported on WinXP and Linux  }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EOPNOTSUPP}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\tsvar{h}_{0} = \tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 ...
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tsvar{opts} = \tsholop{LIST\_TO\_SET} \;\tsvar{opts}_{0} \Mwedge {}\\{}
 (\tsunknown{MSG\_PEEK} \;\in  \;\tsvar{opts} \Mwedge  \tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch}) \Mwedge {}\\{}
 (\Mif  \;\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen {}\\{}
...
{\rulesubsection{Description}
    ...
    Consider a UDP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$
    state, a $\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})$ call is made.

    This rule covers two cases. In the first, on WinXP, the $\tsunknown{MSG\_PEEK}$ flag is set in
    $\tsvar{opts}_{0}$. In the second case, on Linux and WinXP, the socket has not been shut down for
    writing, and the $\tsunknown{MSG\_OOB}$ flag is set in $\tsvar{opts}_{0}$. In either case, the $\tsunknown{send}()$ call fail
...
FreeBSD
&
    FreeBSD ignores the $\tsunknown{MSG\_PEEK}$ and $\tsunknown{MSG\_OOB}$ flags for $\tsunknown{send}()$.

\\\hline
Linux
&
    Linux ignores the $\tsunknown{MSG\_PEEK}$ flag for $\tsunknown{send}()$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{sendTXIX}{send\_19}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EADDRINUSE}$: on FreeBSD, local and destination address quad in use by another socket }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    writing. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{send}(\tsvar{fd},\Msome (\tsvar{i}_{2},\tsvar{p}_{2}),\tsholop{IMPLODE}
\tsvar{str},\tsvar{opts}_{0})$ call is made. The socket is bound to local port $\tsvar{p}'_{1}$ or it can be autobound to
    ...
    thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EADDRINUSE}})$.
...
\rrulecc{sendTXXI}{send\_21}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EISCONN}$: socket has peer address set and destination address is specified in call on FreeBSD }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EISCONN}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{es} \Mass  *; \tsvar{is}_{2} \Mass  \Msome  \;\tsvar{i}_{2}; \tsvar{ps}_{2} \Mass  \Msome  \;\tsvar{p}_{2}; \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp})  \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
...
\tsvar{i}_{2}$, and $\tsvar{ps}_{2} = \Msome  \;\tsvar{p}_{2}$. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a
    ...
    thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EISCONN}})$.
...
\rrulecc{sendTXXII}{send\_22}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{EPIPE}$ or $\tsunknown{ESHUTDOWN}$: socket shut down for writing }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
{\rulesubsection{Description}
     ...
     A $\MLhcall{\tsvar{tid}}{\tsunknown{send}(\tsvar{fd},\tsvar{addr},\tsholop{IMPLODE} \;\tsvar{str},\tsvar{opts}_{0})}$ transition is made, leaving the thread in
     state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EPIPE}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{setfileflags}()$}
\seccomm{ \[ \tsunknown{setfileflags}: (\tsunknown{fd} * \tsunknown{filebflag} \;\tstype{list}) \Mtotype  \tstype{unit} \]
  ...
  \begin{itemize}
    \item $\tsunknown{O\_ASYNC}$ Specifies whether signal driven I/O is enabled.
    \item $\tsunknown{O\_NONBLOCK}$ Specifies whether a socket is non-blocking.
  \end{itemize}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setfileflags}(\tsvar{fd},\tsvar{flags})$ call is
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{setfileflags}(\tsvar{fd},\tsvar{flags})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{setsockbopt}()$}
\seccomm{  \[ \tsunknown{setsockbopt}: (\tsunknown{fd} * \tsunknown{sockbflag} * \tstype{bool}) \Mtotype  \tstype{unit} \]
  ...
  \begin{itemize}
    ...
    \item $\tsunknown{SO\_BSDCOMPAT}$ Specifies whether the BSD semantics for delivery of ICMPs to UDP sockets
     with no peer address set is enabled.

    \item $\tsunknown{SO\_DONTROUTE}$ Requests that outgoing messages bypass the standard routing
    ...
    \item $\tsunknown{SO\_KEEPALIVE}$ Keeps connections active by enabling the periodic transmission of
     messages, if this is supported by the protocol.

    \item $\tsunknown{SO\_OOBINLINE}$ Leaves received out-of-band data (data marked urgent) inline.

    \item $\tsunknown{SO\_REUSEADDR}$ Specifies that the rules used in validating addresses supplied to
     $\tsunknown{bind}()$ should allow reuse of local ports, if this is supported by the protocol.
...
& \textbf{udp: fast fail}
&  Fail with $\tsunknown{ENOPROTOOPT}$: $\tsunknown{SO\_KEEPALIVE}$ and $\tsunknown{SO\_OOBINLINE}$ options not supported for a UDP socket on WinXP \end{ltstabulariii}\par
\clustersubsection{Rules}
~
...
{\rulesubsection{Description}
    ...
    $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setsockbopt}(\tsvar{fd},\tsvar{f},\tsvar{b})$ call is made. $\tsvar{f}$ is the
    boolean socket flag to be set, and $\tsvar{b}$ is the boolean value to set it to. The call succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{setsockbopt}(\tsvar{fd},\tsvar{f},\tsvar{b})}$ is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}())$. The
...
\rrulecc{setsockboptTII}{setsockbopt\_2}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: $\tsunknown{SO\_KEEPALIVE}$ and $\tsunknown{SO\_OOBINLINE}$ options not supported for a UDP socket on WinXP }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec )] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    On WinXP, consider a UDP socket $\tsvar{sid}$ referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in
    the $\tsunknown{Run}$ state, a $\tsunknown{setsockbopt}(\tsvar{fd},\tsvar{f},\tsvar{b})$ call is made, where $\tsvar{f}$ is either
    $\tsunknown{SO\_KEEPALIVE}$ or $\tsunknown{SO\_OOBINLINE}$. The call fails with an $\tsunknown{ENOPROTOOPT}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{setsockbopt}(\tsvar{fd},\tsvar{f},\tsvar{b})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{setsocknopt}()$}
\seccomm{  \[ \tsunknown{setsocknopt}: (\tsunknown{fd} * \tsunknown{socknflag} * \tstype{int}) \Mtotype  \tstype{unit} \]
  ...
  \begin{itemize}
    \item $\tsunknown{SO\_RCVBUF}$ Specifies the receive buffer size.

    \item $\tsunknown{SO\_RCVLOWAT}$ Specifies the minimum number of bytes to process for socket input
     operations.

     \item $\tsunknown{SO\_SNDBUF}$ Specifies the send buffer size.

     \item $\tsunknown{SO\_SNDLOWAT}$ Specifies the minimum number of bytes to process for socket output
      operations.
  \end{itemize}
...
\seccomm{
  ...
  \begin{itemize}
    ...
    \item \wasverb{level} is the protocol level at which the flag resides: \wasverb{SOL\textunderscore{}SOCKET} for
     ...
     \wasverb{option\textunderscore{}name} are limited to: $\tsunknown{SO\_RCVBUF}$, $\tsunknown{SO\_RCVLOWAT}$, $\tsunknown{SO\_SNDBUF}$, and
     $\tsunknown{SO\_SNDLOWAT}$.
...
& \textbf{all: fast fail}
&  Fail with $\tsunknown{ENOPROTOOPT}$: $\tsunknown{SO\_SNDLOWAT}$ not settable on Linux \end{ltstabulariii}\par
\clustersubsection{Rules}
~
...
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{ns} = (\Mif  \;\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsvar{f} = \tsunknown{SO\_SNDBUF} \Mwedge  \tsvar{n}' < \tsvar{sock}.\tsvar{sf}.\tsvar{n}(\tsunknown{SO\_SNDLOWAT}) \Mthen {}\\{}
\quad\quad\quad\quad\quad \Mfupdate{(\Mfupdate{\tsvar{sock}.\tsvar{sf}.\tsvar{n}}{\tsvar{f}}{\tsvar{n}'})}{\tsunknown{SO\_SNDLOWAT}}{\tsvar{n}'}{}\\{}
...
{\rulesubsection{Description}
    ...
    the thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setsocknopt}(\tsvar{fd},\tsvar{f},\tsvar{n})$ call is made where
    $\tsvar{f}$ is a numeric socket flag to be updated, and $\tsvar{n}$ is the integer value to set it to. The
    call succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{setsocknopt}(\tsvar{fd},\tsvar{f},\tsvar{n})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. The socket's numeric flag $\tsvar{f}$ is updated to be the value $\tsvar{n}'$ which is: the
...
FreeBSD
&
    If the flag to be set is $\tsunknown{SO\_SNDBUF}$ and the new value $\tsvar{n}$ is less than the value of the
    socket's $\tsunknown{SO\_SNDLOWAT}$ flag then the $\tsunknown{SO\_SNDLOWAT}$ flag is also set to $\tsvar{n}$.

\end{ltstabular}\par
\rrulepad }


\rrulecc{setsocknoptTII}{setsocknopt\_2}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EINVAL}$: on FreeBSD numeric socket flags cannot be set to zero }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{setsocknopt}(\tsvar{fd},\tsvar{f},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINVAL}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    On FreeBSD, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setsocknopt}(\tsvar{fd},\tsvar{f},\tsvar{n})$ call
...
\rrulecc{setsocknoptTIV}{setsocknopt\_4}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: $\tsunknown{SO\_SNDLOWAT}$ not settable on Linux }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{setsocknopt}(\tsvar{fd},\tsvar{f},\tsvar{n})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{linux\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
 \tsvar{f} = \tsunknown{SO\_SNDLOWAT}}
{\rulesubsection{Description}

    On Linux, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setsocknopt}(\tsvar{fd},\tsvar{f},\tsvar{n})$ call is
    made. $\tsvar{f} = \tsunknown{SO\_SNDLOWAT}$, which is not settable, so the call fails with an $\tsunknown{ENOPROTOOPT}$
    error.
...
\clustersection{(TCP and UDP)}{$\tsunknown{setsocktopt}()$}
\seccomm{ \[ \tsunknown{setsocktopt}: (\tsunknown{fd} * \tsunknown{socktflag} * (\tstype{int} * \tstype{int}) \;\tstype{option}) \Mtotype  \tstype{unit} \]
  ...
  \begin{itemize}
    \item $\tsunknown{SO\_RCVTIMEO}$ Specifies the timeout value for input operations.

    \item $\tsunknown{SO\_SNDTIMEO}$ Specifies the timeout value that an output function blocks because flow
...
\seccomm{
  ...
  \begin{itemize}
    ...
    \item \wasverb{level} is the protocol level at which the flag resides: \wasverb{SOL\textunderscore{}SOCKET} for
     ...
     \wasverb{option\textunderscore{}name} are limited to: $\tsunknown{SO\_RCVTIMEO}$ and $\tsunknown{SO\_SNDTIMEO}$.
...
& \textbf{all: fast fail}
&  Fail with $\tsunknown{ENOPROTOOPT}$: on WinXP $\tsunknown{SO\_LINGER}$ not settable for a UDP socket \\
...
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \tsvar{t}' \geq  0 \Mwedge {}\\{}
 (\Mif  \;\tsvar{f} \;\in  \{\tsunknown{SO\_RCVTIMEO}; \tsunknown{SO\_SNDTIMEO}\} \Mwedge  \tsvar{t}' = 0{}\\{}
 \Mthen  \;\tsvar{t}'' = \infty{}\\{}
 \Melse  \;\tsvar{t}'' = \tsvar{t}') \Mwedge {}\\{}
 (\Mif  \;\tsvar{f} = \tsunknown{SO\_LINGER} \Mwedge   \tsvar{t} = \Msome (\tsvar{s},\tsvar{ns}) \Mthen  \;\tsvar{ns} = 0 \;\Melse  \;\Mtrue ) \Mwedge {}\\{}
 (\tsvar{f} \;\in  \{\tsunknown{SO\_RCVTIMEO}; \tsunknown{SO\_SNDTIMEO}\} \implies  \tsvar{t}'' = \infty \Mvee  \tsvar{t}'' \leq  \tsunknown{sndrcv\_timeo\_t\_max}) \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})$ call is
    made. $\tsvar{fd}$ refers to a socket $\tsvar{sid}$ which has time-option socket flags $\tsvar{sock}.\tsvar{sf}.\tsvar{t}$; $\tsvar{f}$
    is a time-option socket flag: either $\tsunknown{SO\_RCVTIMEO}$ or $\tsunknown{SO\_SNDTIMEO}$; and $\tsvar{t}$ is the
    well formed time-option value to set $\tsvar{f}$ to. The call succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. If $\tsvar{t}=*$ or $\tsvar{t}=\Msome  (0,0)$ then the socket's time-option flags are updated such
...
\rrulecc{setsocktoptTIV}{setsocktopt\_4}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOPROTOOPT}$: on WinXP $\tsunknown{SO\_LINGER}$ not settable for a UDP socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOPROTOOPT}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    On WinXP, from thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})$ call is
    made. $\tsvar{fd}$ is a file descriptor referring to a UDP socket $\tsvar{sid}$, $\tsvar{f}$ is the time-option
    socket $\tsunknown{SO\_LINGER}$. The flag $\tsvar{f}$ is not settable, so the call fails with an $\tsunknown{ENOPROTOOPT}$
    error.
...
\rrulecc{setsocktoptTV}{setsocktopt\_5}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EDOM}$:  timeout value too long to fit in socket structure }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EDOM}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{f} \;\in  \{\tsunknown{SO\_RCVTIMEO}; \tsunknown{SO\_SNDTIMEO}\} \Mwedge {}\\{}
 \tsunknown{tltimeopt\_wf} \;\tsvar{t} \Mwedge   {}\\{}
 \tsvar{t}' = \tsunknown{time\_of\_tltimeopt} \;\tsvar{t} \Mwedge {}\\{}
 (\Mif  \;\tsvar{t}' = 0{}\\{}
 \Mthen  \;\tsvar{t}'' = \infty{}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is currently in the $\tsunknown{Run}$ state, a $\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})$ call is
    made. $\tsvar{f}$ is a time-option socket flag that is either $\tsunknown{SO\_RCVTIMEO}$ or $\tsunknown{SO\_SNDTIMEO}$, and
    ...
    A $\MLhcall{\tsvar{tid}}{\tsunknown{setsocktopt}(\tsvar{fd},\tsvar{f},\tsvar{t})}$ call is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EDOM}})$.
...
\clustersection{(TCP and UDP)}{$\tsunknown{shutdown}()$}
\seccomm{  \[ \tsunknown{shutdown}: (\tsunknown{fd} * \tstype{bool} * \tstype{bool}) \Mtotype  \tstype{unit} \]
  ...
  For Linux and WinXP, a TCP socket may only be shut down if it is in the $\tsunknown{ESTABLISHED}$ state; on
...
{\tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},\tsvar{pr}) \Mwedge {}\\{}
 ...
 \Mif  \;\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \Mwedge  \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED};\tsunknown{LISTEN}\} \Mwedge  \tsvar{w}  \;\Mthen {}\\{}
\quad {}\\{}
\quad {}\\{}
\quad {}\\{}
...
\quad\quad\quad\quad \Mmagiclrec  \tsvar{lis} \Mass  * \Mmagicrrec ){}\\{}
 \Mmagicbolrrec {}\\{}
 \Melse {}\\{}
\quad (\neg{}\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch} \implies  \exists \tsvar{i}_{1} \;\tsvar{p}_{1} \;\tsvar{i}_{2} \;\tsvar{p}_{2}. \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{ESTABLISHED} \Mwedge  \tsvar{is}_{1}=\Msome  \;\tsvar{i}_{1} \Mwedge {}\\{}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})$ call is made. $\tsvar{fd}$
    refers to a TCP socket $\tsvar{sid}$ which is in the $\tsunknown{ESTABLISHED}$ state and has binding quad
    ...
    state $\tsunknown{Ret} (\tsunknown{OK}())$. If $\tsvar{r}=\Mtrue $ then the read-half of the connection is shut down, setting
...
FreeBSD
&
    The TCP socket can be in any state, not just $\tsunknown{ESTABLISHED}$. If the socket is in the $\tsunknown{CLOSED}$
    or $\tsunknown{LISTEN}$ and is to be shutdown for writing, $\tsvar{w}=\Mtrue $, then the socket is closed, see \ltslink{tcpTclose}{$\tsaux{tcp\_close}$}.
...
{\rulesubsection{Description}
    ...
    Consider a UDP socket $\tsvar{sid}$, referenced by $\tsvar{fd}$. From thread $\tsvar{tid}$, which is in the
    $\tsunknown{Run}$ state, a $\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})$ call is made and succeeds.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})}$ transition is made, leaving the thread state $\tsunknown{Ret}
(\tsunknown{OK}())$. If the socket was shutdown for reading when the call was made or $\tsvar{r} = \Mtrue $ then the
...
\rrulecc{shutdownTIII}{shutdown\_3}{tcp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTCONN}$: cannot shutdown a socket that is not connected on Linux and WinXP }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{fd} \;\in  \Mfdom{\tsvar{h}.\tsvar{fds}} \Mwedge {}\\{}
 ...
 \Mfapply{\tsvar{h}.\tsvar{files}}{\tsvar{fid}} = \tscon{File}(\tsunknown{FT\_Socket}(\tsvar{sid}),\tsvar{ff}) \Mwedge {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}).\tsvar{pr} \Mwedge {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} \neq  \tsunknown{ESTABLISHED} \Mwedge {}\\{}
 \neg{}(\tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch})}
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})$ call is made where
    $\tsvar{fd}$ refers to a TCP socket $\tsvar{sid}$ which is not in the $\tsunknown{ESTABLISHED}$ state. The call fails
    with an $\tsunknown{ENOTCONN}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})$.
...
\rrulecc{shutdownTIV}{shutdown\_4}{udp: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTCONN}$: socket's peer address not set on Linux }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock} \; \Mmagiclrec  \tsvar{is}_{2} \Mass  *; \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsvar{udp}) \Mmagicrrec  ) ] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})}{\tsunknown{sched\_timer}}};{}\\{}
 \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\Mass  *$. From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})$ call is
    made, and fails with an $\tsunknown{ENOTCONN}$ error.

    A $\MLhcall{\tsvar{tid}}{\tsunknown{shutdown}(\tsvar{fd},\tsvar{r},\tsvar{w})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTCONN}})$. If the socket was shutdown for reading when the call was made or $\tsvar{r} = \Mtrue $ then the
    socket is shutdown for reading. If the socket was shutdown for writing when the call was made or
    $\tsvar{w} = \Mtrue $ then the socket is shutdown for writing.
...
\clustersection{(TCP and UDP)}{$\tstype{socket}()$}
\seccomm{ \[ \tstype{socket}: \tsunknown{sock\_type} \Mtotype  \tsunknown{fd} \]
  ...
  $\tsunknown{SOCK\_STREAM}$ for TCP and $\tsunknown{SOCK\_DGRAM}$ for UDP. The returned $\tsunknown{fd}$ is the file descriptor of
  the new socket.
...
\seccomm{
  ...
  \begin{itemize}
    ...
    model, $\tsunknown{SOCK\_STREAM}$ refers to a TCP socket and $\tsunknown{SOCK\_DGRAM}$ to a UDP socket so the
    \wasverb{protocol} argument is not necessary.

  \end{itemize}

  A call to $\tstype{socket}(\tsunknown{SOCK\_STREAMM})$ in the model interface, would be a
  \wasverb{socket(AF\textunderscore{}INET,SOCK\textunderscore{}STREAM,0)} call in Posix; a call to $\tstype{socket}(\tsunknown{SOCK\_DGRAMM})$ in the
...
\quad \tsunknown{SOCK\_DGRAM} \Mtotype  (\tsvar{sock} ={}\\{}
...
\quad \tsunknown{SOCK\_STREAM} \Mtotype  (\tsvar{sock} ={}\\{}
\quad\quad \tscon{Sock}(\Msome  \;\tsvar{fid},\tsunknown{sf\_default} \;\tsvar{h}.\tsvar{arch} \;\tsvar{socktype},*,*,*,*,*,\Mfalse ,\Mfalse ,{}\\{}
\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{CLOSED},\tsaux{initial\_cb},*)))){}\\{}
 }
{\rulesubsection{Description}

    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tstype{socket}(\tsvar{socktype})$ call is made. The
    number of open file descriptors is less than the maximum permitted, $\tsunknown{OPEN\_MAX}$.

    If $\tsvar{socktype}=\tsunknown{SOCK\_STREAM}$ then a new TCP socket $\tsvar{sock}$ is created, in the $\tsunknown{CLOSED}$ state,
    with \ltslink{initialTcb}{$\tsaux{initial\_cb}$} as its control block, and all other fields uninitialised; if
    $\tsvar{socktype}=\tsunknown{SOCK\_DGRAM}$ then a new, unitialised UDP socket $\tsvar{sock}$ is created. A new open file
    description is created pointing to the socket, and a new file descriptor, $\tsvar{fd}$, is allocated
    in an architecture specific way (see { $\tsunknown{nextfd}$}) to point to the open file
    ...
    A $\MLhcall{\tsvar{tid}}{\tstype{socket}(\tsunknown{sock\_type})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tsunknown{OK}
\tsvar{fd})$ to return the new file descriptor.

\rrulepad }


\rrulecc{socketTII}{socket\_2}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EMFILE}$: out of file descriptors for this process }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a $\tstype{socket}(\tsvar{s})$ call is made. The number of
    open file descriptors is greater than the maximum allowed number, $\tsunknown{OPEN\_MAX}$, and so the call
    fails with an $\tsunknown{EMFILE}$ error.

    A $\MLhcall{\tsvar{tid}}{\tstype{socket}(\tsvar{s})}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EMFILE}})$.
...
\seccomm{
  ...
  are returned to the caller, with transitions from the thread state $\Mtimed{\tsunknown{Ret} \;\tsunknown{v}}{\tsunknown{d}}$.
  ...
  \item Rule $\tsunknown{intr\_1}$ applies to all the thread states for blocked calls, $\tsunknown{Accept2}(\tsunknown{sid})$ etc.,
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} \;\tsvar{v}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhreturn{\tsvar{tid}}{\tsvar{v}} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsunknown{never\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtrue }
{\rulesubsection{Description}

    A system call from thread $\tsvar{tid}$ has completed, leaving the thread state $\Mtimed{\tsunknown{Ret} \;\tsvar{v}}{\tsvar{d}}$.  The value $\tsvar{v}$ (which may be of the form $\tsunknown{OK} \;\tsvar{v}'$ or $\tscon{FAIL}\;{\tsvar{v}'}$, for success or failure respectively) is returned to the caller before the timer $\tsvar{d}$ expires.  The thread continues its execution, indicated by the resulting thread state $\Mtimed{\tsunknown{Run}}{\tsunknown{never\_timer}}$.

\rrulepad }


\rrulecc{badfTI}{badf\_1}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{EBADF}$: not a valid file descriptor }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{opn}} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    From thread $\tsvar{tid}$, which is in the $\tsunknown{Run}$ state, a system call $\tsvar{opn}$ is made. The call
    ...
    A $\MLhcall{\tsvar{tid}}{\tsvar{opn}}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsvar{e}})$ where
    ...
    $\tsunknown{sockatmark}()$.  See the definition of { $\tsunknown{fd\_op}$}.
...
\rrulecc{notsockTI}{notsock\_1}{all: fast fail}{\tsholcomm{ Fail with $\tsunknown{ENOTSOCK}$: file descriptor not a valid socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhcall{\tsvar{tid}}{\tsvar{opn}} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTSOCK}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
{\rulesubsection{Description}
    ...
    A $\MLhcall{\tsvar{tid}}{\tsvar{opn}}$ transition is made, leaving the thread state $\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{ENOTSOCK}})$.
    ...
    and $\tsunknown{sockatmark}()$.  See the definition of { $\tsunknown{fd\_sockop}$}.

\rrulepad }


\rrulecc{intrTI}{intr\_1}{all: slow nonurgent fail}{\tsholcomm{ Fail with $\tsunknown{EINTR}$: blocked system call interrupted by
     signal }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsvar{st}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Ret} (\tscon{FAIL}\;{\tsunknown{EINTR}})}{\tsunknown{sched\_timer}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\tsvar{sock} = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}) \Mwedge {}\\{}
 (\tsvar{st} = \tsunknown{Close2}(\tsvar{sid}) \Mvee {}\\{}
 \tsvar{st} = \tsunknown{Connect2}(\tsvar{sid}) \Mvee {}\\{}
 \tsvar{st} = \tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts}) \Mvee {}\\{}
 \tsvar{st} = \tsunknown{Send2}(\tsvar{sid},\tsvar{addr},\tsvar{str},\tsvar{opts}) \Mvee {}\\{}
 \tsvar{st} = \tsunknown{PSelect2}(\tsvar{readfds},\tsvar{writefds},\tsvar{exceptfds}) \Mvee {}\\{}
 \tsvar{st} = \tsunknown{Accept2}(\tsvar{sid}))}
{\rulesubsection{Description}

    If on socket $\tsvar{sid}$ as user call blocked leaving a thread in one of the states:
    $\tsunknown{Close2}(\tsvar{sid})$, $\tsunknown{Connect2}(\tsvar{sid})$, $\tsunknown{Recv2}(\tsvar{sid})$, $\tsunknown{Send2}(\tsvar{sid})$, $\tsunknown{PSelect2}(\tsvar{sid})$ or
    $\tsunknown{Accept2}(\tsvar{sid})$ and a signal is caught, the calls fails returning error $\tsunknown{EINTR}$.
...
\rrulecc{resourcefailTI}{resourcefail\_1}{all: fast badfail}{\tsholcomm{ Fail with $\tsunknown{ENFILE}$, $\tsunknown{ENOBUFS}$ or $\tsunknown{ENOMEM}$: out
     of resources }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{\tsunknown{Run}}{\tsvar{d}}} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
\rrulecc{resourcefailTII}{resourcefail\_2}{all: slow nonurgent badfail}{\tsholcomm{ Fail with $\tsunknown{ENFILE}$, $\tsunknown{ENOBUFS}$ or
...
{\neg{}\tsunknown{INFINITE\_RESOURCES} \Mwedge {}\\{}
 \tsvar{sock} = (\tsvar{h}.\tsvar{socks} \Mfapply{}{\tsvar{sid}}) \Mwedge {}\\{}
 ((\tsvar{t} = \tsunknown{Accept2}(\tsvar{sid}) \Mwedge  \tsvar{e} \;\in  \{\tsunknown{ENFILE}; \tsunknown{ENOBUFS}; \tsunknown{ENOMEM}\}) \Mvee {}\\{}
 (\tsvar{t} = \tsunknown{Connect2}(\tsvar{sid}) \Mwedge  \tsvar{e} = \tsunknown{ENOBUFS}) \Mvee {}\\{}
 (\tsvar{t} = \tsunknown{Recv2}(\tsvar{sid},\tsvar{n},\tsvar{opts}) \Mwedge  \tsvar{e} \;\in  \{\tsunknown{ENOBUFS}; \tsunknown{ENOMEM}\}))}
{\rulesubsection{Description}

    If thread $\tsvar{tid}$ of host $\tsvar{h}$ is in state $\tsunknown{Accept2}(\tsvar{sid})$, $\tsunknown{Connect2}(\tsvar{sid})$ or
    $\tsunknown{Recv2}(\tsvar{sid})$ following an $\tsunknown{accept}()$, $\tsunknown{connect}()$ or $\tsunknown{recv}()$ system call that blocked,
...
$\tsunknown{deliver\_in\_1}$ deals with a passive open: a socket in $\tsunknown{LISTEN}$ state that receives a $\tsvar{SYN}$ and sends a $\tsvar{SYN},\tsunknown{ACK}$.

$\tsunknown{deliver\_in\_2}$ deals with the completion of an active open: a socket in $\tsunknown{SYN\_SENT}$ state (that has previously sent a $\tsvar{SYN}$ with the $\tsunknown{connect\_1}$ rule) that receives a $\tsvar{SYN},\tsunknown{ACK}$ and sends an $\tsunknown{ACK}$.  It also deals with simultaneous opens.
...
& \textbf{tcp: network nonurgent}
&  Completion of active open (in $\tsunknown{SYN\_SENT}$ receive SYN,ACK and send ACK) or simultaneous open (in $\tsunknown{SYN\_SENT}$ receive SYN and send SYN,ACK) \\
...
$\tsrule{di3\_ststuff}$
&
&  $\tsunknown{deliver\_in\_3}$ TCP state change processing \\
...
& \textbf{tcp: network nonurgent}
&  Receive RST and zap non-$\{\tsunknown{CLOSED}$; $\tsunknown{LISTEN}$; $\tsunknown{SYN\_SENT}$; $\tsunknown{SYN\_RECEIVED}$; $\tsunknown{TIME\_WAIT}\}$ socket \\
$\tsrule{deliver\_in\_7a}$
& \textbf{tcp: network nonurgent}
&  Receive RST and zap $\tsunknown{SYN\_RECEIVED}$ socket \\
$\tsrule{deliver\_in\_7b}$
& \textbf{tcp: network nonurgent}
&  Receive RST and ignore for $\tsunknown{LISTEN}$ socket \\
$\tsrule{deliver\_in\_7c}$
& \textbf{tcp: network nonurgent}
&  Receive RST and ignore for $\tsunknown{SYN\_SENT}$(unacceptable ack) or $\tsunknown{TIME\_WAIT}$ socket \\
$\tsrule{deliver\_in\_7d}$
& \textbf{tcp: network nonurgent}
&  Receive RST and zap $\tsunknown{SYN\_SENT}$(acceptable ack) socket \\
$\tsrule{deliver\_in\_8}$
& \textbf{tcp: network nonurgent}
&  Receive SYN in non-$\{\tsunknown{CLOSED}$; $\tsunknown{LISTEN}$; $\tsunknown{SYN\_SENT}$; $\tsunknown{TIME\_WAIT}\}$ state \\
$\tsrule{deliver\_in\_9}$
& \textbf{tcp: network nonurgent}
&  Receive SYN in $\tsunknown{TIME\_WAIT}$ state if there is no matching $\tsunknown{LISTEN}$ socket or sequence number has not increased \end{ltstabulariii}\par
\clustersubsection{Rules}
~
...
\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{SYN\_RECEIVED},\tsvar{cb}'',*)))] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq}' ;{}\\{}
 \tsvar{oq} \Mass  \tsvar{oq}' \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}'')],\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:} A host $\tsvar{h}$ with listening socket $\tsvar{sock}$ referenced by index $\tsvar{sid}$ receives a valid and
    ...
    $\tsunknown{SYN\_RECEIVED}$ state is constructed, referenced by $\tsvar{sid}' (\neq  \tsvar{sid})$, is added to the queue of
...
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\Msome  \;\tsvar{lis})) \Mwedge {}\\{}
 {}\\{}
 {}\\{}
 \tsholcomm{ A BSD socket in the $\tsunknown{LISTEN}$ state may have its peer's $\tsunknown{IP}$ address $\tsvar{is}_{2}$ and port
 ...
 {}\\{}
 \tsholcomm{ If another socket in the $\tsunknown{TIME\_WAIT}$ state matches the address quad of the SYN segment
        ...
        $\tsunknown{TIME\_WAIT}$ socket, $\tsunknown{rcv\_nxt}$. This prevents old or duplicate SYN segments from previous
...
\quad \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{TIME\_WAIT} \Mwedge {}\\{}
...
\quad \Mfalse  ) \Mwedge {}\\{}
 {}\\{}
 \tsholcomm{ Otherwise, the $\tsunknown{TIME\_WAIT}$ sock is completely defunct because there is a new connection
 ...
 \tsholcomm{ Note: this models the behaviour in RFC1122 Section 4.2.2.13 which states that a new $\tsvar{SYN}$
        ...
        connection, \ie, reuse the socket for the new connection changing out of the $\tsunknown{TIME\_WAIT}$
        state. This is modelled by closing the existing $\tsunknown{TIME\_WAIT}$ socket and creating the new
        socket from scratch. }{}\\{}
...
\quad\quad\quad \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{TIME\_WAIT} \Mwedge {}\\{}
...
\quad\quad \tsvar{q}'_{0} = \tsvar{lis}.\tsunknown{q0}{}\\{}
 ...
 \tsvar{sf}' = \tsvar{sf} \; \Mmagiclrec  \tsunknown{n} \Mass  \tsunknown{funupd\_list} \;\tsvar{sf}.\tsunknown{n} [(\tsunknown{SO\_RCVBUF},\tsvar{rcvbufsize}'); (\tsunknown{SO\_SNDBUF},\tsvar{sndbufsize}')] \Mmagicrrec  \Mwedge {}\\{}
 {}\\{}
...
{\rulesubsection{Model details}
    ...
    When a socket completes connection establishment, \ie, enters the $\tsunknown{ESTABLISHED}$ state, BSD
...
\rrulecc{deliverTinTII}{deliver\_in\_2}{tcp: network nonurgent}{\tsholcomm{ Completion of active open (in $\tsunknown{SYN\_SENT}$ receive SYN,ACK and send ACK) or simultaneous open (in $\tsunknown{SYN\_SENT}$ receive SYN and send SYN,ACK) }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st}',\tsvar{cb}'',*)))] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq}' ;{}\\{}
 \tsvar{oq} \Mass  \tsvar{oq}' \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}'')],\tsvar{MM})}
{\tsunknown{tcp\_sock} = \tsaux{TCP\_Sock0}(\tsunknown{SYN\_SENT},\tsvar{cb},*) \Mwedge {}\\{}
 {}\\{}
 \tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \Mtrue  \;\Mfalse  (\tsvar{iflgs},\tsvar{idata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 {}\\{}
 ...
 {}\\{}
 \tsvar{rcvbufsize}' \;\in  \;\tsunknown{UNIV} \Mwedge  \tsvar{sndbufsize}' \;\in  \;\tsunknown{UNIV} \Mwedge {}\\{}
 \tsvar{sf}' = \tsvar{sf} \; \Mmagiclrec  \tsunknown{n} \Mass  \tsunknown{funupd\_list} \;\tsvar{sf}.\tsunknown{n} [(\tsunknown{SO\_RCVBUF},\tsvar{rcvbufsize}');{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad (\tsunknown{SO\_SNDBUF},\tsvar{sndbufsize}')] \Mmagicrrec  \Mwedge {}\\{}
 {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \Melse  \;\tsaux{make\_syn\_ack\_flgs\_data})) \Mwedge {}\\{}
 \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s}' \;\tsvar{s}'' \Mwedge {}\\{}
 {}\\{}
 \tsunknown{stream\_enqueue\_or\_fail} \;\Mtrue  \;\tsvar{h}.\tsvar{arch} \;\tsvar{h}.\tsvar{rttab} \;\tsvar{h}.\tsvar{ifds} (\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{i}_{2}) \tsvar{cb}' \;\tsvar{cb}'' \Mwedge {}\\{}
 {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad \{\tsunknown{ESTABLISHED}\}  {}\\{}
\quad\quad\quad\quad\quad\quad \Melse  \{\tsunknown{FIN\_WAIT\_2};\tsunknown{FIN\_WAIT\_1}\})) \tsholcomm{ we were trying to send a FIN from $\tsunknown{SYN\_SENT}$, so move straight
                                                  to $\tsunknown{FIN\_WAIT\_2}$. Definitely the case with BSD; should also be
...
\quad\quad\quad\quad\quad\quad\quad \tsunknown{CLOSE\_WAIT}{}\\{}
\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsunknown{LAST\_ACK})))         \tsholcomm{ we were trying to send a FIN from $\tsunknown{SYN\_SENT}$ and also receive a
                                                  FIN, so we move straight into $\tsunknown{LAST\_ACK}$. }{}\\{}
 \Melse {}\\{}
\quad\quad \tsholcomm{ simultaneous open }{}\\{}
\quad\quad (\Mif  \neg{}\tsvar{FIN}' \;\Mthen {}\\{}
\quad\quad\quad\quad (\tsvar{st}' = \tsunknown{SYN\_RECEIVED} \Mwedge {}\\{}
\quad\quad\quad\quad \tsvar{cantrcvmore}' = \tsvar{cantrcvmore}){}\\{}
\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad {}\\{}
\quad\quad\quad\quad (\tsvar{st}' = \tsunknown{CLOSE\_WAIT} \Mwedge   \tsholcomm{ yes, really! (in BSD) even though we've not yet had our initial SYN acknowledged! See \wasverb{tcp\textunderscore{}input.c:2065 +/-2000} }{}\\{}
...
{\tsvar{sid} \;\notin  (\Mfdom{\tsvar{socks}}) \Mwedge {}\\{}
 ...
 {}\\{}
 \tsholcomm{ The socket must be in a connected state, or is in the $\tsunknown{SYN\_RECEIVED}$ state and
        $\tsunknown{seg}$ is the final segment completing a passive or simultaneous open. }{}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} \;\notin  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT}\} \Mwedge {}\\{}
 \tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{SYN\_RECEIVED};\tsunknown{ESTABLISHED};\tsunknown{CLOSE\_WAIT};\tsunknown{FIN\_WAIT\_1};\tsunknown{FIN\_WAIT\_2};{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsunknown{CLOSING};\tsunknown{LAST\_ACK};\tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 {}\\{}
 ...
 (\exists  \tsvar{cond}. \neg{}(\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{FIN\_WAIT\_1}; \tsunknown{CLOSING}; \tsunknown{LAST\_ACK}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 \tsvar{cond})) \Mwedge {}\\{}
 {}\\{}
 \tsholcomm{ A $\tsvar{SYN}$ should be received only in the $\tsunknown{SYN\_RECEIVED}$ state. }{}\\{}
 (\tsvar{iflgs}.\tsvar{SYN} \implies  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED}) \Mwedge {}\\{}
 {}\\{}
...
\quad (\tsvar{sock}',\tsvar{oflgs}.\tsvar{FIN}) = (\tsvar{sock}_{2}, \tsvar{FIN}_{2} \Mvee  \tsvar{FIN}_{1}){}\\{}
 ...
 {}\\{}
 \tsvar{sock}'.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock'}) \Mwedge {}\\{}
 \tsvar{sock}'' = \tsvar{sock}' \Mwedge {}\\{}
 {}\\{}
 \tsholcomm{ If socket $\tsvar{sock}$ was initially in the $\tsunknown{SYN\_RECEIVED}$ state and after processing $\tsunknown{seg}$
        is in the $\tsunknown{ESTABLISHED}$ state (or if the segment contained a $\tsvar{FIN}$ and the socket is in one of the
        $\tsunknown{FIN\_WAIT\_1}$, $\tsunknown{FIN\_WAIT\_2}$ or $\tsunknown{CLOSE\_WAIT}$ states), the socket is probably on some
 ...
 (\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED} \Mwedge {}\\{}
\quad \tsunknown{tcp\_sock'}.\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSE\_WAIT}\} \Mthen {}\\{}
\quad\quad \tsaux{di3\_socks\_update} \;\tsvar{sid} (\tsvar{socks} \oplus  (\tsvar{sid},\tsvar{sock}'')) \tsvar{socks}'{}\\{}
 \Melse {}\\{}
\quad \tsholcomm{ If the socket was not initially in the $\tsunknown{SYN\_RECEIVED}$ state, \ie $\tsunknown{seg}$ was processed
...
\ddefnc{diIIITtopstuff}{\iA{di3\_topstuff}}{\subddefnA[{ $\tsunknown{deliver\_in\_3}$ initial checks }]{di3\_topstuff}{\tsaux{di3\_topstuff} \;\tsunknown{sock} \;\tsunknown{sock'} ={}\\{}
 ...
 \tsholcomm{ Reset the socket's idle timer and keepalive timer to start counting from zero as
        ...
        $\tsunknown{FIN\_WAIT\_2}$ timer is enabled this may be reset upon processing this segment. See
...
\quad\quad \tsunknown{stream\_mlift\_tcp\_output\_perhaps\_or\_fail} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{sock} (\tsunknown{sock'},\tsvar{FIN}) \Mwedge {}\\{}
...
\quad\quad (\tsunknown{sock'},\tsvar{FIN},\tsunknown{sto\_p}) = (\tsunknown{sock},\Mfalse ,\Mfalse ){}\\{}
 {}\\{}
\quad \Melse  \;\tsunknown{ASSERTION\_FAILURE} \text{``di3\textunderscore{}newackstuff''} \tsholcomm{ impossible }{}\\{}
 {}\\{}
 )\}.{}\\{}
 ...
 \exists  \tsunknown{tcp\_sock}.{}\\{}
 (\tsunknown{sock}.\tsvar{pr} = \tscon{TCP\_PROTO} \;\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 (\Mif  \;\tsunknown{tcp\_sock\_0}.\tsvar{st} = \tsunknown{LAST\_ACK} \Mwedge  \tsunknown{ourfinisacked} \;\Mthen {}\\{}
\quad \tsholcomm{ If the socket's $\tsvar{FIN}$ has been acknowledged and the socket is in the $\tsunknown{LAST\_ACK}$
...
\ddefnc{diIIITackstuff}{\iA{di3\_ackstuff}}{\subddefnA[{ $\tsunknown{deliver\_in\_3}$ ACK processing }]{di3\_ackstuff}{\tsaux{di3\_ackstuff} \;\tsunknown{tcp\_sock\_0} \;\tsunknown{ourfinisacked} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{sock} (\tsunknown{sock'},\tsvar{FIN},\tsunknown{sto\_p}) ={}\\{}
...
\quad\quad\quad \tsunknown{stream\_mlift\_tcp\_output\_perhaps\_or\_fail} \;\tsvar{arch} \;\tsvar{rttab} \;\tsvar{ifds} \;\tsunknown{sock} (\tsunknown{sock'},\tsvar{FIN}) \Mwedge {}\\{}
...
\quad\quad\quad \tsunknown{sto\_p} = \Mtrue  \tsholcomm{ no need to process the segment any further }{}\\{}
 ...
 {}\\{}
 {}\\{}
\quad\quad \Melse  \;\tsunknown{ASSERTION\_FAILURE} \text{``di3\textunderscore{}ackstuff: Believed to be impossible---here for completion and safety''}{}\\{}
 {}\\{}
 {}\\{}
 {}\\{}
...
\ddefnc{diIIITdatastuff}{\iA{di3\_datastuff}}{\subddefnA[{ $\tsunknown{deliver\_in\_3}$ data processing }]{di3\_datastuff}{(\tsaux{di3\_datastuff} (\tsunknown{FIN\_reass}:\tstype{bool}) \tsunknown{the\_ststuff} \;\tsunknown{ourfinisacked} \;\tsunknown{sock} (\tsunknown{sock'}:\tstype{socket},\tsvar{FIN}:\tstype{bool})):\tstype{bool} ={}\\{}
 {}\\{}
 \Mlet  \;\tsunknown{tcp\_sock} = \tsaux{tcp\_sock\_of} \;\tsunknown{sock} \;\Min {}\\{}
 {}\\{}
 \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{TIME\_WAIT} \Mvee  (\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSING} \Mwedge  \tsunknown{ourfinisacked}) \Mthen {}\\{}
...
\ddefnc{diIIITststuff}{\iA{di3\_ststuff}}{\subddefnA[{ $\tsunknown{deliver\_in\_3}$ TCP state change processing }]{di3\_ststuff}{\tsaux{di3\_ststuff} \;\tsunknown{FIN\_reass} \;\tsunknown{ourfinisacked} \;\tsunknown{sock} (\tsunknown{sock'},\tsunknown{stop'}) ={}\\{}
 {}\\{}
 \tsholcomm{ The entirety of this function is an encoding of the TCP State Transition Diagram (as it is, not as it is traditionally depicted)
        post-$\tsunknown{SYN\_SENT}$ state. It specifies for given start state and set of conditions (all or
...
\quad \Melse  \;\tsunknown{sock}) \Min {}\\{}
 \Mlet  \;\tsunknown{tcp\_sock} = \tsaux{tcp\_sock\_of} \;\tsunknown{sock} \;\Min {}\\{}
 \Mlet  \;\tsaux{cont} = (\tsunknown{sock'} = \tsunknown{sock} \Mwedge  \tsunknown{stop'} = \Mfalse ) \Min {}\\{}
...
\quad\quad\quad\quad \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO} (\tsunknown{tcp\_sock} \;{}\\{}
 \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{TIME\_WAIT};{}\\{}
 \tsvar{cb} \Mass   \tsunknown{tcp\_sock}.\tsvar{cb} \; \Mmagiclrec  \tsfield{tt\_keep} \Mass  * \Mmagicrrec {}\\{}
 \Mmagicbolrrec ){}\\{}
 \Mmagicbolrrec  \Mwedge {}\\{}
\quad \tsunknown{stop'} = \Mfalse ) \Min {}\\{}
 {}\\{}
 ...
 {}\\{}
\quad\quad \tscomm{ REMARK we are very loose here }{}\\{}
\quad (\tsunknown{SYN\_RECEIVED},\Mfalse ) \Mtotype  \tsholcomm{ In $\tsunknown{SYN\_RECEIVED}$ and have not received a $\tsvar{FIN}$ }{}\\{}
...
\quad \tsunknown{ESTABLISHED} \tsholcomm{ socket is now fully connected }{}\\{}
 \Melse {}\\{}
...
\quad\quad \tsunknown{FIN\_WAIT\_2}{}\\{}
\quad \Melse {}\\{}
\quad\quad \tsholcomm{ Still waiting for the emitted $\tsvar{FIN}$ to be acknowledged }{}\\{}
\quad\quad \tsunknown{FIN\_WAIT\_1}{}\\{}
 \Mmagicbolrrec ) \Mmagicrrec  \Mwedge {}\\{}
\quad\quad\quad \tsunknown{stop'} = \Mfalse {}\\{}
\quad\quad \Melse {}\\{}
\quad\quad\quad \tsholcomm{ Not a valid path }{}\\{}
\quad\quad\quad \tsunknown{stop'}) \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{SYN\_RECEIVED},\Mtrue ) \Mtotype   \tsholcomm{ In $\tsunknown{SYN\_RECEIVED}$ and have received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Enter the $\tsunknown{CLOSE\_WAIT}$ state, missing out $\tsunknown{ESTABLISHED}$ }{}\\{}
\quad\quad \tsunknown{sock'} = \tsunknown{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO} (\tsunknown{tcp\_sock} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{CLOSE\_WAIT} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
\quad\quad \tsunknown{stop'} = \Mfalse  \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{ESTABLISHED},\Mfalse )  \Mtotype   \tsholcomm{ In $\tsunknown{ESTABLISHED}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Doing common-case data delivery and acknowledgements. Remain in $\tsunknown{ESTABLISHED}$. }{}\\{}
\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
 {}\\{}
\quad (\tsunknown{ESTABLISHED},\Mtrue )  \Mtotype   \tsholcomm{ In $\tsunknown{ESTABLISHED}$ and received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Move into the $\tsunknown{CLOSE\_WAIT}$ state }{}\\{}
\quad\quad \tsunknown{sock'} = \tsunknown{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO} (\tsunknown{tcp\_sock} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{CLOSE\_WAIT} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
\quad\quad \tsunknown{stop'} = \Mfalse  \Mdpipe {}\\{}
 {}\\{}
 {}\\{}
\quad (\tsunknown{CLOSE\_WAIT},\Mfalse )   \Mtotype   \tsholcomm{ In $\tsunknown{CLOSE\_WAIT}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Do nothing and remain in $\tsunknown{CLOSE\_WAIT}$. The socket has its receive-side shut down due to
...
\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{CLOSE\_WAIT},\Mtrue )   \Mtotype   \tsholcomm{ In $\tsunknown{CLOSE\_WAIT}$ and received (another) $\tsvar{FIN}$ }{}\\{}
...
\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{FIN\_WAIT\_1},\Mfalse )   \Mtotype   \tsholcomm{ In $\tsunknown{FIN\_WAIT\_1}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ This socket will have emitted a $\tsvar{FIN}$ to enter $\tsunknown{FIN\_WAIT\_1}$. }{}\\{}
\quad\quad \Mif  \;\tsunknown{ourfinisacked} \;\Mthen {}\\{}
\quad\quad\quad \tsholcomm{ If this socket's $\tsvar{FIN}$ has been acknowledged, enter state $\tsunknown{FIN\_WAIT\_2}$ and start
                the $\tsunknown{FIN\_WAIT\_2}$ timer. The timer ensures that if the other end has gone away
                without emitting a $\tsvar{FIN}$ and does not transmit any more data the socket is closed
                rather left dangling. }{}\\{}
\quad\quad\quad \tsunknown{sock'} = \tsunknown{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO} (\tsunknown{tcp\_sock} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{FIN\_WAIT\_2} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
\quad\quad\quad \tsunknown{stop'} = \Mfalse {}\\{}
 {}\\{}
\quad\quad \Melse {}\\{}
\quad\quad\quad \tsholcomm{ If this socket's $\tsvar{FIN}$ has not been acknowledged then remain in $\tsunknown{FIN\_WAIT\_1}$ }{}\\{}
\quad\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{FIN\_WAIT\_1},\Mtrue )   \Mtotype   \tsholcomm{ In $\tsunknown{FIN\_WAIT\_1}$ and received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \Mif  \;\tsunknown{ourfinisacked} \;\Mthen {}\\{}
\quad\quad\quad \tsholcomm{ ...and this socket's $\tsvar{FIN}$ has been acknowledged then the connection has been
                closed successfully so enter $\tsunknown{TIME\_WAIT}$. Note: this differs slightly from the
                behaviour of BSD which momentarily enters the $\tsunknown{FIN\_WAIT\_2}$ and after a little more
                processing enters $\tsunknown{TIME\_WAIT}$ }{}\\{}
...
\quad\quad\quad \tsholcomm{ If this socket's $\tsvar{FIN}$ has not been acknowledged then the other end is attempting
                ...
                $\tsunknown{CLOSING}$ state }{}\\{}
\quad\quad\quad \tsunknown{sock'} = \tsunknown{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO} (\tsunknown{tcp\_sock} \; \Mmagiclrec  \tsvar{st} \Mass  \tsunknown{CLOSING} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
\quad\quad\quad \tsunknown{stop'} = \Mfalse  \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{FIN\_WAIT\_2},\Mfalse )   \Mtotype   \tsholcomm{ In $\tsunknown{FIN\_WAIT\_2}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ This socket has previously emitted a $\tsvar{FIN}$ which has already been acknowledged. It
              ...
              this time the socket should remain in $\tsunknown{FIN\_WAIT\_2}$ until such a time that it
              receives a valid $\tsvar{FIN}$ from the remote end, or if no activity occurs on the
              connection the $\tsunknown{FIN\_WAIT\_2}$ timer will fire, eventually closing the socket }{}\\{}
\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{FIN\_WAIT\_2},\Mtrue )   \Mtotype   \tsholcomm{ In $\tsunknown{FIN\_WAIT\_2}$ and have received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Connection has been shutdown so enter $\tsunknown{TIME\_WAIT}$ }{}\\{}
\quad\quad \tsunknown{enter\_TIME\_WAIT} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{CLOSING},\Mfalse )      \Mtotype    \tsholcomm{ In $\tsunknown{CLOSING}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \Mif  \;\tsunknown{ourfinisacked} \;\Mthen {}\\{}
\quad\quad\quad \tsholcomm{ If this socket's $\tsvar{FIN}$ has been acknowledged (common-case), enter $\tsunknown{TIME\_WAIT}$ as
...
\quad\quad\quad \tsholcomm{ Otherwise, the other end has not yet received or processed the $\tsvar{FIN}$ emitted by
                this socket. Remain in the $\tsunknown{CLOSING}$ state until it does so. Note: if the
...
\quad\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{CLOSING},\Mtrue )      \Mtotype   \tsholcomm{ In $\tsunknown{CLOSING}$ and have received a $\tsvar{FIN}$ }{}\\{}
...
\quad\quad\quad\quad \tsholcomm{ If this socket's $\tsvar{FIN}$ has been acknowledged then the connection is now
                 successfully closed, so enter $\tsunknown{TIME\_WAIT}$ state }{}\\{}
...
\quad\quad\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{LAST\_ACK},\Mfalse )     \Mtotype   \tsholcomm{ In $\tsunknown{LAST\_ACK}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Remain in $\tsunknown{LAST\_ACK}$ until this socket's $\tsvar{FIN}$ is acknowledged. Note: eventually
              the retransmit timer will fire forcing the $\tsvar{FIN}$ to be retransmitted. }{}\\{}
\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{LAST\_ACK},\Mtrue )     \Mtotype   \tsholcomm{ In $\tsunknown{LAST\_ACK}$ and have received a $\tsvar{FIN}$ }{}\\{}
...
\quad\quad \tsunknown{ASSERTION\_FAILURE} \text{``di3\textunderscore{}ststuff''} \tsholcomm{ impossible } \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{TIME\_WAIT},\Mfalse )    \Mtotype   \tsholcomm{ In $\tsunknown{TIME\_WAIT}$ and have not received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Remaining in $\tsunknown{TIME\_WAIT}$ until the \wasverb{2MSL} timer expires }{}\\{}
\quad\quad \tsaux{cont} \Mdpipe {}\\{}
 {}\\{}
\quad (\tsunknown{TIME\_WAIT},\Mtrue )    \Mtotype   \tsholcomm{ In $\tsunknown{TIME\_WAIT}$ and have received a $\tsvar{FIN}$ }{}\\{}
\quad\quad \tsholcomm{ Remaining in $\tsunknown{TIME\_WAIT}$ until the \wasverb{2MSL} timer expires }{}\\{}
\quad\quad \tsaux{cont}}
}
{\rrulepad }
...
\ddefnc{diIIITsocksTupdate}{\iA{di3\_socks\_update}}{\subddefnA[{ $\tsunknown{deliver\_in\_3}$ socket update processing }]{di3\_socks\_update}{\tsaux{di3\_socks\_update} \;\tsunknown{sid} \;\tsvar{socks} \;\tsvar{socks}' ={}\\{}
 {}\\{}
...
\quad \Mlet  \;\tsvar{cb}' = \tsunknown{tcp\_sock\_1}.\tsvar{cb} \;\Min {}\\{}
 {}\\{}
...
{{}\\{}
 ...
 \tsunknown{tcp\_sock\_0}.\tsvar{st} \;\in  \{\tsunknown{FIN\_WAIT\_1}; \tsunknown{CLOSING}; \tsunknown{LAST\_ACK}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 ...
 \exists  \tsvar{s}''.{}\\{}
 \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s}' \;\tsvar{s}'' \Mwedge {}\\{}
 \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}'')]) \tsvar{SS}'}
{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{iq} \Mass  \tsvar{iq} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{iq} \Mass  \tsvar{iq}' \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
\rrulecn{deliverTinTVII}{deliver\_in\_7}{tcp: network nonurgent}{\tsholcomm{ Receive RST and zap non-$\{\tsunknown{CLOSED}$; $\tsunknown{LISTEN}$; $\tsunknown{SYN\_SENT}$; $\tsunknown{SYN\_RECEIVED}$; $\tsunknown{TIME\_WAIT}\}$ socket }}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ts} \Mass  \Mfupdate{\tsvar{ts}}{\tsvar{tid}}{\Mtimed{{\tsvar{ts}}_{\tsvar{st}}}{\tsvar{d}}};{}\\{}
 ...
 \tsvar{iq} \Mass  \tsvar{iq}' \Mmagicrrec ,{}\\{}
 \tsvar{SS}',\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:} receive RST and silently zap non-$\{\tsunknown{CLOSED}$; $\tsunknown{LISTEN}$; $\tsunknown{SYN\_SENT}$; $\tsunknown{SYN\_RECEIVED}$; $\tsunknown{TIME\_WAIT}\}$ socket }{}\\{}
 {}\\{}
 \tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)) \Mwedge {}\\{}
 \tsvar{st} \;\notin  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}; \tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}; \tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 {}\\{}
 \exists  \tsvar{S}_{0} \;\tsvar{s} \;\tsvar{s}'. \tsvar{SS} = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s})] \Mwedge {}\\{}
 \tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \Mtrue  \;\Mfalse  (\tsvar{iflgs},\tsvar{idata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 ...
 {}\\{}
 {}\\{}
 ( \tsholcomm{ $\tsvar{sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}; \tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}; \tsunknown{TIME\_WAIT}\}$
          excluded already above }{}\\{}
 \Mif  \;\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSE\_WAIT}\} \Mthen {}\\{}
\quad\quad \tsvar{err} = \Msome  \;\tsunknown{ECONNRESET}{}\\{}
 \Melse  \tsholcomm{ $\tsvar{sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSING}; \tsunknown{LAST\_ACK}\}$ -- leave existing error }{}\\{}
...
\rrulecc{deliverTinTVIIa}{deliver\_in\_7a}{tcp: network nonurgent}{\tsholcomm{ Receive RST and zap $\tsunknown{SYN\_RECEIVED}$ socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})];{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  \tsunknown{socks\_update'};{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq}' \Mmagicrrec ,{}\\{}
 \tsvar{SS}',\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:} receive RST and zap $\tsunknown{SYN\_RECEIVED}$ socket, removing from listen queue etc. }{}\\{}
 {}\\{}
 \exists  \tsvar{S}_{0} \;\tsvar{s} \;\tsvar{s}'. \tsvar{SS} = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s})] \Mwedge {}\\{}
 \tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \Mtrue  \;\Mfalse  (\tsvar{iflgs},\tsvar{idata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 \tsvar{iflgs}.\tsvar{RST} = \Mtrue  \Mwedge {}\\{}
 ...
 {}\\{}
 \tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{SYN\_RECEIVED},\tsvar{cb},*)) \Mwedge {}\\{}
 {}\\{}
...
\quad \tsunknown{tcp\_lsock}.\tsvar{st} = \tsunknown{LISTEN} \Mwedge {}\\{}
...
\quad \tsunknown{socks\_update'} = [(\tsvar{sid}',\tsvar{lsock}'); (\tsvar{sid},\tsvar{sock}')]{}\\{}
 ...
 \tsholcomm{ We do not delete the socket entry here because of simultaneous opens.
    Keep existing error for $\tsunknown{SYN\_RECEIVED}$ socket on RST }{}\\{}
...
\rrulecn{deliverTinTVIIb}{deliver\_in\_7b}{tcp: network nonurgent}{\tsholcomm{ Receive RST and ignore for $\tsunknown{LISTEN}$ socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq}' \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:} receive RST and ignore for $\tsunknown{LISTEN}$ socket }{}\\{}
 {}\\{}
 \tsunknown{dequeue\_iq}(\tsvar{iq},\tsvar{iq}',\Msome  (\tsunknown{TCP} \;\tsvar{seg})) \Mwedge {}\\{}
 \tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\tsvar{is}_{1},\Msome  \;\tsvar{p}_{1},\tsvar{is}_{2},\tsvar{ps}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{LISTEN},\tsvar{cb},\tsvar{lis})) \Mwedge {}\\{}
 {}\\{}
...
\rrulecc{deliverTinTVIIc}{deliver\_in\_7c}{tcp: network nonurgent}{\tsholcomm{ Receive RST and ignore for $\tsunknown{SYN\_SENT}$(unacceptable ack) or $\tsunknown{TIME\_WAIT}$ socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq} \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s})],\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock}')] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq}' \Mmagicrrec ,{}\\{}
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')],\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:} receive RST and ignore for $\tsunknown{SYN\_SENT}$(unacceptable ack) or $\tsunknown{TIME\_WAIT}$ socket }{}\\{}
 {}\\{}
 \tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \Mtrue  \;\Mfalse  (\tsvar{iflgs},\tsvar{idata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 \tsvar{sid} \;\notin  \Mfdom{\tsvar{socks}} \Mwedge {}\\{}
 \tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)) \Mwedge {}\\{}
 \tsvar{st} \;\in  \{\tsunknown{SYN\_SENT}; \tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 {}\\{}
 \tsvar{iflgs}.\tsvar{RST} = \Mtrue  \Mwedge {}\\{}
 \tsvar{idata} \;\in  \;\tsunknown{UNIV} \Mwedge {}\\{}
 {}\\{}
 ...
 (\tsvar{st} = \tsunknown{SYN\_SENT} \implies  \Mfalse ) \Mwedge {}\\{}
 {}\\{}
 \tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 (\Mif  \;\tsvar{st} = \tsunknown{TIME\_WAIT} \;\Mthen   \tsholcomm{ only update if $\geq  \tsunknown{ESTABLISHED}$, c.f.\ \wasverb{tcp\textbackslash{}\textunderscore{}input.c:887} }{}\\{}
\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock} \;{}\\{}
 ...
 \Mmagicbolrrec ) \Mmagicrrec {}\\{}
 \Melse  \tsholcomm{ $\tsvar{st} = \tsunknown{SYN\_SENT}$ }{}\\{}
...
\rrulecn{deliverTinTVIId}{deliver\_in\_7d}{tcp: network nonurgent}{\tsholcomm{ Receive RST and zap $\tsunknown{SYN\_SENT}$(acceptable ack) socket }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq} \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
...
{\tsholcomm{ \textbf{Summary}
 ...
 \tsvar{sid} \;\notin  \Mfdom{\tsvar{socks}} \Mwedge {}\\{}
 \tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{SYN\_SENT},\tsvar{cb},*)) \Mwedge {}\\{}
 {}\\{}
 \tsvar{iflgs}.\tsvar{RST} = \Mtrue  \Mwedge {}\\{}
 \tsvar{idata} \;\in  \;\tsunknown{UNIV} \Mwedge {}\\{}
 {}\\{}
...
\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]{}\\{}
 \Melse {}\\{}
...
\quad\quad\quad\quad \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]) \tsvar{SS}')}
{}


\rrulecn{deliverTinTVIII}{deliver\_in\_8}{tcp: network nonurgent}{\tsholcomm{ Receive SYN in non-$\{\tsunknown{CLOSED}$; $\tsunknown{LISTEN}$; $\tsunknown{SYN\_SENT}$; $\tsunknown{TIME\_WAIT}\}$ state }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq} ;{}\\{}
 \tsvar{oq} \Mass  \tsvar{oq} ;{}\\{}
 \tsvar{bndlm} \Mass  \tsvar{bndlm} \Mmagicrrec ,{}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock}')] ;{}\\{}
 ...
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}'')],\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:}
     Receive a SYN in non-$\{\tsunknown{CLOSED}$; $\tsunknown{LISTEN}$; $\tsunknown{SYN\_SENT}$; $\tsunknown{TIME\_WAIT}\}$ state.
...
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsvar{st},\tsvar{cb},*)) \Mwedge {}\\{}
 ...
 \tsholcomm{ Note that it may be the case that this rule should only apply when the SYN is \emph{in the
     ...
     retransmission. }{}\\{}
 {}\\{}
 \tsvar{st} \;\notin  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT};\tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 {}\\{}
 \tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 \Mlet  \;\tsunknown{tt\_keep'} = \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} \neq  \tsunknown{SYN\_RECEIVED} \;\Mthen {}\\{}
...
\rrulecn{deliverTinTIX}{deliver\_in\_9}{tcp: network nonurgent}{\tsholcomm{ Receive SYN in $\tsunknown{TIME\_WAIT}$ state if there is no matching $\tsunknown{LISTEN}$ socket or sequence number has not increased }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 \tsvar{iq} \Mass  \tsvar{iq};{}\\{}
 \tsvar{oq} \Mass  \tsvar{oq};{}\\{}
 \tsvar{bndlm} \Mass  \tsvar{bndlm} \Mmagicrrec ,{}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus  [(\tsvar{sid},\tsvar{sock})] ;{}\\{}
 ...
 \tsvar{SS} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}'')],\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:}
     Receive a SYN in $\tsunknown{TIME\_WAIT}\}$ state where there is no matching $\tsunknown{LISTEN}$ socket.
     Drop it and (depending on the architecture) generate a RST. }{}\\{}
 {}\\{}
 \tsunknown{dequeue\_iq}(\tsvar{iq},\tsvar{iq}',\Msome  (\tsunknown{TCP} \;\tsvar{seg})) \Mwedge {}\\{}
 {}\\{}
 \tsvar{sid} \;\notin  \Mfdom{\tsvar{socks}} \Mwedge {}\\{}
 \tsvar{sock} = \tscon{Sock}(\Msome  \;\tsvar{fid},\tsvar{sf},\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{2},\tsvar{es},\tsvar{cantsndmore},\tsvar{cantrcvmore},{}\\{}
\quad\quad\quad\quad\quad\quad \tsaux{TCP\_Sock}(\tsunknown{TIME\_WAIT},\tsvar{cb},*)) \Mwedge {}\\{}
 \tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \Mtrue  \;\Mfalse  (\tsvar{iflgs},\tsvar{idata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 \tsvar{iflgs}.\tsvar{RST} = \Mfalse  \Mwedge  (\tsvar{iflgs}.\tsvar{SYN} \Mvee  \tsvar{iflgs}.\tsvar{SYNACK}) \Mwedge {}\\{}
 \tsvar{idata} \;\in  \;\tsunknown{UNIV} \Mwedge {}\\{}
 {}\\{}
...
\quad \tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
\quad \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN} \Mwedge {}\\{}
...
\quad \tsvar{sock}.\tsvar{ps}_{1} = \Msome  \;\tsvar{p}_{1}){}\\{}
 ...
 {}\\{}
 \tsholcomm{
   This rule does not appear in the BSD code; what happens there is that the old $\tsunknown{TIME\_WAIT}$ state
...
% by the TCP RFCs (SB coughs!).
  ...
  \ltslink{makeTsynTflgsTdata}{$\tsaux{make\_syn\_flgs\_data}$} and \ltslink{makeTsynTackTflgsTdata}{$\tsaux{make\_syn\_ack\_flgs\_data}$} and are output deterministically in response to
  ...
  \ltslink{streamTmliftTtcpToutputTperhapsTorTfail}{$\tsunknown{stream\_mlift\_tcp\_output\_perhaps\_or\_fail}$} directly and---more importantly---deterministically. This is
  ...
  \ltslink{tcpToutputTperhaps}{$\tsaux{tcp\_output\_perhaps}$} and \ltslink{streamTmliftTtcpToutputTperhapsTorTfail}{$\tsunknown{stream\_mlift\_tcp\_output\_perhaps\_or\_fail}$} for more
  information.
  ...
  \ltslink{streamTenqueueTorTfailTsock}{$\tsunknown{stream\_enqueue\_or\_fail\_sock}$}, \ltslink{enqueueTandTignoreTfail}{$\tsaux{enqueue\_and\_ignore\_fail}$}, \ltslink{enqueueTeachTandTignoreTfail}{$\tsaux{enqueue\_each\_and\_ignore\_fail}$} or
  \ltslink{streamTmliftTtcpToutputTperhapsTorTfail}{$\tsunknown{stream\_mlift\_tcp\_output\_perhaps\_or\_fail}$}.  These functions are used by $\tsunknown{deliver\_out\_1}$ and other
...
\quad\quad\quad\quad\quad \tsvar{cantrcvmore},\tscon{TCP\_PROTO}(\tsunknown{tcp\_sock})) \Mwedge {}\\{}
 \tsunknown{tcp\_sock} = \tsaux{TCP\_Sock0}(\tsvar{st},\tsvar{cb},*) \Mwedge {}\\{}
 {}\\{}
 \tsholcomm{ and either is in a synchronised state with initial $\tsvar{SYN}$ acknowledged\dots }{}\\{}
 ( (\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED};\tsunknown{CLOSE\_WAIT};\tsunknown{FIN\_WAIT\_1};\tsunknown{FIN\_WAIT\_2};\tsunknown{CLOSING};{}\\{}
\quad\quad\quad\quad \tsunknown{LAST\_ACK};\tsunknown{TIME\_WAIT}\}) \Mvee {}\\{}
 \tsholcomm{ \dots{}or is in the $\tsunknown{SYN\_SENT}$ or $\tsunknown{SYN\_RECEIVED}$ state and a $\tsvar{FIN}$ needs to be emitted }{}\\{}
 (\tsvar{st} \;\in  \{\tsunknown{SYN\_SENT}; \tsunknown{SYN\_RECEIVED}\} \Mwedge  \tsvar{cantsndmore}){}\\{}
 ) \Mwedge {}\\{}
 {}\\{}
...
\quad \tsunknown{stream\_tcp\_output\_really} \;\tsvar{sock}_{0} (\tsvar{sock}',\tsvar{FIN}) \Mwedge {}\\{}
 {}\\{}
\quad \tsvar{sock}'.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock'}) \Mwedge {}\\{}
 {}\\{}
...
\quad \tsunknown{stream\_enqueue\_or\_fail\_sock} (\tsunknown{tcp\_sock'}.\tsvar{st} \;\in  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT}\}) \tsvar{h}.\tsvar{arch} \;\tsvar{h}.\tsvar{rttab} \;\tsvar{h}.\tsvar{ifds}{}\\{}
...
& \textbf{tcp: misc nonurgent}
&  $\tsunknown{FIN\_WAIT\_2}$ timer expires \end{ltstabulariii}\par
\clustersubsection{Rules}
~
...
{\tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 ...
 \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_SENT} \Mwedge   \tsholcomm{ this rule is incomplete: $\tsunknown{RexmtSyn}$ is possible in other states, since $\tsunknown{deliver\_in\_2}$ may change state without clearing $\tsunknown{tt\_rexmt}$ }{}\\{}
 {}\\{}
...
\quad\quad \tsholcomm{ Timer has expired too many times. Drop and close the connection }{}\\{}
 {}\\{}
\quad\quad \tsholcomm{ since socket state is $\tsunknown{SYN\_SENT}$, no segments can be output }{}\\{}
...
\quad\quad \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]) \tsvar{SS}'{}\\{}
 {}\\{}
 \Melse {}\\{}
...
\quad\quad \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')] \Mwedge {}\\{}
\quad\quad \tsholcomm{ Attempt to add the new segment to the host's output queue, constraining the final control block state }{}\\{}
\quad\quad \tsunknown{stream\_enqueue\_or\_fail} \;\Mfalse  \;\tsvar{h}.\tsvar{arch} \;\tsvar{h}.\tsvar{rttab} \;\tsvar{h}.\tsvar{ifds} (\Msome  \;\tsvar{i}_{1}, \Msome  \;\tsvar{i}_{2}) \tsvar{cb}' \;\tsvar{cb}'' \Mwedge {}\\{}
...
{\tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 \tsvar{sock}'.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock'}) \Mwedge {}\\{}
 (\tsunknown{tcp\_sock}.\tsvar{st} \;\notin  \{\tsunknown{CLOSED}; \tsunknown{LISTEN}; \tsunknown{SYN\_SENT}; \tsunknown{CLOSE\_WAIT}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{TIME\_WAIT}\} \Mvee {}\\{}
\quad\quad (\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN} \Mwedge  \tsunknown{bsd\_arch} \;\tsvar{h}.\tsvar{arch})) \Mwedge   {}\\{}
 {}\\{}
 \tsvar{shift} \;\in  \;\tsunknown{UNIV} \Mwedge {}\\{}
 {}\\{}
 \tsvar{cb} = \tsunknown{tcp\_sock}.\tsvar{cb} \Mwedge {}\\{}
 {}\\{}
 (\Mif {}\\{}
\quad\quad \tsvar{shift}+1 > (\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED} \;\Mthen {}\\{}
\quad\quad\quad \tsunknown{TCP\_SYNACKMAXRXTSHIFT} \;\Melse  \;\tsunknown{TCP\_MAXRXTSHIFT}){}\\{}
 \Mthen {}\\{}
...
\quad\quad\quad\quad \Mcase  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN} \;\Mof {}\\{}
\quad\quad\quad\quad\quad\quad \Mtrue  \Mtotype  \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')] {}\\{}
\quad\quad\quad\quad\quad\quad \Mdpipe  \Mfalse  \Mtotype  \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]) \tsvar{SS}'{}\\{}
\quad\quad \Melse {}\\{}
\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
 {}\\{}
 \Melse {}\\{}
...
\quad \tsvar{cb}' = \tsvar{cb} \Mwedge {}\\{}
 {}\\{}
\quad (\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_RECEIVED} \;\Mthen {}\\{}
...
\quad\quad\quad\quad\quad (\tsvar{sock}.\tsvar{is}_{1},\tsvar{sock}.\tsvar{is}_{2}, \tsvar{sock}.\tsvar{ps}_{1}, \tsvar{sock}.\tsvar{ps}_{2}) = (\Msome  \;\tsvar{i}_{1},\Msome  \;\tsvar{i}_{2},\Msome  \;\tsvar{p}_{1},\Msome  \;\tsvar{p}_{2}) \Mwedge {}\\{}
 {}\\{}
\quad\quad\quad\quad\quad \tsholcomm{ We are in $\tsunknown{SYN\_RECEIVED}$ and want to retransmit the SYN,ACK, so we either got here
...
\quad\quad\quad\quad\quad \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')] \Mwedge {}\\{}
 {}\\{}
...
\quad\quad\quad ){}\\{}
\quad \Melse  \;\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{LISTEN} \;\Mthen   \tsholcomm{ BSD LISTEN bug:
...
\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')] \Mwedge {}\\{}
...
\quad\quad\quad \Melse  \tsholcomm{  $\tsunknown{ESTABLISHED}, \tsunknown{FIN\_WAIT\_1}, \tsunknown{CLOSING}, \tsunknown{LAST\_ACK}$ }{}\\{}
\quad\quad\quad\quad\quad \tsholcomm{ i.e., cannot be $\tsunknown{CLOSED}, \tsunknown{LISTEN}, \tsunknown{SYN\_SENT}, \tsunknown{CLOSE\_WAIT}, \tsunknown{FIN\_WAIT\_2}, \tsunknown{TIME\_WAIT}$ }{}\\{}
\quad\quad\quad\quad\quad \tsunknown{stream\_tcp\_output\_really}{}\\{}
...
\quad\quad\quad\quad\quad \exists  \tsvar{S}_{0} \;\tsvar{s} \;\tsvar{s}'. \tsvar{SS} = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s})] \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]{}\\{}
\quad ){}\\{}
 {}\\{}
 ) \Mwedge {}\\{}
 {}\\{}
 \tsunknown{stream\_enqueue\_or\_fail} \;\Mtrue  \;\tsvar{h}.\tsvar{arch} \;\tsvar{h}.\tsvar{rttab} \;\tsvar{h}.\tsvar{ifds} (\tsvar{sock}'.\tsvar{is}_{1},\tsvar{sock}'.\tsvar{is}_{2}) \tsunknown{tcp\_sock'}.\tsvar{cb} \;\tsvar{cb}'' \Mwedge {}\\{}
...
{\tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 ...
 \tsunknown{stream\_tcp\_output\_really}{}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad (\tsvar{sock}',\tsvar{oflgs}.\tsvar{FIN}) \Mwedge {}\\{}
 ...
 \tsvar{odata} = [\,] \Mwedge {}\\{}
\quad \tsholcomm{ guaranteed by $\tsunknown{stream\_tcp\_output\_really}$ }{}\\{}
...
\quad \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
 {}\\{}
 \tsunknown{stream\_enqueue\_or\_fail\_sock} (\tsunknown{tcp\_sock'}.\tsvar{st} \;\in  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT}\}) \tsvar{h}.\tsvar{arch} \;\tsvar{h}.\tsvar{rttab} \;\tsvar{h}.\tsvar{ifds}{}\\{}
...
{{}\\{}
 ...
 \tsholcomm{ Note that in another rule the following needs to be specified:
        if the timer has expired for the last time, then (in another rule):
         (if HAVERCVDSYN (i.e., not $\tsunknown{CLOSED}/\tsunknown{LISTEN}/\tsunknown{SYN\_SENT}$) then
              send a RST
          else
...
\quad [(\tsvar{sid},\tsvar{sock}')] \Mmagicrrec ,{}\\{}
 \tsvar{SS}',\tsvar{MM})}
{\tsholcomm{ \textbf{Summary:}
   When the 2MSL $\tsunknown{TIME\_WAIT}$ period expires, the socket is closed.
   }{}\\{}
 {}\\{}
 {}\\{}
 \Mif  \;\tsaux{exists\_quad\_of} \;\tsvar{sock} \;\Mthen {}\\{}
 \tsaux{destroy} (\tsaux{quad\_of} \;\tsvar{sock}) \tsvar{SS} \;\tsvar{SS}'{}\\{}
 \Melse {}\\{}
 {}\\{}
 \tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
...
{\tsvar{sock}.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock}) \Mwedge {}\\{}
 \tsvar{sock}'.\tsvar{pr} = \tscon{TCP\_PROTO}(\tsunknown{tcp\_sock'}) \Mwedge {}\\{}
 \Mlet  \;\tsvar{sock}_{0} = \tsvar{sock} \;\Min {}\\{}
 \tsunknown{stream\_tcp\_output\_really} \;\tsvar{sock}_{0} (\tsvar{sock}',\tsvar{oflgs}.\tsvar{FIN}) \Mwedge {}\\{}
 \tsvar{oflgs} = \tsvar{oflgs} \; \Mmagiclrec  \tsvar{SYN} \Mass  \Mfalse ; \tsvar{SYNACK} \Mass  \Mfalse ; \tsvar{RST} \Mass  \Mfalse  \Mmagicrrec  \Mwedge {}\\{}
 \tsvar{odata} = [\,] \Mwedge {}\\{}
...
{\tsholcomm{
 ...
 \tsholcomm{ Note it should be the case that the socket is in $\tsunknown{SYN\_SENT}$, and so $\tsunknown{outsegs}$ will be empty, but that is not definite. }{}\\{}
 {}\\{}
 \tsholcomm{ write to stream if possible }{}\\{}
 \Mif  \;\tsaux{exists\_quad\_of} \;\tsvar{sock} \;\Mthen {}\\{}
...
\quad \tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{oflgs},\tsvar{odata}) \tsvar{s} \;\tsvar{s}' \Mwedge {}\\{}
\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]{}\\{}
 \Melse {}\\{}
\quad \tsvar{SS}' = \tsvar{SS}}
{\rulesubsection{Description}
...
\rrulecc{timerTttTfinTwaitTIITI}{timer\_tt\_fin\_wait\_2\_1}{tcp: misc nonurgent}{\tsholcomm{ $\tsunknown{FIN\_WAIT\_2}$ timer expires }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock})] \Mmagicrrec ,{}\\{}
 \tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
...
{\rulesubsection{Description}
   ...
   the socket.  Specifically, we reset it every time we receive a segment while in $\tsunknown{FIN\_WAIT\_2}$,
...
\quad [(\tsvar{sid},\tsvar{sock} \; \;\tsvar{pr} \Mass  \tsaux{UDP\_Sock}(\tsvar{rcvq}))] \Mmagicrrec  \Mwedge {}\\{}
 \tsvar{rcvq}' = \Mappend{\tsvar{rcvq}}{[\tsunknown{Dgram\_msg}(\Mmagiclrec  \tsvar{data} \Mass  \tsvar{data}; \tsunknown{is} \Mass  \Msome  \;\tsvar{i}_{3}; \tsunknown{ps} \Mass  \tsvar{ps}_{3} \Mmagicrrec )]} \Mwedge {}\\{}
...
{(\tsvar{h} \; \;\tsvar{iq} \Mass  \tsvar{iq},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{iq} \Mass  \tsvar{iq}'; \tsvar{oq} \Mass  \Mif  \;\tsunknown{icmp\_to\_go} \;\Mthen  \;\tsvar{oq}' \;\Melse  \;\tsvar{h}.\tsvar{oq} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
\quad\quad\quad\quad \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{ESTABLISHED} \;\Mthen {}\\{}
...
\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad\quad\quad \Melse  \;\Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT};\tsunknown{SYN\_RECEIVED}\} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED} \;\Mthen {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]) \tsvar{SS}'{}\\{}
\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad\quad\quad \Melse {}\\{}
...
\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS} ) \Mdpipe {}\\{}
...
\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsunknown{udp\_sock} \;{}\\{}
 \Mmagiclrec  \tsvar{rcvq} \Mass  \Mappend{\tsunknown{udp\_sock}.\tsvar{rcvq}}{[(\tsunknown{Dgram\_error}(\Mmagiclrec  \tsunknown{e} \Mass  \tsunknown{ECONNRESET} \Mmagicrrec ))]} \Mmagicrrec ) \Mmagicrrec  \Mwedge  \tsvar{oq}' = \tsvar{oq}{}\\{}
\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{es} \;\Mupdby  \;\Msome  \;\tsunknown{ECONNREFUSED}{}\\{}
 \tsholop{onlywhen} ((\tsvar{sock}.\tsvar{is}_{2} \neq  *) \Mvee  \neg{}(\tsunknown{SO\_BSDCOMPAT} \;\in  \;\tsvar{sock}.\tsvar{sf}.\tsunknown{b})) \Mmagicrrec  \Mwedge  \tsvar{oq}' = \tsvar{oq})}
{\rulesubsection{Description}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad \exists  \tsunknown{tf\_doing\_tstmp} \Mcons  \{\Mtrue ;\Mfalse \}.{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad \Mlet  \;\tsunknown{mss} = \tsholop{MIN} (\tsvar{sock}.\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDBUF})){}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsunknown{stream\_tcp\_output\_perhaps} \;\tsvar{sock}'' (\tsvar{sock}''',\tsvar{FINs}) \Mwedge {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsunknown{stream\_enqueue\_or\_fail\_sock} (\tsunknown{tcp\_sock'''}.\tsvar{st} \;\notin  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT}\}){}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \Mcase  \;\tsvar{FINs} \;\Mof  \;* \Mtotype  \tsvar{SS}' = \tsvar{SS}{}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}),\tsvar{s}')]{}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \Mwedge  \tsvar{oq}' = \tsvar{oq} \Mwedge  \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad \tsholcomm{ Note the case where it is a syncache entry is not dealt with here: a \wasverb{syncache\textunderscore{}unreach()} should be done instead }{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \Mwedge  \tsvar{oq}' = \tsvar{oq} \Mwedge  \tsvar{SS}' = \tsvar{SS}){}\\{}
\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \Mwedge  \tsvar{oq}' = \tsvar{oq} \Mwedge  \tsvar{SS}' = \tsvar{SS}) \Mdpipe {}\\{}
...
\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsunknown{udp\_sock} \;{}\\{}
 \Mmagiclrec  \tsvar{rcvq} \Mass  \Mappend{\tsunknown{udp\_sock}.\tsvar{rcvq}}{[(\tsunknown{Dgram\_error}(\Mmagiclrec  \tsunknown{e} \Mass  \tsunknown{EMSGSIZE} \Mmagicrrec ))]} \Mmagicrrec ) \Mmagicrrec  \Mwedge  \tsvar{oq}' = \tsvar{oq}{}\\{}
\quad\quad \Melse {}\\{}
...
\quad\quad\quad\quad\quad \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{SYN\_SENT} \;\Mthen {}\\{}
\quad\quad\quad\quad\quad\quad\quad \exists  \tsvar{oflgsodata}.{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsholcomm{ know from definition of $\tsaux{tcp\_drop\_and\_close}$ that no segs will be emitted }{}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsaux{tcp\_drop\_and\_close} \;\tsvar{h}.\tsvar{arch} (\Msome  \;\tsunknown{ECONNREFUSED}) \tsvar{sock} (\tsvar{sock}',\tsvar{oflgsodata}) \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad\quad \tsaux{destroy} (\tsaux{quad\_of} \;\tsvar{sock}) \tsvar{SS} \;\tsvar{SS}'{}\\{}
\quad\quad\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \Mwedge  \tsvar{oq}' = \tsvar{oq} \Mwedge  \tsvar{SS}' = \tsvar{SS}{}\\{}
...
\quad\quad\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsunknown{udp\_sock} \;{}\\{}
 \Mmagiclrec  \tsvar{rcvq} \Mass  \Mappend{\tsunknown{udp\_sock}.\tsvar{rcvq}}{[(\tsunknown{Dgram\_error}(\Mmagiclrec  \tsunknown{e} \Mass  \tsunknown{ECONNRESET} \Mmagicrrec ))]} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
...
\rrulecc{deliverTinTicmpTIV}{deliver\_in\_icmp\_4}{all: network nonurgent}{\tsholcomm{ Receive $\tsunknown{ICMP\_PARAMPROB}$ etc for known socket }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock}')] ;{}\\{}
...
\quad\quad\quad\quad\quad \Mif  \;\tsunknown{tcp\_sock}.\tsvar{st} \;\in  \{\tsunknown{CLOSED};\tsunknown{LISTEN};\tsunknown{SYN\_SENT};\tsunknown{SYN\_RECEIVED}\} \Mwedge {}\\{}
...
\quad\quad\quad\quad\quad\quad\quad \tsvar{SS}' = \tsvar{SS}{}\\{}
\quad\quad\quad \Melse {}\\{}
\quad\quad\quad\quad\quad {}\\{}
\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \Mwedge  \tsvar{oq}' = \tsvar{oq} \Mwedge  \tsvar{SS}' = \tsvar{SS}) \Mdpipe {}\\{}
\quad\quad \tscon{UDP\_PROTO}(\tsunknown{udp\_sock}) \Mtotype {}\\{}
\quad\quad\quad\quad (\Mif  \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen {}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsunknown{udp\_sock} \;{}\\{}
 \Mmagiclrec  \tsvar{rcvq} \Mass  \Mappend{\tsunknown{udp\_sock}.\tsvar{rcvq}}{[(\tsunknown{Dgram\_error}(\Mmagiclrec  \tsunknown{e} \Mass  \tsunknown{ENOPROTOOPT} \Mmagicrrec ))]} \Mmagicrrec ) \Mmagicrrec  \Mwedge {}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsvar{oq}' = \tsvar{oq}{}\\{}
\quad\quad\quad\quad\quad \Melse  {}\\{}
...
\rrulecc{deliverTinTicmpTV}{deliver\_in\_icmp\_5}{all: network nonurgent}{\tsholcomm{ Receive $\tsunknown{ICMP\_SOURCE\_QUENCH}$ for known socket }}
{(\tsvar{h}_{0},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \MLhtau  }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{socks} \Mass  \tsvar{socks} \oplus {}\\{}
\quad [(\tsvar{sid},\tsvar{sock}')] ;{}\\{}
...
\quad\quad\quad\quad (\Mif  \;\tsunknown{windows\_arch} \;\tsvar{h}.\tsvar{arch} \;\Mthen {}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsvar{sock}' = \tsvar{sock} \; \Mmagiclrec  \tsvar{pr} \Mass  \tscon{UDP\_PROTO}(\tsunknown{udp\_sock} \;{}\\{}
 \Mmagiclrec  \tsvar{rcvq} \Mass  \Mappend{\tsunknown{udp\_sock}.\tsvar{rcvq}}{[(\tsunknown{Dgram\_error}(\Mmagiclrec  \tsunknown{e} \Mass  \tsunknown{EHOSTUNREACH} \Mmagicrrec ))]} \Mmagicrrec ) \Mmagicrrec {}\\{}
\quad\quad\quad\quad\quad \Melse  {}\\{}
...
\quad \tsvar{MM} = \tsunknown{BAG\_INSERT} \;\tsvar{msg} \;\tsvar{MM}' \Mwedge {}\\{}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{iq} \Mass  \tsvar{iq} \Mmagicrrec ,\tsvar{SS},\tsunknown{BAG\_INSERT} \;\tsvar{msg} \;\tsvar{MM})}
...
{(\tsvar{h} \; \Mmagiclrec  \tsvar{oq} \Mass  \tsvar{oq} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tsvar{lbl} }{1}}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{oq} \Mass  \tsvar{oq}' \Mmagicrrec ,\tsvar{SS},\tsvar{MM}')}
{( \tsvar{lbl} = \MLhtau  \Mwedge  {}\\{}
\quad \tsvar{MM}' = \tsvar{MM} \Mwedge {}\\{}
...
$\tsrule{trace\_1}$
& \textbf{all: misc nonurgent}
&  Trace TCPCB state, $\tsunknown{ESTABLISHED}$ or later \\
$\tsrule{trace\_2}$
& \textbf{all: misc nonurgent}
&  Trace TCPCB state, pre-$\tsunknown{ESTABLISHED}$ \\
$\tsrule{interface\_1}$
& \textbf{all: misc nonurgent}
...
\rrulecc{traceTI}{trace\_1}{all: misc nonurgent}{\tsholcomm{ Trace TCPCB state, $\tsunknown{ESTABLISHED}$ or later }}
{(\tsvar{h},\tsvar{SS},\tsvar{MM})}
...
{\tsvar{sid} \;\in  \Mfdom{\tsvar{h}.\tsvar{socks}} \Mwedge {}\\{}
 ...
 \tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSING};{}\\{}
\quad\quad\quad \tsunknown{CLOSE\_WAIT}; \tsunknown{LAST\_ACK}; \tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
...
{\rulesubsection{Description}
     ...
     frequently when in a state before $\tsunknown{ESTABLISHED}$. We only check for equality
     when we are in $ \tsunknown{ESTABLISHED}$ or later states.


\rrulepad }


\rrulecn{traceTII}{trace\_2}{all: misc nonurgent}{\tsholcomm{ Trace TCPCB state, pre-$\tsunknown{ESTABLISHED}$ }}
{(\tsvar{h},\tsvar{SS},\tsvar{MM})}
{\Mtransition{ \tscon{Lh\_trace} \;\tsvar{tr} }{1}}
{(\tsvar{h},\tsvar{SS},\tsvar{MM})}
{\tsvar{sid} \;\in  \Mfdom{\tsvar{h}.\tsvar{socks}} \Mwedge {}\\{}
 \tsvar{tr} = (\tsvar{flav},\tsvar{sid},\tsvar{quad},\tsvar{st},\tsvar{cb}) \Mwedge {}\\{}
 \tsvar{st} \;\notin  \{\tsunknown{ESTABLISHED}; \tsunknown{FIN\_WAIT\_1}; \tsunknown{FIN\_WAIT\_2}; \tsunknown{CLOSING};{}\\{}
\quad\quad\quad\quad\quad \tsunknown{CLOSE\_WAIT}; \tsunknown{LAST\_ACK}; \tsunknown{TIME\_WAIT}\} \Mwedge {}\\{}
 (\tsvar{st} = \tsunknown{CLOSED} \Mvee   \tsholcomm{ BSD emits one of these each time a tcpcb is created, eg at end of 3WHS }{}\\{}
...
\quad\quad \Msome  (\tsvar{is}_{1},\tsvar{ps}_{1},\tsvar{is}_{2},\tsvar{ps}_{2}) \Mtotype  \Mif  \;\tsvar{flav} = \tsunknown{TA\_DROP} \Mvee  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED} \;\Mthen  \;\Mtrue {}\\{}
...
\quad\quad *                   \Mtotype  \Mtrue ) \Mwedge {}\\{}
\quad (\tsvar{st}  = \tsunknown{tcp\_sock}.\tsvar{st} \Mvee  \tsunknown{tcp\_sock}.\tsvar{st} = \tsunknown{CLOSED}))))}
{}


\rrulecc{interfaceTI}{interface\_1}{all: misc nonurgent}{\tsholcomm{ Change connectivity }}
{(\tsvar{h} \; \Mmagiclrec  \tsvar{ifds} \Mass  \tsvar{ifds} \Mmagicrrec ,\tsvar{SS},\tsvar{MM})}
...
$\tsrule{soreadable}$
&
&  check whether a socket is readable \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{TimeTPassTtimedoption}{\iA{Time\_Pass\_timedoption}}{\subddefnA[{ time passes for an $\tsunknown{'a} \;\tsunknown{timed} \;\;\tstype{option}$ value }]{Time\_Pass\_timedoption}{(\tsaux{Time\_Pass\_timedoption} : \tsunknown{duration} \Mtotype  \tsunknown{'a} \;\tsunknown{timed} \;\;\tstype{option} \Mtotype  \tsunknown{'a} \;\tsunknown{timed} \;\;\tstype{option} \;\;\tstype{option}){}\\{}
...
\ddefnn{TimeTPassTtcpcb}{\iA{Time\_Pass\_tcpcb}}{\subddefnA[{ time passes for a tcp control block }]{Time\_Pass\_tcpcb}{(\tsaux{Time\_Pass\_tcpcb} : \tsunknown{duration} \Mtotype  \tstype{tcpcb} \Mtotype  \tstype{tcpcb} \;\tstype{set} \;\;\tstype{option})  \tscomm{ recall: 'a set == 'a -\textgreater{} bool }{}\\{}
...
\ddefnn{TimeTPassTsocket}{\iA{Time\_Pass\_socket}}{\subddefnA[{ time passes for a socket }]{Time\_Pass\_socket}{(\tsaux{Time\_Pass\_socket} : \tsunknown{duration} \Mtotype  \tstype{socket} \Mtotype  \tstype{socket} \;\tstype{set} \;\;\tstype{option}){}\\{}
...
\ddefnn{TimeTPassThost}{\iA{Time\_Pass\_host}}{\subddefnA[{ time passes for a host }]{Time\_Pass\_host}{(\tsaux{Time\_Pass\_host} : \tsunknown{duration} \Mtotype  \tstype{host} \Mtotype  \tstype{host} \;\tstype{set} \;\;\tstype{option}){}\\{}
...
\ddefnc{sowriteable}{\iA{sowriteable}}{\subddefnA[{ check whether a socket is writable }]{sowriteable}{\tsaux{sowriteable} \;\tsvar{arch} \;\tsunknown{sock} \;\tsunknown{SS} \;\tsunknown{b}={}\\{}
 \Mcase  \;\tsunknown{sock}.\tsvar{pr} \;\Mof {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp}) \Mtotype  ({}\\{}
\quad \exists  \tsvar{sndq}.{}\\{}
\quad (\Mif  \;\tsaux{exists\_quad\_of} \;\tsunknown{sock} \;\Mthen {}\\{}
\quad\quad\quad \Mlet  (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) = \tsaux{quad\_of} \;\tsunknown{sock} \;\Min {}\\{}
\quad\quad\quad \exists  \tsvar{S}_{0} \;\tsvar{s}. \tsunknown{SS} = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})] \Mwedge {}\\{}
\quad\quad\quad \exists  \tsvar{peek} \;\tsvar{inline} \;\tsvar{flgs} \;\tsvar{s}'.{}\\{}
\quad\quad\quad \tsaux{read} (\tsvar{i}_{2},\tsvar{p}_{2},\tsvar{i}_{1},\tsvar{p}_{1}) \tsvar{peek} \;\tsvar{inline} (\tsvar{flgs},\tsvar{sndq}) \tsvar{s} \;\tsvar{s}'{}\\{}
\quad \Melse {}\\{}
\quad\quad\quad \tsvar{sndq} = [\,]) \Mwedge {}\\{}
\quad \tsunknown{b} = ({}\\{}
\quad ((\tsunknown{tcp}.\tsvar{st} \;\in  \{\tsunknown{ESTABLISHED}; \tsunknown{CLOSE\_WAIT}\} \Mwedge {}\\{}
\quad\quad \tsunknown{sock}.\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDBUF}) - \tsholop{LENGTH} \;\tsvar{sndq}  \geq  \tsunknown{sock}.\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_SNDLOWAT})) \Mvee  \tscomm{ change to send\textunderscore{}buffer\textunderscore{}space }{}\\{}
\quad (\Mif  \;\tsunknown{linux\_arch} \;\tsvar{arch} \;\Mthen  \neg{}\tsunknown{sock}.\tsvar{cantsndmore} \;\Melse  \;\tsunknown{sock}.\tsvar{cantsndmore}) \Mvee {}\\{}
\quad (\tsunknown{linux\_arch} \;\tsvar{arch} \Mwedge  \tsunknown{tcp}.\tsvar{st} = \tsunknown{CLOSED}) \Mvee {}\\{}
...
\ddefnc{soreadable}{\iA{soreadable}}{\subddefnA[{ check whether a socket is readable }]{soreadable}{\tsaux{soreadable} \;\tsvar{arch} \;\tsunknown{sock} \;\tsunknown{SS} \;\tsunknown{b} ={}\\{}
 \Mcase  \;\tsunknown{sock}.\tsvar{pr} \;\Mof {}\\{}
 \tscon{TCP\_PROTO}(\tsunknown{tcp}) \Mtotype  ({}\\{}
\quad \exists  \tsvar{rcvq}.{}\\{}
\quad (\Mif  \;\tsaux{exists\_quad\_of} \;\tsunknown{sock} \;\Mthen {}\\{}
\quad\quad\quad \Mlet  (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) = \tsaux{quad\_of} \;\tsunknown{sock} \;\Min {}\\{}
\quad\quad\quad \exists  \tsvar{S}_{0} \;\tsvar{s}. \tsunknown{SS} = \tsvar{S}_{0} \oplus  [(\tsaux{streamid\_of\_quad} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}), \tsvar{s})] \Mwedge {}\\{}
\quad\quad\quad \exists  \tsvar{peek} \;\tsvar{inline} \;\tsvar{flgs} \;\tsvar{s}'.{}\\{}
\quad\quad\quad \tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsvar{peek} \;\tsvar{inline} (\tsvar{flgs},\tsvar{rcvq}) \tsvar{s} \;\tsvar{s}'{}\\{}
\quad \Melse {}\\{}
\quad\quad\quad \tsvar{rcvq} = [\,]) \Mwedge {}\\{}
\quad \tsunknown{b} = ({}\\{}
\quad\quad\quad (\tsholop{LENGTH} \;\tsvar{rcvq} \geq  \tsunknown{sock}.\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_RCVLOWAT}) \Mvee {}\\{}
\quad\quad\quad \tsunknown{sock}.\tsvar{cantrcvmore} \Mvee {}\\{}
\quad\quad\quad (\tsunknown{linux\_arch} \;\tsvar{arch} \Mwedge  \tsunknown{tcp}.\tsvar{st} = \tsunknown{CLOSED}) \Mvee {}\\{}
\quad\quad\quad (\tsunknown{tcp}.\tsvar{st} = \tsunknown{LISTEN} \Mwedge {}\\{}
\quad\quad\quad\quad \exists \tsvar{lis}. \tsunknown{tcp}.\tsvar{lis} = \Msome  \;\tsvar{lis} \Mwedge {}\\{}
\quad\quad\quad\quad\quad\quad\quad \tsvar{lis}.\tsunknown{q} \neq  [\,]) \Mvee {}\\{}
\quad\quad\quad \tsunknown{sock}.\tsvar{es} \neq  *))) \Mdpipe {}\\{}
 \tscon{UDP\_PROTO}(\tsunknown{udp}) \Mtotype {}\\{}
\quad \tsunknown{b} = (\tsunknown{udp}.\tsvar{rcvq} \neq  [\,] \Mvee  \tsunknown{sock}.\tsvar{es} \neq  * \Mvee  (\tsunknown{sock}.\tsvar{cantrcvmore} \Mwedge  \neg{}\tsunknown{windows\_arch} \;\tsvar{arch}))}
}
{\rulesubsection{Description}

A TCP socket $\tsunknown{sock}$ is readable if: (1) the length of its receive queue is greater than or equal
to the minimum number of bytes for socket input operations, $\tsvar{sf}.\tsunknown{n}(\tsunknown{SO\_RCVLOWAT})$; (2) it has been
shut down for reading; (3) on Linux, it is in the $\tsunknown{CLOSED}$ state; it is in the $\tsunknown{LISTEN}$ state
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
\def\rulesrcsid{\$ Id: TCP3\textunderscore{}streamScript.sml,v 1.18 2009/02/20 10:35:33 tjr22 Exp \$}

\chaptersection{ Stream auxiliary functions}
\label{TCP3_stream}%
\chapcomm{
...
\clustersection{(TCP and UDP)}{Default initial values}
\seccomm{
...
&
&  form the stream identifier from quad \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnc{initialTstreamFlags}{\iA{initial\_streamFlags}}{\subddefnA[{ initial stream flags }]{initial\_streamFlags}{\tsaux{initial\_streamFlags} = \Mmagiclrec {}\\{}
 \tsvar{SYN} \Mass  \Mfalse ;{}\\{}
...
\ddefnc{initialTstream}{\iA{initial\_stream}}{\subddefnA[{ initial unidirectional stream }]{initial\_stream}{\tsaux{initial\_stream} (\tsvar{i},\tsvar{p}) \tsvar{destroyed} = \Mmagiclrec {}\\{}
 \tsvar{i} \Mass  \tsvar{i};{}\\{}
 \tsvar{p} \Mass  \tsvar{p};{}\\{}
...
the $\tsvar{destroyed}$ flag should take. Then $\tsvar{data}$ is initialized to the empty list.


\rrulepad }


\ddefnc{initialTstreams}{\iA{initial\_streams}}{\subddefnA[{ initial bidirectional stream }]{initial\_streams}{\tsaux{initial\_streams} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) = ({}\\{}
...
A stream is constructed based on the quad $(\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2})$. Only one endpoint, at the originating
host $(\tsvar{i}_{1},\tsvar{p}_{1})$, exists, thus, the output stream is not destroyed, whilst the input stream is
destroyed.
...
\ddefnc{streamidTofTquad}{\iA{streamid\_of\_quad}}{\subddefnA[{ form the stream identifier from quad }]{streamid\_of\_quad}{\tsaux{streamid\_of\_quad} ((\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}):\tsunknown{ip}\#\tsunknown{port}\#\tsunknown{ip}\#\tsunknown{port}) = \{(\tsvar{i}_{1},\tsvar{p}_{1});(\tsvar{i}_{2},\tsvar{p}_{2})\}}
}
{\rulesubsection{Description}
...
\clustersection{(TCP and UDP)}{Auxiliary functions}
\seccomm{
...
&
&  flags and data corresponding to an initial $\tsvar{SYN}$ message \\
$\tsrule{make\_syn\_ack\_flgs\_data}$
&
&  flags and data corresponding to an initial $\tsvar{SYNACK}$ message \\
$\tsrule{sync\_streams}$
&
...
$\tsrule{read}$
&
&  read flags and data from a stream \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{nullTflgsTdata}{\iA{null\_flgs\_data}}{\subddefnA[{ flags and data corresponding to no control information }]{null\_flgs\_data}{\tsaux{null\_flgs\_data} (\tsvar{flgs},\tsvar{data}) = ({}\\{}
...
\ddefnn{makeTsynTflgsTdata}{\iA{make\_syn\_flgs\_data}}{\subddefnA[{ flags and data corresponding to an initial $\tsvar{SYN}$ message }]{make\_syn\_flgs\_data}{\tsaux{make\_syn\_flgs\_data} (\tsvar{flgs},\tsvar{data}:\tsunknown{char} \;\tstype{list}) = ({}\\{}
...
\ddefnn{makeTsynTackTflgsTdata}{\iA{make\_syn\_ack\_flgs\_data}}{\subddefnA[{ flags and data corresponding to an initial $\tsvar{SYNACK}$ message }]{make\_syn\_ack\_flgs\_data}{\tsaux{make\_syn\_ack\_flgs\_data} (\tsvar{flgs},\tsvar{data}:\tsunknown{char} \;\tstype{list}) = ({}\\{}
...
\ddefnc{syncTstreams}{\iA{sync\_streams}}{\subddefnA[{ retrieve unidirectional streams from bidirectional stream }]{sync\_streams}{\tsaux{sync\_streams} (\tsvar{i}_{1}:\tsunknown{ip},\tsvar{p}_{1}:\tsunknown{port},\tsvar{i}_{2}:\tsunknown{ip},\tsvar{p}_{2}:\tsunknown{port}) (\tsunknown{s}:\tstype{tcpStreams}) (\tsunknown{in\_},\tsunknown{out}) = ({}\\{}
...
A function to extract the input stream $\tsunknown{in\_}$ and output stream $\tsunknown{out}$ from a bidirectional stream
$\tsunknown{s}$ based on the ip address and port of an endpoint.


\rrulepad }


\ddefnc{write}{\iA{write}}{\subddefnA[{ write flags and data to a stream }]{write}{\tsaux{write} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsvar{flgs},\tsvar{data}) \tsunknown{s} \;\tsunknown{s'} = ({}\\{}
...
The unidirectional streams before ($\tsunknown{in\_},\tsunknown{out}$) and after ($\tsunknown{in'},\tsunknown{out'}$) are first extracted using
$\tsaux{sync\_streams}$. The $\tsvar{flgs}$ and $\tsvar{data}$ of the output stream $\tsunknown{out'}$ are updated to reflect the
write. For example, $\tsvar{data}$ is appended to $\tsunknown{out}.\tsvar{data}$ to form $\tsunknown{out'}.\tsvar{data}$.


\rrulepad }


\ddefnc{read}{\iA{read}}{\subddefnA[{ read flags and data from a stream }]{read}{\tsaux{read} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsunknown{peek}:\tstype{bool}) (\tsunknown{inline}:\tstype{bool}) (\tsvar{flgs}:\tstype{streamFlags},\tsvar{data}:\tsunknown{char} \;\tstype{list}) \tsunknown{s} \;\tsunknown{s'} = ({}\\{}
\quad \exists  \tsunknown{in\_} \;\tsvar{out} \;\tsvar{in}' \;\tsvar{out}'.{}\\{}
\quad \tsaux{sync\_streams} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsunknown{s} (\tsunknown{in\_},\tsvar{out}) \Mwedge {}\\{}
\quad \tsaux{sync\_streams} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsunknown{s'} (\tsvar{in}',\tsvar{out}') \Mwedge {}\\{}
...
\quad (\Mcase  \;\tsvar{flgs}.\tsvar{SYNACK} \;\Mof {}\\{}
\quad\quad\quad\quad \Mtrue  \Mtotype  \tsvar{in}'.\tsvar{flgs}.\tsvar{SYNACK} = \Mfalse  \Mwedge  \tsunknown{in\_}.\tsvar{flgs}.\tsvar{SYNACK} = \Mtrue {}\\{}
\quad\quad \Mdpipe  \Mfalse  \Mtotype  \tsvar{in}'.\tsvar{flgs}.\tsvar{SYNACK} = \tsunknown{in\_}.\tsvar{flgs}.\tsvar{SYNACK}) \Mwedge {}\\{}
...
The unidirectional streams before ($\tsunknown{in\_},\tsunknown{out}$) and after ($\tsunknown{in'},\tsunknown{out'}$) are first extracted using
$\tsaux{sync\_streams}$. The $\tsvar{flgs}$ and $\tsvar{data}$ of the input stream $\tsunknown{in'}$ are updated to reflect the
read. For example, if $\tsvar{flgs}.\tsvar{SYN}$ is set, a $\tsvar{SYN}$ was read, which causes the $\tsvar{SYN}$ flag for
input stream $\tsunknown{in'}$ to be lowered; furthore, $\tsunknown{in\_}.\tsvar{flgs}.\tsvar{SYN}$ must also have been set, i.e. there
must have been a $\tsvar{SYN}$ to read.


\rrulepad }


\clustersection{(TCP and UDP)}{Stream removal}
\seccomm{
...
&
&  destroy all quads in a stream map, then clean up \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{bothTstreamsTdestroyed}{\iA{both\_streams\_destroyed}}{\subddefnA[{ test whether both unidirectional streams are destroyed }]{both\_streams\_destroyed}{\tsaux{both\_streams\_destroyed} \;\tsunknown{ss} = \forall  \tsvar{s} \;\tsvar{t}. \tsunknown{ss}.\tsvar{streams} = \{\tsvar{s};\tsvar{t}\} \implies  \tsvar{s}.\tsvar{destroyed} \Mwedge  \tsvar{t}.\tsvar{destroyed}}
}
{}


\ddefnc{removeTdestroyedTstreams}{\iA{remove\_destroyed\_streams}}{\subddefnA[{ restrict the stream map to those streams that are not destroyed }]{remove\_destroyed\_streams}{\tsaux{remove\_destroyed\_streams} (\tsunknown{SS}:\tsunknown{streamid} \mapsto  \tstype{tcpStreams}) = ({}\\{}
...
\ddefnc{destroy}{\iA{destroy}}{\subddefnA[{ destroy a particular unidirectional stream, then clean up }]{destroy}{\tsaux{destroy} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) \tsunknown{SS} \;\tsunknown{S''} = ({}\\{}
...
The particular stream $\tsunknown{s}$ identified by quad $(\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2})$ is extracted from the stream map $\tsunknown{SS}$. In turn, the input and output streams are extracted from $\tsunknown{s}$. The stream $\tsunknown{s}$ is updated to mark the output stream $\tsunknown{out}$ as destroyed, producing the updated stream map $\tsunknown{S'}$. Finally, streams with both endpoints destroyed are garbage collected using $\tsaux{remove\_destroyed\_streams}$.


\rrulepad }


\ddefnc{destroyTquads}{\iA{destroy\_quads}}{\subddefnA[{ destroy all quads in a stream map, then clean up }]{destroy\_quads}{\tsaux{destroy\_quads} \;\tsunknown{quads} (\tsunknown{SS}:\tsunknown{streamid} \mapsto  \tstype{tcpStreams}) \tsunknown{S''} = ({}\\{}
...
Similar to $\tsaux{destroy}$, but allowing the destruction of multiple streams, for example, when a listening socket with pending connections is closed.
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
% TCP3_netScript.sml:69:4-13:                 WARNING: Empty preamble in cluster comment
...
\clustersection{(TCP and UDP)}{Basic network types}
\seccomm{
...
$\tsrule{rn}$
&
&  net transition rule names \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{typeTabbrevThosts}{\iA{type\_abbrev\_hosts}}{\subddefnA{type\_abbrev\_hosts}{\tsholop{type\_abbrev} \;\tsunknown{hosts} :\tsunknown{hostid} \mapsto  \tstype{host}}
}
{}


\ddefnn{typeTabbrevTstreams}{\iA{type\_abbrev\_streams}}{\subddefnA{type\_abbrev\_streams}{\tsholop{type\_abbrev} \;\tsvar{streams} :\tsunknown{streamid} \mapsto  \tstype{tcpStreams}}
}
{}


\ddefnn{typeTabbrevTmsgs}{\iA{type\_abbrev\_msgs}}{\subddefnA{type\_abbrev\_msgs}{\tsholop{type\_abbrev} \;\tsunknown{msgs} :\tsunknown{msg} \;\tsunknown{multiset}}
}
{}


\ddefnn{typeTabbrevTnet}{\iA{type\_abbrev\_net}}{\subddefnA{type\_abbrev\_net}{\tsholop{type\_abbrev} \;\tsunknown{net} :\tsunknown{hosts} \# \tsvar{streams} \# \tsunknown{msgs}}
}
{}
...
\ddefnn{rn}{\iA{rn}}{\subddefnA[{ net transition rule names }]{rn}{\tsunknown{rn} = \tsunknown{call} \mid  \tsunknown{return} \mid  \tsunknown{tau} \mid  \tsunknown{interface} \mid  \tsunknown{host\_tau} \mid  \tsunknown{time\_pass} \mid  \tsunknown{trace}}
}
{}


\clustersection{(TCP and UDP)}{Network labelled transition system}
\clustersubsection{Summary}
\par\begin{ltstabulariii}
$\tsrule{call}$
&
...
{\Mtransition{ (\tscon{Ln\_call}(\tsvar{hid},\tsvar{tid},\tsvar{c})) }{1}}
...
{\rulesubsection{Description}
    ...
    A thread $\tsvar{tid}$ on host $\tsvar{h}$ executes a sockets call $\tsvar{c}$ which
...
\rrulecc{return}{return}{}{}
{((\tsvar{hs} \oplus  (\tsvar{hid},\tsvar{h}),\tsvar{S},\tsvar{M}):\tsunknown{net})}
{\Mtransition{ (\tscon{Ln\_return}(\tsvar{hid},\tsvar{tid},\tsvar{v})) }{1}}
{(\tsvar{hs} \oplus  (\tsvar{hid},\tsvar{h}'),\tsvar{S}',\tsvar{M}')}
...
{\rulesubsection{Description}
    ...
    A thread $\tsvar{tid}$ on host $\tsvar{h}$ returns from a sockets call.
...
{\Mtransition{ (\tscon{Ln\_tau}) }{1}}
{(\tsvar{hs},\tsvar{S},\tsvar{M})}
{\Mtrue }
{\rulesubsection{Description}

    This tau action at the network level corresponds to the hosts
    doing a $\MLhsenddatagram{\tsunknown{msg}}$ or a $\MLhrecvdatagram{\tsunknown{msg}}$ transition.


\rrulepad }


\rrulecc{interface}{interface}{}{}
{((\tsvar{hs} \oplus  (\tsvar{hid},\tsvar{h}),\tsvar{S},\tsvar{M}):\tsunknown{net})}
{\Mtransition{ (\tscon{Ln\_interface} (\tsvar{hid},\tsvar{ifid},\tsvar{up})) }{1}}
{(\tsvar{hs} \oplus  (\tsvar{hid},\tsvar{h}'),\tsvar{S}',\tsvar{M}')}
...
{\rulesubsection{Description}
    ...
    Allow a host to do a $\MLhtau $ transition.


\rrulepad }


\rrulecc{timeTpass}{time\_pass}{}{}
{((\tsvar{hs},\tsvar{S},\tsvar{M}):\tsunknown{net})}
{\Mtransition{ (\tscon{Ln\_epsilon} \;\tsvar{dur}) }{1}}
{(\tsvar{hs}'',\tsvar{S},\tsvar{M})}
...
{\rulesubsection{Description}
     ...
     Trace records give $\tscon{Ln\_tau}$ transitions at the network level.
...
\def\rulesrcsid{}
%%%% AUTOGENERATED FILE (from LTS source) -- DO NOT EDIT! %%%%
\chaptersection{ Abstraction function}
\label{absFun}%
\chapcomm{
...
$\tsrule{tcpcb1\_to\_3}$
&
&  abstract a $\tstype{tcpcb}$ \\
$\tsrule{tcp\_socket1\_to\_3}$
&
&  abstract a $\tstype{tcp\_socket}$ \\
$\tsrule{socket1\_to\_3}$
&
&  abstraction a $\tstype{socket}$ \\
$\tsrule{host1\_to\_3}$
&
&  abstract a $\tstype{host}$ \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{tcpcbITtoTIII}{\iA{tcpcb1\_to\_3}}{\subddefnA[{ abstract a $\tstype{tcpcb}$ }]{tcpcb1\_to\_3}{(\tsaux{tcpcb1\_to\_3}:\tsunknown{TCP1\_hostTypes}\;\tsunknown{\$tcpcb}\Mtotype \tsunknown{TCP3\_hostTypes}\;\tsunknown{\$tcpcb}) \tsvar{cb} = ({}\\{}
...
\ddefnn{tcpTsocketITtoTIII}{\iA{tcp\_socket1\_to\_3}}{\subddefnA[{ abstract a $\tstype{tcp\_socket}$ }]{tcp\_socket1\_to\_3}{(\tsaux{tcp\_socket1\_to\_3}:\tsunknown{TCP1\_hostTypes}\;\tsunknown{\$tcp\_socket}\Mtotype \tsunknown{TCP3\_hostTypes}\;\tsunknown{\$tcp\_socket}) \tsunknown{s} = ({}\\{}
...
\ddefnn{socketITtoTIII}{\iA{socket1\_to\_3}}{\subddefnA[{ abstraction a $\tstype{socket}$ }]{socket1\_to\_3}{(\tsaux{socket1\_to\_3}:\tsunknown{TCP1\_hostTypes}\;\tsunknown{\$socket}\Mtotype \tsunknown{TCP3\_hostTypes}\;\tsunknown{\$socket}) \tsunknown{s} = ({}\\{}
...
\ddefnn{hostITtoTIII}{\iA{host1\_to\_3}}{\subddefnA[{ abstract a $\tstype{host}$ }]{host1\_to\_3}{(\tsaux{host1\_to\_3}:\tsunknown{TCP1\_hostTypes}\;\tsunknown{\$host}\Mtotype \tsunknown{TCP3\_hostTypes}\;\tsunknown{\$host}) \tsunknown{h} = ({}\\{}
...
\clustersection{(TCP and UDP)}{Stream reassembly}
\seccomm{
...
$\tsrule{stream\_reass}$
&
&  reassemble the stream from segments on the wire \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnc{streamTreass}{\iA{stream\_reass}}{\subddefnA[{ reassemble the stream from segments on the wire }]{stream\_reass}{\tsaux{stream\_reass} (\tsunknown{seq}:\tsunknown{tcpLocal} \;\tsunknown{seq32}) (\tsunknown{segs}: \tsunknown{tcpSegment} \;\tstype{set}) = ({}\\{}
 \tscomm{ REMARK first arg should be  word32 }{}\\{}
...
\clustersection{(TCP and UDP)}{Abstraction function}
\seccomm{
...
$\tsrule{abs\_trans}$
&
&  abstract a full protocol-level network transition \end{ltstabulariii}\par
\clustersubsection{Rules}
~

\ddefnn{ERROR}{\iA{ERROR}}{\subddefnA[{ a simple way to indicate that an error has occurred }]{ERROR}{\tsunknown{ERROR} (\tsunknown{a}:\tsunknown{'a}) = (\tsunknown{ARB}:\tsunknown{'b})}
}
{}


\ddefnc{absThostsToneTsided}{\iA{abs\_hosts\_one\_sided}}{\subddefnA[{ unidirectional abstraction function }]{abs\_hosts\_one\_sided}{\tsaux{abs\_hosts\_one\_sided} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsunknown{h},\tsunknown{msgs},\tsvar{i}) = ({}\\{}
 {}\\{}
...
\quad\quad\quad \Mcase  (\tsunknown{h}.\tsvar{oq},\tsvar{i}.\tsvar{iq}) \Mof  (\Mtimed{\tsunknown{omsgs}}{\tsunknown{\_1}}, \Mtimed{\tsunknown{imsgs}}{\tsunknown{\_2}}) \Mtotype  (\tsunknown{omsgs},\tsunknown{imsgs}) \Min {}\\{}
...
\quad \Mmagiclrec   \tsvar{i} \Mass  \tsvar{i}_{1};{}\\{}
 ...
 \Msome  (\tsunknown{sid},\tsunknown{hsock}) \Mtotype  ((\tsunknown{tcpsock\_of} \;\tsunknown{hsock}).\tsvar{st} = \tsunknown{CLOSED}){}\\{}
 \Mdpipe  * \Mtotype  \Mtrue ){}\\{}
 \Mmagicbolrrec )}
}
{\rulesubsection{Description}

The core of the abstraction function is to compute the $\tsvar{data}$ in the stream, given the connection
endpoints and the segments on the wire.

Normally the sender and receiver endpoints are both active. In this case, the sender $\tsvar{sndq}$ and
the receiver $\tsvar{rcvq}$ contain bytes corresponding to sequence number intervals. These intervals
overlap, so to recover the data in the stream, we must drop some data from the $\tsvar{sndq}$. We drop
$\tsunknown{rcv\_nxt} - \tsunknown{snd\_una}$ bytes and then append the resulting $\tsvar{sndq}'$ to $\tsvar{rcvq}$ to form the contents
of the stream.

The other cases are handled in a similar way. If the receiver endpoint is absent, the data is just
that data in the sender's $\tsvar{sndq}$. If the sender endpoint is absent, the data is reassembled from
segments on the wire, using $\tsaux{stream\_reass}$.

The $\tsvar{flgs}$ are calculated based on the flags set in segments on the wire. In fact, this should
...
The destroyed flag is true iff the socket is $\tsunknown{CLOSED}$ or no longer exists.


\rrulepad }


\ddefnc{absThosts}{\iA{abs\_hosts}}{\subddefnA[{ the full abstraction function for host states }]{abs\_hosts}{\tsaux{abs\_hosts} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsunknown{h1},\tsunknown{msgs},\tsunknown{h2}) = ({}\\{}
...
host states and streams. It uses the unidirectional abstraction function $\tsaux{abs\_hosts\_one\_sided}$
twice to form streams $\tsunknown{s12}$ and $\tsunknown{s21}$. If these streams are both destroyed, then the resulting
$\tsvar{streams}$ (an option) is $*$, otherwise it is a pair of the unidirectional streams.


\rrulepad }


\ddefnc{absTlbl}{\iA{abs\_lbl}}{\subddefnA[{ abstract transition labels }]{abs\_lbl}{\tsaux{abs\_lbl} \;\tsunknown{lbl} = (\Mcase  \;\tsunknown{lbl} \;\Mof {}\\{}
\quad \tsunknown{Ln0\_call} (\tsunknown{hid}, \tsunknown{tid}, \tsunknown{lib}) \Mtotype  \tscon{Ln\_call} (\tsunknown{hid}, \tsunknown{tid}, \tsunknown{lib}){}\\{}
 ...
 \Mdpipe  \tsunknown{Ln0\_interface} (\tsunknown{hid},\tsunknown{ifid},\tsunknown{up}) \Mtotype  \tsunknown{ERROR} \text{``absfn: Ln0\textunderscore{}interface''}{}\\{}
...
\ddefnc{absTtrans}{\iA{abs\_trans}}{\subddefnA[{ abstract a full protocol-level network transition }]{abs\_trans}{\tsaux{abs\_trans} (\tsvar{i}_{1},\tsvar{p}_{1},\tsvar{i}_{2},\tsvar{p}_{2}) (\tsunknown{h1},\tsunknown{msgs},\tsunknown{h2}) \tsunknown{lbl} (\tsunknown{h1'},\tsunknown{msgs'},\tsunknown{h2'}) = ({}\\{}
...
The $\tsaux{abs\_trans}$ function ties together the previous host and label abstraction functions to
