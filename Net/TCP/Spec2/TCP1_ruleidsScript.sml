...
(*[ RCSID "$Id: TCP1_ruleidsScript.sml,v 1.1 2005/07/12 15:42:25 tjr22 Exp $" ]*)
...
val _ = Version.registerTheory "$RCSfile: TCP1_ruleidsScript.sml,v $" "$Revision: 1.1 $" "$Date: 2005/07/12 15:42:25 $";
