...
(*[ RCSID "$Id: TCP1_host0Script.sml,v 1.2 2005/07/19 12:24:02 tjr22 Exp $" ]*)
...
val _ = Version.registerTheory "$RCSfile: TCP1_host0Script.sml,v $" "$Revision: 1.2 $" "$Date: 2005/07/19 12:24:02 $";
