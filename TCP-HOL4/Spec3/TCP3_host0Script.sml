...
(*[ RCSID "$Id: TCP3_host0Script.sml,v 1.5 2009/02/19 17:47:27 tjr22 Exp $" ]*)
...
local open TCP1_baseTypesTheory
	   ...
	   TCP3_streamTypesTheory
           TCP3_hostTypesTheory  (* needed for trace labels, annoyingly *)
in end;

val _ = new_theory "TCP3_host0";

val _ = Version.registerTheory "$RCSfile: TCP3_host0Script.sml,v $" "$Revision: 1.5 $" "$Date: 2009/02/19 17:47:27 $";

(*: @chapter [[TCP3_host0]] Host LTS labels and rule categories
