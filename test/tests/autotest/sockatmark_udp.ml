...
(* $Id: sockatmark_udp.ml,v 1.7 2006/06/07 11:52:45 amgb2 Exp $ *)
(* ---------------------------------------------------------------------- *)
...
let test1 = (
  ...
  "sockatmark() -- for a fresh UDP socket with binding quad " ^ (string_of_bound_udp_quad sf) ^ ",call sockatmark() and expect to fail",
...
let do_sockatmark_udp_tests handle hosts_list test_type =
  begin_next_test_group handle "sockatmark() for UDP";
