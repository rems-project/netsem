...
(* $Id: threadparsing.mli,v 1.2 2003/01/17 13:51:18 smb50 Exp $ *)
...
val symbol_end : env -> int
(** See {!Parsing.symbol_start}. *)

val rhs_start : env -> int -> int
...
val rhs_end : env -> int -> int
(** See {!Parsing.rhs_start}. *)

val clear_parser : env -> unit
...
val yyparse :
  env -> parse_tables -> int -> (Lexing.lexbuf -> 'a) -> Lexing.lexbuf -> 'b
val peek_val : parser_env -> int -> 'a
val is_current_lookahead : env -> 'a -> bool
val parse_error : string -> unit

val create_parse_env : unit -> env
